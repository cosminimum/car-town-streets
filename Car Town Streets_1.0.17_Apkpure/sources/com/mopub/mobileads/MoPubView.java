...
public class MoPubView extends FrameLayout {
    ...
    private void initVersionDependentAdView(Context context) {
        ...
        try {
            Class<?> HTML5AdViewClass = Class.forName("com.mopub.mobileads.HTML5AdView");
            Class<?>[] parameterTypes = {Context.class, MoPubView.class};
            Object[] args = {context, this};
            try {
                Constructor<?> constructor = HTML5AdViewClass.getConstructor(parameterTypes);
                this.mAdView = (AdView) constructor.newInstance(args);
