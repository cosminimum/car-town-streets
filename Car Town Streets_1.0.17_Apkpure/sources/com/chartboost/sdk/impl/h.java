...
public class h extends com.chartboost.sdk.b {
    ...
    private a.C0000a m;
    private a.C0000a n;
    private SparseArray<a.C0000a> o;
    ...
    public class a extends b.AbstractC0003b {
        ...
        public class C0005a extends ArrayAdapter<JSONObject> {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                String optString = item.optString(ServerProtocol.DIALOG_PARAM_TYPE, "");
                b bVar = null;
                if (convertView == null) {
        ...
        for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
            ...
            if (optString.equals("regular")) {
                ...
                if (optJSONObject3 != null) {
                    ...
                    a(optJSONObject3, Constants.PORTRAIT, bVar, bundle2);
                    this.e++;
                    Bundle bundle3 = new Bundle();
                    bundle3.putInt("index", i2);
                    a(optJSONObject3, Constants.LANDSCAPE, bVar, bundle3);
                }
            } else {
