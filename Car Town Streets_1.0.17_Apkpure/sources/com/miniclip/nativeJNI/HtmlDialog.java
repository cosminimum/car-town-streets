...
public class HtmlDialog extends Dialog {
    ...
    private void createCrossImage() {
        ...
        this.mCrossImage.setOnClickListener(new View.OnClickListener() { // from class: com.miniclip.nativeJNI.HtmlDialog.1
        ...
        int resourceId = getContext().getResources().getIdentifier("close", "drawable", getContext().getPackageName());
        this.mCrossImage.setImageDrawable(getContext().getResources().getDrawable(resourceId));
    }
    ...
    private void setUpWebView(int margin) {
        ...
        try {
            if (this.mIsInternalURL == 0) {
                ...
                this.mWebView.loadData(URLEncoder.encode(this.mHtml, "utf-8").replaceAll("\\+", " "), "text/html; charset=UTF-8", null);
            }
        } catch (IOException e) {
        }
