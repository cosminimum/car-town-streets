...
public class interstitialMopubView extends RelativeLayout implements View.OnClickListener {
    ...
    private Runnable mAddSkipButton = new Runnable() { // from class: com.miniclip.nativeJNI.interstitialMopubView.1
    ...
    public void showAd() {
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            paramsDialog = new RelativeLayout.LayoutParams((int) (cocojava.mWidth * density), (int) (cocojava.mHeight * density));
        } else {
        ...
        Animation anim = new AlphaAnimation((float) BitmapDescriptorFactory.HUE_RED, 1.0f);
