...
public class interstitialBanner extends RelativeLayout implements View.OnClickListener {
    ...
    private Runnable mAddSkipButton = new Runnable() { // from class: com.miniclip.nativeJNI.interstitialBanner.1
    ...
    public void showAd() {
        ...
        RelativeLayout.LayoutParams paramsFull2 = new RelativeLayout.LayoutParams(((int) (320.0f * density)) + 10, ((int) (50.0f * density * 2.0f)) + 10);
        ...
        RelativeLayout.LayoutParams paramsS = new RelativeLayout.LayoutParams((int) (320.0f * density), (int) (50.0f * density));
        paramsS.addRule(14);
        paramsS.addRule(12);
        ...
        if (!hasAd()) {
            ...
            RelativeLayout.LayoutParams paramsD = new RelativeLayout.LayoutParams((int) (320.0f * density), (int) (50.0f * density));
            paramsD.addRule(14);
            paramsD.addRule(10);
            ...
            RelativeLayout.LayoutParams paramsN = new RelativeLayout.LayoutParams((int) (320.0f * density), (int) (50.0f * density));
            paramsN.addRule(14);
            paramsN.addRule(10);
