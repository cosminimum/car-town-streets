...
public class ApsalarJSInterface {
    ...
    public void registerCallback(String str) {
        ...
        Apsalar.registerCallback(str, (WebView) ((android.app.Activity) this.mContext).findViewById(this.webViewId));
    ...
    public void trigger(String str) {
        Apsalar.trigger((android.app.Activity) this.mContext, str);
    }
    ...
    public void survey(String str) {
        Apsalar.survey((android.app.Activity) this.mContext, str);
    }
