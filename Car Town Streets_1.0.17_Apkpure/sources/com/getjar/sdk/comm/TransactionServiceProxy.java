...
public class TransactionServiceProxy extends ServiceProxyBase {
    ...
    public Operation reserveManagedOffer(CommContext commContext, String offerId, String clientTransactionId, HashMap<String, String> purchaseMetadata, HashMap<String, String> trackingMetadata, boolean suppressInternalCallbacks) throws Exception {
        ...
        String url = String.format(Locale.US, _URL_TEMPLATE_RESERVE_MANAGED_OFFER, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT));
        return makeAsyncPOSTRequestForJson("reserveManagedOffer", Operation.Priority.HIGH, commContext, url, postData, null, null, suppressInternalCallbacks, true, true);
    }
    ...
    public Operation confirmManagedOffer(CommContext commContext, String clientTransactionId, HashMap<String, String> purchaseMetadata, boolean suppressInternalCallbacks) throws Exception {
        ...
        AuthManager.initialize(commContext.getApplicationContext());
        AuthManager.getInstance().waitOnAuth();
        String url = String.format(Locale.US, _URL_TEMPLATE_CONFIRM_MANAGED_OFFER, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT));
        return makeAsyncPOSTRequestForJson("confirmManagedOffer", Operation.Priority.HIGH, commContext, url, postData, null, null, suppressInternalCallbacks, true, true);
    }
    ...
    public Operation reserveUnmanagedPurchase(CommContext commContext, String productId, String productName, String productDescription, Integer amount, String developerPayload, String clientTransactionId, HashMap<String, String> trackingMetadata, boolean suppressInternalCallbacks) throws Exception {
        ...
        if (StringUtility.isNullOrEmpty(productDescription)) {
    ...
    public Operation confirmUnmanagedPurchase(CommContext commContext, String clientTransactionId, boolean suppressInternalCallbacks) throws Exception {
        ...
        AuthManager.initialize(commContext.getApplicationContext());
        AuthManager.getInstance().waitOnAuth();
        String url = String.format(Locale.US, _URL_TEMPLATE_CONFIRM_UNMANAGED_OFFER, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT), URLEncoder.encode(clientTransactionId, "UTF-8"));
        return makeAsyncPOSTRequestForJson("confirmUnmanagedPurchase", Operation.Priority.HIGH, commContext, url, null, null, null, suppressInternalCallbacks, false, true);
    }
    ...
    public Operation confirmAndLicense(CommContext commContext, String clientTransactionId, String itemId, License.LicenseScope licenseScope, boolean suppressInternalCallbacks) throws Exception {
        ...
        String url = String.format(Locale.US, _URL_TEMPLATE_CONFIRM_AND_LICENSE, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT), URLEncoder.encode(signature, "UTF-8"));
        HashMap<String, String> postData = new HashMap<>(4);
        ...
        postData.put("client_transaction_token", clientTransactionId);
        return makeAsyncPOSTRequestForJson("confirmAndLicense", Operation.Priority.HIGH, commContext, url, postData, null, null, suppressInternalCallbacks, true, true);
    }
    ...
    public Operation buyCurrency(CommContext commContext, String clientTransactionId, String productId, HashMap<String, String> itemMetadata, HashMap<String, String> trackingMetadata, boolean suppressInternalCallbacks) {
        ...
        AuthManager.initialize(commContext.getApplicationContext());
        AuthManager.getInstance().waitOnAuth();
        String url = String.format(Locale.US, _URL_TEMPLATE_BUY_CURRENCY, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT));
        ...
        try {
            ...
            try {
                postData.put("tracking_metadata", Utility.mapToJsonString(trackingMetadata));
                postData.put("client_transaction_token", clientTransactionId);
                return makeAsyncPOSTRequestForJson("buyCurrency", Operation.Priority.HIGH, commContext, url, postData, null, null, suppressInternalCallbacks, true, true);
    ...
    public Operation cancelTransaction(CommContext commContext, String clientTransactionId, boolean suppressInternalCallbacks) throws Exception {
        ...
        AuthManager.initialize(commContext.getApplicationContext());
        AuthManager.getInstance().waitOnAuth();
        String url = String.format(Locale.US, _URL_TEMPLATE_CANCEL_TRANSACTION, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT), URLEncoder.encode(clientTransactionId, "UTF-8"));
        return makeAsyncPOSTRequestForJson("cancelTransaction", Operation.Priority.HIGH, commContext, url, null, null, null, suppressInternalCallbacks, false, true);
    }
    ...
    public Operation earn(CommContext commContext, String itemId, String packageName, String clientTransactionId, HashMap<String, String> itemMetadata, HashMap<String, String> trackingMetadata, boolean suppressInternalCallbacks) throws Exception {
        ...
        AuthManager.initialize(commContext.getApplicationContext());
        AuthManager.getInstance().waitOnAuth();
        String url = String.format(Locale.US, _URL_TEMPLATE_EARN, GetJarConfig.getInstance(commContext, true).getDirectiveValue(GetJarConfig.KEY_TRANSACTION_SERVICE_ENDPOINT), URLEncoder.encode(itemId, "UTF-8"), URLEncoder.encode(clientTransactionId, "UTF-8"));
        return makeAsyncPOSTRequestForJson("earn", Operation.Priority.HIGH, commContext, url, postData, null, null, suppressInternalCallbacks, false, true);
    }
}
