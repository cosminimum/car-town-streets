...
public class Logger {
    ...
    private final List<AppenderInterface> _appenders = Collections.unmodifiableList(Arrays.asList(LogCatAppender.getInstance(), BufferingAppender.getInstance(), RemoteAppender.getInstance()));
    ...
    public boolean isLevelActive(int logLevel) {
        if (logLevel != 7 && logLevel != 3 && logLevel != 6 && logLevel != 4 && logLevel != 2 && logLevel != 5) {
            throw new IllegalArgumentException(String.format(Locale.US, "Unsupported log level: %1$d", Integer.valueOf(logLevel)));
        }
        for (AppenderInterface logger : this._appenders) {
    ...
    public void log(int level, long areas, String msg, Throwable tr) {
        ...
        if (isLevelActive(level) && isAreaActive(areas)) {
    ...
    public static void v(long areas, String msg) {
        v(areas, msg, null);
    }

    public static void v(long areas, String msg, Throwable tr) {
        getInstance().log(2, areas, msg, tr);
    }

    public static void d(long areas, String msg) {
        d(areas, msg, null);
    }

    public static void d(long areas, String msg, Throwable tr) {
        getInstance().log(3, areas, msg, tr);
    }

    public static void i(long areas, String msg) {
        i(areas, msg, null);
    }

    public static void i(long areas, String msg, Throwable tr) {
        getInstance().log(4, areas, msg, tr);
    }

    public static void w(long areas, String msg) {
        w(areas, msg, null);
    }

    public static void w(long areas, String msg, Throwable tr) {
        getInstance().log(5, areas, msg, tr);
    }

    public static void e(long areas, String msg) {
        e(areas, msg, null);
    }

    public static void e(long areas, String msg, Throwable tr) {
        getInstance().log(6, areas, msg, tr);
    }

    public static String getThrowableDump(Throwable tr) {
        return String.format(Locale.US, "%s | %s | %s", tr.getClass().getName(), tr.getMessage(), getStackTrace(tr.getStackTrace()));
    }
    ...
    public static String getStackTrace() {
        ...
        for (int i = 3; i < stacks.length; i++) {
            buffer.append(String.format(Locale.US, "%1$s : %2$s : %3$s [%4$d]\n", stacks[i].getFileName(), stacks[i].getClassName(), stacks[i].getMethodName(), Integer.valueOf(stacks[i].getLineNumber())));
        }
