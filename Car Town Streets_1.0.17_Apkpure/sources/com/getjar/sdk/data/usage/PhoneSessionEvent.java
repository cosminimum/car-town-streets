...
public class PhoneSessionEvent extends SessionEvent {
    ...
    public String toString() {
        return String.format(Locale.US, "id:%1$d timestamp:%2$d type:%3$s reason:%4$s reasonDetails:%5$s sessionId:%6$s synced:%7$s disposable:%8$s", Long.valueOf(getId()), Long.valueOf(getTimestamp()), getType().name(), getReason().name(), getReasonDetails(), getSessionId(), Boolean.valueOf(isSynced()), Boolean.valueOf(isDisposable()));
    }
}
