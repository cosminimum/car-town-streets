...
public class GooglePurchaseResponse implements Serializable {
    ...
    public GooglePurchaseResponse(String notificationId, String orderId, String productId, short purchaseState, String developerPayload, String signedData, String signature) {
        if (StringUtility.isNullOrEmpty(notificationId)) {
