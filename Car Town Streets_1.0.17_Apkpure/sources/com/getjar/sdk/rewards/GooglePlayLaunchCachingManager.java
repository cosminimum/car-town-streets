...
public class GooglePlayLaunchCachingManager {
    ...
    public void update(String packageName, GooglePlayLaunchReason reason) {
        this._cachingManager.updateCache(packageName, reason.name(), Long.valueOf((long) _CacheTTL), null, null);
    ...
    public GooglePlayLaunchReason get(String packageName) {
        ...
        GooglePlayLaunchReason reason = GooglePlayLaunchReason.valueOf(cacheEntry.getValue());
        return reason;
    }
