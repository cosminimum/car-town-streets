...
public class Product implements Parcelable {
    ...
    public static final Parcelable.Creator<Product> CREATOR = new Parcelable.Creator<Product>() { // from class: com.getjar.sdk.Product.1
        ...
        public Product mo31createFromParcel(Parcel in) {
        ...
        public Product[] mo32newArray(int size) {
            return new Product[size];
        }
    };

    /* JADX INFO: Access modifiers changed from: protected */
    public Product(String theProductId, String theProductName, String theProductDescription, long theAmount) {
        this.mProductId = "";
        this.mProductName = "";
        ...
        if (StringUtility.isNullOrEmpty(theProductName)) {
            throw new IllegalArgumentException(String.format(Locale.US, "product '%s' needs a name", theProductId));
        }
        if (theAmount < 0) {
            throw new IllegalArgumentException(String.format(Locale.US, "product '%s' needs an amount greater than or equal to zero", theProductId));
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public Product(String theProductId, String theProductName, String theProductDescription, long theAmount, int imageResourceId) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public Product(String theProductId, String theProductName, String theProductDescription, long theAmount, int imageResourceId, String developerPayload) {
    ...
    public static void validateProductId(String theProductId) {
        ...
        if (!ITEM_ID_PATTERN.matcher(theProductId).matches()) {
