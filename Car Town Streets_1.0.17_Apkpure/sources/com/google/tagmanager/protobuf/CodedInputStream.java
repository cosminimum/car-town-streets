...
public final class CodedInputStream {
    ...
    public void readGroup(int fieldNumber, MessageLite.Builder builder, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        this.recursionDepth++;
        builder.mo411mergeFrom(this, extensionRegistry);
    ...
    public <T extends MessageLite> T readGroup(int fieldNumber, Parser<T> parser, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        this.recursionDepth++;
        T result = parser.mo419parsePartialFrom(this, extensionRegistry);
        checkLastTagWas(WireFormat.makeTag(fieldNumber, 4));
        this.recursionDepth--;
        return result;
    }
    ...
    public int readRawLittleEndian32() throws IOException {
        ...
        byte b3 = readRawByte();
        byte b4 = readRawByte();
        return (b1 & Constants.UNKNOWN) | ((b2 & Constants.UNKNOWN) << 8) | ((b3 & Constants.UNKNOWN) << 16) | ((b4 & Constants.UNKNOWN) << 24);
    }
