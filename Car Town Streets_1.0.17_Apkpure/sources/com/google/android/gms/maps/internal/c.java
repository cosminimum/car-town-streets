    ...
    public static abstract class a extends Binder implements c {
        ...
        private static class C0067a implements c {
            ...
            public com.google.android.gms.maps.model.internal.a eA() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return a.AbstractBinderC0081a.aj(obtain2.readStrongBinder());
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    data.enforceInterface("com.google.android.gms.maps.internal.ICreator");
                    IMapViewDelegate a = a(b.a.E(data.readStrongBinder()), data.readInt() != 0 ? GoogleMapOptions.CREATOR.mo366createFromParcel(data) : null);
                    reply.writeNoException();
                    if (a != null) {
                        iBinder = a.asBinder();
                    }
