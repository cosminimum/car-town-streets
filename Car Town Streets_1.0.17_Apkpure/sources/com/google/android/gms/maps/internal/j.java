...
public interface j extends IInterface {
    ...
    public static abstract class a extends Binder implements j {
        ...
        public static j ab(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof j)) ? new C0074a(iBinder) : (j) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onMapLongClick(data.readInt() != 0 ? LatLng.CREATOR.mo376createFromParcel(data) : null);
