...
public interface h extends IInterface {
    ...
    public static abstract class a extends Binder implements h {
        ...
        /* loaded from: classes.dex */
        private static class C0072a implements h {
            private IBinder dU;
        ...
        public static h Z(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof h)) ? new C0072a(iBinder) : (h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    onMapClick(data.readInt() != 0 ? LatLng.CREATOR.mo376createFromParcel(data) : null);
