...
public interface IGoogleMapDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IGoogleMapDelegate {
        ...
        /* loaded from: classes.dex */
        public static class C0060a implements IGoogleMapDelegate {
            private IBinder dU;
            ...
            public CameraPosition getCameraPosition() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return obtain2.readInt() != 0 ? CameraPosition.CREATOR.mo368createFromParcel(obtain2) : null;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public static IGoogleMapDelegate R(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IGoogleMapDelegate)) ? new C0060a(iBinder) : (IGoogleMapDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    IPolylineDelegate addPolyline = addPolyline(data.readInt() != 0 ? PolylineOptions.CREATOR.mo382createFromParcel(data) : null);
                    reply.writeNoException();
                    if (addPolyline != null) {
                ...
                case 10:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    com.google.android.gms.maps.model.internal.e addPolygon = addPolygon(data.readInt() != 0 ? PolygonOptions.CREATOR.mo380createFromParcel(data) : null);
                    reply.writeNoException();
                    if (addPolygon != null) {
                ...
                case 11:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    com.google.android.gms.maps.model.internal.d addMarker = addMarker(data.readInt() != 0 ? MarkerOptions.CREATOR.mo378createFromParcel(data) : null);
                    reply.writeNoException();
                    if (addMarker != null) {
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    com.google.android.gms.maps.model.internal.c addGroundOverlay = addGroundOverlay(data.readInt() != 0 ? GroundOverlayOptions.CREATOR.mo372createFromParcel(data) : null);
                    reply.writeNoException();
                ...
                case 13:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    com.google.android.gms.maps.model.internal.f addTileOverlay = addTileOverlay(data.readInt() != 0 ? TileOverlayOptions.CREATOR.mo386createFromParcel(data) : null);
                    reply.writeNoException();
                ...
                case 35:
                    data.enforceInterface("com.google.android.gms.maps.internal.IGoogleMapDelegate");
                    com.google.android.gms.maps.model.internal.b addCircle = addCircle(data.readInt() != 0 ? CircleOptions.CREATOR.mo370createFromParcel(data) : null);
                    reply.writeNoException();
                    if (addCircle != null) {
