...
public final class TileOverlayOptions implements SafeParcelable {
    ...
    public TileOverlayOptions(int versionCode, IBinder delegate, boolean visible, float zIndex, boolean fadeIn) {
        ...
        this.Db = this.Da == null ? null : new TileProvider() { // from class: com.google.android.gms.maps.model.TileOverlayOptions.1
            private final com.google.android.gms.maps.model.internal.g Dd;

            {
                this.Dd = TileOverlayOptions.this.Da;
            }
    ...
    public TileOverlayOptions tileProvider(final TileProvider tileProvider) {
        ...
        this.Da = this.Db == null ? null : new g.a() { // from class: com.google.android.gms.maps.model.TileOverlayOptions.2
