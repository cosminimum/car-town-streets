...
public final class CameraPosition implements SafeParcelable {
    ...
    public CameraPosition(int versionCode, LatLng target, float zoom, float tilt, float bearing) {
        ...
        eg.b(BitmapDescriptorFactory.HUE_RED <= tilt && tilt <= 90.0f, "Tilt needs to be between 0 and 90 inclusive");
        this.kg = versionCode;
        this.target = target;
        this.zoom = zoom;
    ...
    public static CameraPosition createFromAttributes(Context context, AttributeSet attrs) {
        ...
        LatLng latLng = new LatLng(obtainAttributes.hasValue(2) ? obtainAttributes.getFloat(2, BitmapDescriptorFactory.HUE_RED) : 0.0f, obtainAttributes.hasValue(3) ? obtainAttributes.getFloat(3, BitmapDescriptorFactory.HUE_RED) : 0.0f);
