...
public class fq {
    ...
    private static final class b extends fq implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            View view;
            if (this.uL == null || (view = this.uL.get()) == null) {
                return;
            }
            f(view);
        }
    ...
    public void dl() {
        this.te.a(this.uI.uJ, this.uI.m359do());
    }

    public Bundle dm() {
        return this.uI.m359do();
    }
