...
public interface bt extends IInterface {
    ...
    public static abstract class a extends Binder implements bt {
        ...
        /* renamed from: com.google.android.gms.internal.bt$a$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        private static class C0028a implements bt {
            private IBinder dU;
        ...
        public static bt n(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bt)) ? new C0028a(iBinder) : (bt) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder a = a(b.a.E(data.readStrongBinder()));
