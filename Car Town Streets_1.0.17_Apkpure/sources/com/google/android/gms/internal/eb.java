...
public interface eb extends IInterface {
    ...
    /* loaded from: classes.dex */
    public static abstract class a extends Binder implements eb {

        /* renamed from: com.google.android.gms.internal.eb$a$a  reason: collision with other inner class name */
        /* loaded from: classes.dex */
        private static class C0036a implements eb {
            private IBinder dU;
        ...
        public static eb x(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof eb)) ? new C0036a(iBinder) : (eb) queryLocalInterface;
        }
