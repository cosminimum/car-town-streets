...
public interface hr extends IInterface {
    ...
    public static abstract class a extends Binder implements hr {
        ...
        /* loaded from: classes.dex */
        private static class C0051a implements hr {
            private IBinder dU;
        ...
        public static hr ax(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hr)) ? new C0051a(iBinder) : (hr) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 34:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusService");
                    a(ho.a.au(data.readStrongBinder()), data.createStringArrayList());
                    reply.writeNoException();
                    return true;
                case 40:
                    data.enforceInterface("com.google.android.gms.plus.internal.IPlusService");
