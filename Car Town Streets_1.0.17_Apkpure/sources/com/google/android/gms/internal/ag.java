...
public final class ag {
    ...
    private void T() {
        try {
            com.google.android.gms.dynamic.b x = this.eX.x();
            if (x == null) {
                return;
            }
            this.eY.addView((View) com.google.android.gms.dynamic.c.b(x));
    ...
    public void setAppEventListener(AppEventListener appEventListener) {
        try {
            ...
            this.eX.a(appEventListener != null ? new z(appEventListener) : null);
        } catch (RemoteException e) {
