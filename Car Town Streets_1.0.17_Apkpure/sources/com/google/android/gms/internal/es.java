...
public abstract class es {
    ...
    public static class a<I, O> implements SafeParcelable {
        ...
        public static a a(String str, int i, b<?, ?> bVar, boolean z) {
            return new a(bVar.ch(), z, bVar.ci(), false, str, i, null, bVar);
        }
        ...
        public String toString() {
            ...
            sb.append("       concreteTypeName=").append(cs()).append('\n');
            if (cr() != null) {
                sb.append("     concreteType.class=").append(cr().getCanonicalName()).append('\n');
            }
            sb.append("          converterName=").append(this.qr == null ? "null" : this.qr.getClass().getCanonicalName()).append('\n');
            return sb.toString();
        }
    ...
    private void a(StringBuilder sb, a aVar, Object obj) {
        if (aVar.ch() == 11) {
            sb.append(aVar.cr().cast(obj).toString());
        } else if (aVar.ch() != 7) {
            sb.append(obj);
        } else {
            sb.append("\"");
    ...
    public <O, I> I a(a<I, O> aVar, Object obj) {
        return ((a) aVar).qr != null ? aVar.g(obj) : obj;
    }
