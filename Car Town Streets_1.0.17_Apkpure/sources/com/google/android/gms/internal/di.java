...
public interface di extends IInterface {
    ...
    public static abstract class a extends Binder implements di {
        ...
        /* loaded from: classes.dex */
        private static class C0033a implements di {
            private IBinder dU;
            ...
            public void E(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.cast.internal.ICastDeviceController");
                    obtain.writeString(str);
                    this.dU.transact(11, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void F(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.cast.internal.ICastDeviceController");
                    obtain.writeString(str);
                    this.dU.transact(12, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void a(double d, double d2, boolean z) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.dU.transact(7, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void a(String str, String str2, long j) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeLong(j);
                    this.dU.transact(9, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void a(String str, byte[] bArr, long j) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeLong(j);
                    this.dU.transact(10, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void a(boolean z, double d, boolean z2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.dU.transact(8, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void aV() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.cast.internal.ICastDeviceController");
                    this.dU.transact(6, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public static di v(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof di)) ? new C0033a(iBinder) : (di) queryLocalInterface;
        }
