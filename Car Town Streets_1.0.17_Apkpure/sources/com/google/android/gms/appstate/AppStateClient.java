...
public final class AppStateClient implements GooglePlayServicesClient {
    ...
    public void deleteState(final OnStateDeletedListener listener, int stateKey) {
        this.jx.a(new a.c<AppStateManager.StateDeletedResult>() { // from class: com.google.android.gms.appstate.AppStateClient.1
            @Override // com.google.android.gms.common.api.a.c
    ...
    public void listStates(final OnStateListLoadedListener listener) {
        this.jx.a(new a.c<AppStateManager.StateListResult>() { // from class: com.google.android.gms.appstate.AppStateClient.2
            @Override // com.google.android.gms.common.api.a.c
    ...
    @Deprecated
    public void signOut() {
        this.jx.b(new a.c<Status>() { // from class: com.google.android.gms.appstate.AppStateClient.3
            @Override // com.google.android.gms.common.api.a.c
    ...
    public void signOut(final OnSignOutCompleteListener listener) {
        eg.b(listener, "Must provide a valid listener");
        this.jx.b(new a.c<Status>() { // from class: com.google.android.gms.appstate.AppStateClient.4
            @Override // com.google.android.gms.common.api.a.c
            public void a(Status status) {
    ...
    public void updateState(int stateKey, byte[] data) {
        this.jx.a(new a(null), stateKey, data);
    }
