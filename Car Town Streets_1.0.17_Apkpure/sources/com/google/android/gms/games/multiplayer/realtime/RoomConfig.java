...
public final class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.wI = false;
            this.wD = (RoomUpdateListener) eg.b(updateListener, "Must provide a RoomUpdateListener");
        }
        ...
        public Builder setVariant(int variant) {
            eg.b(variant == -1 || variant > 0, "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.wo = variant;
            return this;
        }
    }
