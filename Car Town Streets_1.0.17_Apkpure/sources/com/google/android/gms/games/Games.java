...
public final class Games {
    static final Api.b<fl> jO = new Api.b<fl>() { // from class: com.google.android.gms.games.Games.1
    ...
    /* loaded from: classes.dex */
    public static abstract class a<R extends Result> extends a.AbstractC0011a<R, fl> implements PendingResult<R> {
        public a() {
            super(Games.jO);
        }
    }
    ...
    public static PendingResult<Status> signOut(GoogleApiClient apiClient) {
        return apiClient.b(new b() { // from class: com.google.android.gms.games.Games.2
