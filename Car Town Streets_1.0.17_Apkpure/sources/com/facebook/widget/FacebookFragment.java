    ...
    private void openSession(String applicationId, List<String> permissions, SessionLoginBehavior behavior, int activityCode, SessionAuthorizationType authType) {
        if (this.sessionTracker != null) {
            ...
            if (!currentSession.isOpened()) {
                Session.OpenRequest openRequest = new Session.OpenRequest(this).mo22setPermissions(permissions).mo21setLoginBehavior(behavior).mo23setRequestCode(activityCode);
