...
public interface GraphObject {
    ...
    public static final class Factory {
        ...
        public static boolean hasSameId(GraphObject a, GraphObject b) {
            if (a == null || b == null || !a.asMap().containsKey(Constants.APP_ID) || !b.asMap().containsKey(Constants.APP_ID)) {
                return false;
            }
            if (a.equals(b)) {
                return true;
            }
            Object idA = a.getProperty(Constants.APP_ID);
            Object idB = b.getProperty(Constants.APP_ID);
        ...
        public static <T extends GraphObject> T createGraphObjectProxy(Class<T> graphObjectClass, JSONObject state) {
            ...
            T graphObject = (T) Proxy.newProxyInstance(GraphObject.class.getClassLoader(), new Class[]{graphObjectClass}, graphObjectProxy);
            return graphObject;
        }
