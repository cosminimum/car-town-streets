...
public class TJCOffers {
    ...
    public void showOffers() {
        TapjoyLog.m4436i(TAPJOY_OFFERS, "Showing offers with userID: " + TapjoyConnectCore.getUserID());
    ...
    public void showOffersWithCurrencyID(String currencyID, boolean enableCurrencySelector) {
        TapjoyLog.m4436i(TAPJOY_OFFERS, "Showing offers with currencyID: " + currencyID + ", selector: " + enableCurrencySelector + " (userID = " + TapjoyConnectCore.getUserID() + ")");
    ...
    public void spendTapPoints(int amount, TapjoySpendPointsNotifier notifier) {
        if (amount < 0) {
            TapjoyLog.m4435e(TAPJOY_POINTS, "spendTapPoints error: amount must be a positive number");
            return;
        }
    ...
    public synchronized boolean handleGetPointsResponse(String response) {
        ...
        if (document != null) {
            ...
            if (nodeValue == null || !nodeValue.equals("true")) {
                TapjoyLog.m4435e(TAPJOY_POINTS, "Invalid XML: Missing <Success> tag.");
            } else {
                ...
                if (points == null || name == null) {
                    TapjoyLog.m4435e(TAPJOY_POINTS, "Invalid XML: Missing tags.");
                } else {
                    try {
                        ...
                        if (!(tapjoyEarnedPointsNotifier == null || lastLocalPointTotal == -9999 || pointTotal <= lastLocalPointTotal)) {
                            TapjoyLog.m4436i(TAPJOY_POINTS, "earned: " + (pointTotal - lastLocalPointTotal));
                        ...
                        TapjoyLog.m4435e(TAPJOY_POINTS, "Error parsing XML.");
                    }
                }
            }
        }
    ...
    public boolean handleSpendPointsResponse(String response) {
        ...
        if (document != null) {
            ...
            if (nodeValue != null && nodeValue.equals("true")) {
                ...
                TapjoyLog.m4436i(TAPJOY_POINTS, message);
