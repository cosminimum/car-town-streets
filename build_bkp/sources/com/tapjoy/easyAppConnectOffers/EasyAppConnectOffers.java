...
public class EasyAppConnectOffers extends Activity implements TapjoyNotifier, TapjoyFeaturedAppNotifier, TapjoySpendPointsNotifier, TapjoyDisplayAdNotifier, TapjoyAwardPointsNotifier, TapjoyEarnedPointsNotifier {
    ...
    public void getUpdatePoints(String currencyName, int pointTotal) {
        ...
        final int pointTotalFinal = pointTotal;
        cocojava.mGLView.queueEvent(new Runnable() {
            public void run() {
                CocoJNI.MsetTapjoyCoins(pointTotalFinal);
            }
        });
    ...
    public void getFeaturedAppResponse(TapjoyFeaturedAppObject featuredApObject) {
        ...
        cocojava cocojava = (cocojava) this;
    ...
    public void getDisplayAdResponse(View view) {
        this.adView = view;
        Log.i("EASY_APP", "adView dimensions: " + this.adView.getLayoutParams().width + Constants.f677X + this.adView.getLayoutParams().height);
        if (this.adView.getLayoutParams().width > this.adLinearLayout.getMeasuredWidth()) {
            this.adView.setLayoutParams(new ViewGroup.LayoutParams(this.adLinearLayout.getMeasuredWidth(), (this.adLinearLayout.getMeasuredWidth() * 10) / 64));
        }
        Log.i("EASY_APP", "adLinearLayout dimensions: " + this.adLinearLayout.getMeasuredWidth() + Constants.f677X + this.adLinearLayout.getMeasuredHeight());
