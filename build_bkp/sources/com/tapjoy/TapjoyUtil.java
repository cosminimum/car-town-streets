...
public class TapjoyUtil {
    ...
    public static Document buildDocument(String xml) {
        try {
            ...
            TapjoyLog.m4435e(TAPJOY_UTIL, "buildDocument exception: " + e.toString());
            return null;
        }
    }
    ...
    public static void deleteFileOrDirectory(File fileOrDirectory) {
        ...
        TapjoyLog.m4436i(TAPJOY_UTIL, "****************************************");
        TapjoyLog.m4436i(TAPJOY_UTIL, "deleteFileOrDirectory: " + fileOrDirectory.getAbsolutePath());
        TapjoyLog.m4436i(TAPJOY_UTIL, "****************************************");
