...
class JoinerMacro extends FunctionCallImplementation {
    ...
    /* renamed from: ID */
    private static final String f3931ID = FunctionType.JOINER.toString();
    ...
    public TypeSystem.Value evaluate(Map<String, TypeSystem.Value> parameters) {
        ...
        if (escapeParameter != null) {
            ...
            if (PlusShare.KEY_CALL_TO_ACTION_URL.equals(escape)) {
                ...
                Log.m4388e("Joiner: unsupported escape type: " + escape);
                return Types.getDefaultValue();
            }
        }
        ...
        switch (escapeType) {
            case URL:
                try {
                    ...
                    Log.m4389e("Joiner: unsupported encoding", e);
                    return s;
                }
            case BACKSLASH:
                String s2 = s.replace("\\", "\\\\");
