...
class ArbitraryPixelTag extends TrackingTag {
    ...
    static final String ARBITRARY_PIXEL_UNREPEATABLE = ("gtm_" + f3915ID + "_unrepeatable");

    /* renamed from: ID */
    private static final String f3915ID = FunctionType.ARBITRARY_PIXEL.toString();
        ...
        if (unrepeatableId == null || !idProcessed(unrepeatableId)) {
            ...
            if (additionalParamsList != null) {
                ...
                if (!(l instanceof List)) {
                    Log.m4388e("ArbitraryPixel: additional params not a list: not sending partial hit: " + uriBuilder.build().toString());
                    return;
                }
                for (Object m : (List) l) {
                    if (!(m instanceof Map)) {
                        Log.m4388e("ArbitraryPixel: additional params contains non-map: not sending partial hit: " + uriBuilder.build().toString());
                        return;
                    }
            ...
            Log.m4392v("ArbitraryPixel: url = " + uri);
