...
class PersistentHitStore implements HitStore {
    ...
    private void removeOldHitIfFull() {
        ...
        if (hitsOverLimit > 0) {
            ...
            Log.m4392v("Store full, deleting " + hitsToDelete.size() + " hits to make room.");
    ...
    public List<String> peekHitIds(int maxHits) {
        ...
        if (maxHits <= 0) {
            Log.m4394w("Invalid maxHits specified. Skipping");
        } else {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    Log.m4394w("Error in peekHits fetching hitIds: " + e.getMessage());
                    if (cursor != null) {
                        cursor.close();
                    }
                } catch (Throwable th) {
    ...
    public java.util.List<com.google.tagmanager.Hit> peekHits(int r23) {
        ...
        L_0x00d1:
            ...
            com.google.tagmanager.Log.m4394w(r3)     // Catch:{ all -> 0x00f4 }
        ...
        L_0x00fb:
            ...
            com.google.tagmanager.Log.m4394w(r3)     // Catch:{ SQLiteException -> 0x011b }
            goto L_0x00bf
        L_0x011b:
            r15 = move-exception
            ...
            com.google.tagmanager.Log.m4394w(r3)     // Catch:{ all -> 0x016c }
    ...
    public void deleteHits(String[] hitIds) {
        ...
        if (hitIds != null && hitIds.length != 0 && (db = getWritableDatabase("Error opening database for deleteHits.")) != null) {
            try {
                ...
                Log.m4394w("Error deleting hits");
            }
        }
    }
    ...
    public void setHitFirstDispatchTime(long hitId, long firstDispatchTime) {
        ...
        if (db != null) {
            ...
            try {
                ...
                Log.m4394w("Error setting HIT_FIRST_DISPATCH_TIME for hitId: " + hitId);
                deleteHit(hitId);
            }
        }
    }
    ...
    public int getNumStoredHits() {
        ...
        try {
            ...
            Log.m4394w("Error getting numStoredHits");
            if (cursor != null) {
                cursor.close();
            }
        } catch (Throwable th) {
    ...
    public int getNumStoredUntriedHits() {
        ...
        try {
            ...
            Log.m4394w("Error getting num untried hits");
            if (cursor != null) {
                cursor.close();
            }
        } catch (Throwable th) {
    ...
    public void dispatch() {
        Log.m4392v("GTM Dispatch running...");
        if (this.mDispatcher.okToDispatch()) {
            List<Hit> hits = peekHits(40);
            if (hits.isEmpty()) {
                Log.m4392v("...nothing to dispatch");
    ...
    class StoreDispatchListener implements SimpleNetworkDispatcher.DispatchListener {
        ...
        public void onHitPermanentDispatchFailure(Hit hit) {
            PersistentHitStore.this.deleteHit(hit.getHitId());
            Log.m4392v("Permanent failure dispatching hitId: " + hit.getHitId());
        }
        ...
        public void onHitTransientDispatchFailure(Hit hit) {
            ...
            if (firstDispatchTime == 0) {
                ...
                PersistentHitStore.this.deleteHit(hit.getHitId());
                Log.m4392v("Giving up on failed hitId: " + hit.getHitId());
            }
        }
    }
    ...
    public void close() {
        try {
            ...
            Log.m4394w("Error opening database for close");
        }
    }
    ...
    class UrlDatabaseHelper extends SQLiteOpenHelper {
        ...
        private boolean tablePresent(String table, SQLiteDatabase db) {
            ...
            try {
                ...
                Log.m4394w("Error querying for table " + table);
                if (cursor != null) {
                    cursor.close();
                }
                return false;
