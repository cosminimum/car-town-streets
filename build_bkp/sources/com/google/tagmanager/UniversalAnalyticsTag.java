...
class UniversalAnalyticsTag extends TrackingTag {
    ...
    /* renamed from: ID */
    private static final String f3950ID = FunctionType.UNIVERSAL_ANALYTICS.toString();
    ...
    public void evaluateTrackingTag(Map<String, TypeSystem.Value> tag) {
        ...
        if (checkBooleanProperty(tag, ANALYTICS_PASS_THROUGH)) {
            ...
            Log.m4394w("Ignoring unknown tag.");
        }
    ...
    private void sendTransaction(Tracker tracker, Map<String, TypeSystem.Value> tag) {
        ...
        String transactionId = getDataLayerString(Constants.TRANSACTION_ID);
        if (transactionId == null) {
            Log.m4388e("Cannot find transactionId in data layer.");
            return;
        }
        ...
        try {
            ...
            if (items != null) {
                for (Map<String, String> item : items) {
                    if (item.get("name") == null) {
                        Log.m4388e("Unable to send transaction item hit due to missing 'name' field.");
                        return;
                    }
            ...
            Log.m4389e("Unable to send transaction", e);
        }
    }
    ...
    private Map<String, String> getTransactionFields(Map<String, TypeSystem.Value> tag) {
        ...
        if (defaultTransactionMap == null) {
            ...
            defaultMap.put(Constants.TRANSACTION_ID, Fields.TRANSACTION_ID);
