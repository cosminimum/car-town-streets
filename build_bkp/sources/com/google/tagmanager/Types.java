...
class Types {
    ...
    public static TypeSystem.Value objectToValue(Object o) {
        ...
        if (o instanceof String) {
            ...
            Log.m4388e("Converting to Value from unknown object type: " + (o == null ? "null" : o.getClass().toString()));
            return DEFAULT_VALUE;
        }
        if (containsRef2) {
    ...
    private static double getDouble(Object o) {
        ...
        Log.m4388e("getDouble received non-Number");
        return 0.0d;
    }
    ...
    private static long getInt64(Object o) {
        ...
        Log.m4388e("getInt64 received non-Number");
        return 0;
    }
    ...
    private static TypedNumber parseNumber(String s) {
        try {
            ...
            Log.m4388e("Failed to convert '" + s + "' to a number.");
            return DEFAULT_NUMBER;
        }
    }
        ...
        switch (v.getType()) {
            ...
            case MAP:
                if (v.getMapKeyCount() != v.getMapValueCount()) {
                    Log.m4388e("Converting an invalid value to object: " + v.toString());
                    return DEFAULT_OBJECT;
                }
            ...
            case MACRO_REFERENCE:
                Log.m4388e("Trying to convert a macro reference to object");
                return DEFAULT_OBJECT;
            case FUNCTION_ID:
                Log.m4388e("Trying to convert a function id to object");
                return DEFAULT_OBJECT;
            case INTEGER:
            ...
            default:
                Log.m4388e("Failed to convert a value of type: " + v.getType());
                return DEFAULT_OBJECT;
        }
    }
}
