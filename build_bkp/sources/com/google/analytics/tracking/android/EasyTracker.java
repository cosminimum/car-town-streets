...
public class EasyTracker extends Tracker {
    ...
    private void loadParameters() {
        ...
        Log.m1076v("Starting EasyTracker.");
        ...
        if (!(logLevelString == null || (logLevel = getLogLevelFromString(logLevelString)) == null)) {
            Log.m1076v("[EasyTracker] log level loaded: " + logLevel);
        ...
        Log.m1076v("[EasyTracker] sample rate loaded: " + sampleRate);
        int dispatchPeriod = this.mParameterFetcher.getInt("ga_dispatchPeriod", 1800);
        Log.m1076v("[EasyTracker] dispatch period loaded: " + dispatchPeriod);
        ...
        Log.m1076v("[EasyTracker] session timeout loaded: " + this.mSessionTimeout);
        ...
        Log.m1076v("[EasyTracker] auto activity tracking loaded: " + this.mIsAutoActivityTracking);
        ...
        if (isAnonymizeIpEnabled) {
            ...
            Log.m1076v("[EasyTracker] anonymize ip loaded: " + isAnonymizeIpEnabled);
        }
        ...
        if (this.mIsReportUncaughtExceptionsEnabled) {
            ...
            Log.m1076v("[EasyTracker] report uncaught exceptions loaded: " + this.mIsReportUncaughtExceptionsEnabled);
        }
    ...
    private void setContext(Context ctx, ParameterLoader parameterLoader, ServiceManager serviceManager) {
        if (ctx == null) {
            Log.m1074e("Context cannot be null");
        }
