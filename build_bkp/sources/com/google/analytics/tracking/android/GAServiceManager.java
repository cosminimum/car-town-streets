...
public class GAServiceManager extends ServiceManager {
    ...
    public synchronized void dispatchLocalHits() {
        if (this.thread == null) {
            Log.m1076v("Dispatch call queued. Dispatch will run once initialization is complete.");
    ...
    public synchronized void setLocalDispatchPeriod(int dispatchPeriodInSeconds2) {
        if (this.handler == null) {
            Log.m1076v("Dispatch period set with null handler. Dispatch will run once initialization is complete.");
    ...
    public void setForceLocalDispatch() {
        if (this.thread == null) {
            Log.m1076v("setForceLocalDispatch() queued. It will be called once initialization is complete.");
    ...
    public synchronized void updatePowerSaveMode(boolean storeIsEmpty2, boolean connected2) {
        if (!(this.storeIsEmpty == storeIsEmpty2 && this.connected == connected2)) {
            ...
            Log.m1076v("PowerSaveMode " + ((storeIsEmpty2 || !connected2) ? "initiated." : "terminated."));
