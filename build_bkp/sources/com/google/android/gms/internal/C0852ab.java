...
public interface C0852ab extends IInterface {

    /* renamed from: com.google.android.gms.internal.ab$a */
    public static abstract class C0853a extends Binder implements C0852ab {

        /* renamed from: com.google.android.gms.internal.ab$a$a */
        private static class C0854a implements C0852ab {

            /* renamed from: dU */
            private IBinder f1906dU;

            C0854a(IBinder iBinder) {
                this.f1906dU = iBinder;
            }
            ...
            public void onAdClosed() throws RemoteException {
                ...
                try {
                    ...
                    this.f1906dU.transact(1, obtain, obtain2, 0);
            ...
            public void onAdFailedToLoad(int errorCode) throws RemoteException {
                ...
                try {
                    ...
                    this.f1906dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onAdLeftApplication() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f1906dU.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onAdLoaded() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f1906dU.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onAdOpened() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdListener");
                    this.f1906dU.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: e */
        public static C0852ab m1896e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0852ab)) ? new C0854a(iBinder) : (C0852ab) queryLocalInterface;
        }
