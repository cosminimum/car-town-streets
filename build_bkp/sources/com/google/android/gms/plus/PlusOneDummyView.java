...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C1613a implements C1616d {
        private Context mContext;

        private C1613a(Context context) {
    ...
    private static class C1614b implements C1616d {
        private Context mContext;

        private C1614b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C1615c implements C1616d {
        private Context mContext;

        private C1615c(Context context) {
            this.mContext = context;
        }
    ...
    public PlusOneDummyView(Context context, int size) {
        ...
        button.setBackgroundDrawable(m4321eN().getDrawable(size));
        Point bi = m4320bi(size);
        addView(button, new FrameLayout.LayoutParams(bi.x, bi.y, 17));
    }

    /* renamed from: bi */
    private Point m4320bi(int i) {
        int i2 = 24;
        int i3 = 20;
    ...
    /* renamed from: eN */
    private C1616d m4321eN() {
        C1616d bVar = new C1614b(getContext());
        if (!bVar.isValid()) {
            bVar = new C1615c(getContext());
        }
        return !bVar.isValid() ? new C1613a(getContext()) : bVar;
    }
}
