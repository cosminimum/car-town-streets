...
public final class CastMediaControlIntent {
    ...
    private static java.lang.String m1176a(java.lang.String r4, java.lang.String r5, java.util.Collection<java.lang.String> r6) throws java.lang.IllegalArgumentException {
        /*
        ...
        L_0x0081:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.cast.CastMediaControlIntent.m1176a(java.lang.String, java.lang.String, java.util.Collection):java.lang.String");
    }

    public static String categoryForCast(String applicationId) throws IllegalArgumentException {
        if (applicationId != null) {
            return m1176a(CATEGORY_CAST, applicationId, (Collection<String>) null);
        }
    ...
    public static String categoryForCast(String applicationId, Collection<String> namespaces) {
        if (applicationId == null) {
            ...
            return m1176a(CATEGORY_CAST, applicationId, namespaces);
        } else {
    ...
    public static String categoryForCast(Collection<String> namespaces) throws IllegalArgumentException {
        if (namespaces != null) {
            return m1176a(CATEGORY_CAST, (String) null, namespaces);
        }
        throw new IllegalArgumentException("namespaces cannot be null");
    }

    public static String categoryForRemotePlayback() {
        return m1176a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", (String) null, (Collection<String>) null);
    }

    public static String categoryForRemotePlayback(String applicationId) throws IllegalArgumentException {
        if (!TextUtils.isEmpty(applicationId)) {
            return m1176a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", applicationId, (Collection<String>) null);
        }
