...
public interface C1538j extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.j$a */
    public static abstract class C1539a extends Binder implements C1538j {

        /* renamed from: com.google.android.gms.maps.internal.j$a$a */
        private static class C1540a implements C1538j {

            /* renamed from: dU */
            private IBinder f3605dU;

            C1540a(IBinder iBinder) {
                this.f3605dU = iBinder;
            }
            ...
            public void onMapLongClick(LatLng point) throws RemoteException {
                ...
                try {
                    ...
                    this.f3605dU.transact(1, obtain, obtain2, 0);
        ...
        /* renamed from: ab */
        public static C1538j m4179ab(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1538j)) ? new C1540a(iBinder) : (C1538j) queryLocalInterface;
        }
