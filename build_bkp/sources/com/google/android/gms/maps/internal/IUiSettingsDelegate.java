...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class C1511a extends Binder implements IUiSettingsDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IUiSettingsDelegate$a$a */
        private static class C1512a implements IUiSettingsDelegate {

            /* renamed from: dU */
            private IBinder f3596dU;

            C1512a(IBinder iBinder) {
                this.f3596dU = iBinder;
            }
            ...
            public boolean isCompassEnabled() throws RemoteException {
                ...
                try {
                    ...
                    this.f3596dU.transact(10, obtain, obtain2, 0);
            ...
            public boolean isMyLocationButtonEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isRotateGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(15, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isScrollGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isTiltGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(14, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomControlsEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isZoomGesturesEnabled() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IUiSettingsDelegate");
                    this.f3596dU.transact(13, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public void setAllGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setCompassEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setMyLocationButtonEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setRotateGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setScrollGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setTiltGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomControlsEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZoomGesturesEnabled(boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3596dU.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: ai */
        public static IUiSettingsDelegate m4148ai(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IUiSettingsDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C1512a(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
