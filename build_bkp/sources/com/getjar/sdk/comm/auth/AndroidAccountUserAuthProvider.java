...
public class AndroidAccountUserAuthProvider implements UserAuthProvider {
    ...
    public static String getAccountNameFromHash(Context context, String accountNameHash) {
        String str;
        Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: getAccountNameFromHash() START");
        if (context == null) {
            throw new IllegalArgumentException("'commContext' cannot be NULL");
        } else if (StringUtility.isNullOrEmpty(accountNameHash)) {
            Logger.m648w(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: getAccountNameFromHash() null or empty 'accountNameHash' provided");
            return null;
        } else {
            ...
            try {
                ...
                Logger.m643e(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: getAccountNameFromHash() FAILED", e);
                return accountName;
            } finally {
                str = "AuthFlow: AndroidAccountUserAuthProvider: getAccountNameFromHash() FINISHED Returning %1$s";
                Logger.m640d(Area.AUTH.value(), String.format(Locale.US, str, new Object[]{accountName}));
            }
        }
    }
    ...
    public UserAuthResult ensureUser(String currentAuthToken, CommContext commContext, String authFlowId, AuthUIParentInterface uiParent, ProviderHint providerHint) {
        if (StringUtility.isNullOrEmpty(currentAuthToken)) {
            ...
            Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() START");
            try {
                Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() Calling userAccessEnsure()");
                try {
                    Result result = AuthorizationServiceProxy.getInstance().userAccessEnsure(commContext, authFlowId, currentAuthToken, getProviderData(commContext, uiParent, providerHint), getProviderFilter()).get();
                    if (result == null) {
                        Logger.m642e(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() failed to get results");
                        UserAuthResult userAuthResult = new UserAuthResult(getProviderFilter(), AuthResult.State.UNKNOWN_FAILURE);
                        Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE");
                        return userAuthResult;
                    } else if (result.isSuccessfulResponse()) {
                        Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() got successful results");
                        ...
                        Logger.m640d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE [userAccessId:%1$s, userDeviceId%2$s, authToken:%3$s, claimsCount:%4$d, ttl:%5$d]", new Object[]{authResult.getUserAccessId(), authResult.getUserDeviceId(), authResult.getAuthToken(), Integer.valueOf(authResult.getClaims().size()), Long.valueOf(authResult.getTTL())}));
                        Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE");
                        return authResult;
                    } else {
                        Logger.m648w(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() got failure results");
                        ...
                        if (result.checkForBlacklistedOrUnsupported(commContext)) {
                            Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() We are blacklisted or unsupported");
                    ...
                    Logger.m643e(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() operation.get() failed", e2);
                    ...
                    Logger.m643e(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() operation.get() failed", e3);
                ...
                Logger.m643e(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() failed", e4);
                Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE");
    ...
    public boolean isUINeeded(CommContext commContext, String authFlowId, ProviderHint providerHint) {
        ...
        if (!isProviderHintForMe(providerHint) || StringUtility.isNullOrEmpty(this._accountResolver.getAndroidAccountNameViaHint(commContext, providerHint))) {
            return true;
        }
        return false;
    }
    ...
    private Map<String, MetadataValue> getProviderData(CommContext commContext, AuthUIParentInterface uiParent, ProviderHint providerHint) {
        ...
        if (deviceMetadata == null || deviceMetadata.size() <= 0) {
            Logger.m648w(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() failed to get device metadata");
            return null;
        }
        ...
        if (!StringUtility.isNullOrEmpty(androidAccountName) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName, commContext)) != null) {
            Logger.m640d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:cache]", new Object[]{androidAccountName}));
        }
        if (androidAccount == null) {
            if (isProviderHintForMe(providerHint)) {
                ...
                if (!StringUtility.isNullOrEmpty(androidAccountName2) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName2, commContext)) != null) {
                    Logger.m640d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:hint]", new Object[]{androidAccountName2}));
            ...
            if (androidAccount == null) {
                ...
                if (!StringUtility.isNullOrEmpty(androidAccountName3) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName3, commContext)) != null) {
                    Logger.m640d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:ui]", new Object[]{androidAccountName3}));
                    setUserAuthProviderAndData(commContext, androidAccountName3);
                }
            }
            if (androidAccount == null) {
                setUserAuthProviderAndData(commContext, (String) null);
                Logger.m648w(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() failed to get android account name");
                return null;
            }
        }
    ...
    private boolean validateUserAuthProviderAndDataCacheEntry(UserAuthProviderAndDataCacheEntry providerAndData) {
        if (providerAndData == null) {
            Logger.m646v(Area.AUTH.value() | Area.STORAGE.value(), "AuthFlow: AndroidAccountUserAuthProvider: validateUserAuthProviderAndDataCacheEntry(): No cached provider data found");
            return false;
        } else if (!providerAndData.getUserAuthProviderType().isInstance(this)) {
            Logger.m646v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: validateUserAuthProviderAndDataCacheEntry(): Cached provider data is for '%1$s' and is not usable by '%2$s'", new Object[]{providerAndData.getUserAuthProviderType().getName(), getClass().getName()}));
            return false;
            ...
            Logger.m646v(Area.AUTH.value() | Area.STORAGE.value(), "AuthFlow: AndroidAccountUserAuthProvider: validateUserAuthProviderAndDataCacheEntry(): Cached provider data found without required content");
            return false;
        }
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r6v6, resolved type: java.lang.Object} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry} */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry getUserAuthProviderAndData(android.content.Context r14) {
        /*
            r13 = this;
            r5 = 0
            com.getjar.sdk.data.CachingManager r1 = new com.getjar.sdk.data.CachingManager
            android.content.Context r6 = r14.getApplicationContext()
            java.lang.String r7 = "androidAccountUserAuthCache"
            r1.<init>((android.content.Context) r6, (java.lang.String) r7)
            java.lang.String r6 = "userAuthProviderAndData"
            com.getjar.sdk.data.CacheEntry r3 = r1.getCacheEntry(r6)
            if (r3 != 0) goto L_0x0015
        L_0x0014:
            return r5
        L_0x0015:
            java.lang.String r4 = r3.getValue()
            boolean r6 = com.getjar.sdk.utilities.StringUtility.isNullOrEmpty(r4)
            if (r6 != 0) goto L_0x0014
            r5 = 0
            java.lang.Object r6 = com.getjar.sdk.utilities.Base64.decodeToObject(r4)     // Catch:{ Exception -> 0x004f }
            r0 = r6
            com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry r0 = (com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry) r0     // Catch:{ Exception -> 0x004f }
            r5 = r0
            com.getjar.sdk.logging.Area r6 = com.getjar.sdk.logging.Area.AUTH     // Catch:{ Exception -> 0x004f }
            long r6 = r6.value()     // Catch:{ Exception -> 0x004f }
            com.getjar.sdk.logging.Area r8 = com.getjar.sdk.logging.Area.STORAGE     // Catch:{ Exception -> 0x004f }
            long r8 = r8.value()     // Catch:{ Exception -> 0x004f }
            long r6 = r6 | r8
            java.util.Locale r8 = java.util.Locale.US     // Catch:{ Exception -> 0x004f }
            java.lang.String r9 = "AuthFlow: AndroidAccountUserAuthProvider: Using cached UserAuthProviderAndDataCacheEntry [%1$s]"
            r10 = 1
            java.lang.Object[] r10 = new java.lang.Object[r10]     // Catch:{ Exception -> 0x004f }
            r11 = 0
            java.lang.Class r12 = r5.getUserAuthProviderType()     // Catch:{ Exception -> 0x004f }
            java.lang.String r12 = r12.getName()     // Catch:{ Exception -> 0x004f }
            r10[r11] = r12     // Catch:{ Exception -> 0x004f }
            java.lang.String r8 = java.lang.String.format(r8, r9, r10)     // Catch:{ Exception -> 0x004f }
            com.getjar.sdk.logging.Logger.m640d(r6, r8)     // Catch:{ Exception -> 0x004f }
            goto L_0x0014
        L_0x004f:
            r2 = move-exception
            com.getjar.sdk.logging.Area r6 = com.getjar.sdk.logging.Area.AUTH
            long r6 = r6.value()
            com.getjar.sdk.logging.Area r8 = com.getjar.sdk.logging.Area.STORAGE
            long r8 = r8.value()
            long r6 = r6 | r8
            java.lang.String r8 = "AuthFlow: AndroidAccountUserAuthProvider: Deserialization of UserAuthProviderAndDataCacheEntry failed"
            com.getjar.sdk.logging.Logger.m643e(r6, r8, r2)
            goto L_0x0014
        */
        throw new UnsupportedOperationException("Method not decompiled: com.getjar.sdk.comm.auth.AndroidAccountUserAuthProvider.getUserAuthProviderAndData(android.content.Context):com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry");
    }

    private void setUserAuthProviderAndData(CommContext commContext, String accountName) {
        Logger.m646v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: Updating cached UserAuthProviderAndDataCacheEntry [type:%1$s data:%2$s]", new Object[]{AndroidAccountUserAuthProvider.class.getName(), accountName}));
        HashMap<String, String> providerDataToCache = new HashMap<>(1);
        providerDataToCache.put(_KeyProviderDataName, accountName);
        try {
            new CachingManager(commContext.getApplicationContext(), _CacheName).updateCache(_KeyUserAuthProviderAndData, Base64.encodeObject(new UserAuthProviderAndDataCacheEntry(AndroidAccountUserAuthProvider.class, providerDataToCache)), Long.MAX_VALUE, (String) null, (URI) null);
        } catch (IOException e) {
    ...
    private class AndroidAccountResolver {
        ...
        /* access modifiers changed from: private */
        public AlertDialog _createdDialog;
        ...
        public boolean validateAccountAgainstCache(CommContext commContext, CharSequence accountName) {
            ...
            Logger.m646v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() cached account and available account do not match [cache:%1$s available:%2$s]", new Object[]{cachedAccountName, accountName}));
            return false;
        }

        /* access modifiers changed from: private */
        public String getAndroidAccountNameViaHint(CommContext commContext, ProviderHint providerHint) {
            Logger.m640d(Area.AUTH.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaHint() START");
            if (commContext == null) {
                throw new IllegalArgumentException("'commContext' cannot be NULL");
        ...
        public String getAndroidAccountNameViaUI(CommContext commContext, AuthUIParentInterface uiParent) {
            Logger.m640d(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() START");
            ...
            if (accountNames.length == 1 && validateAccountAgainstCache(commContext, accountNames[0])) {
                    ...
                    try {
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            public void run() {
                                String str;
                                try {
                                    Logger.m640d(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() Showing dialog");
                                    dialog.show();
                                } catch (Exception e) {
                                    Logger.m643e(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() dialog.show() failed", e);
                                    AndroidAccountResolver.this.asyncAccountResolutionNotify();
                                } finally {
                                    str = "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() Done showing dialog";
                                    Logger.m640d(Area.AUTH.value() | Area.UI.value(), str);
                                }
                            }
                        });
                ...
                Logger.m640d(Area.AUTH.value() | Area.UI.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() FINISHED Returning %1$s", new Object[]{this._accountNameFromUI}));
                return this._accountNameFromUI;
            } else {
                Logger.m640d(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() FINISHED Returning NULL");
                return null;
            }
        }

        private AlertDialog getAndroidAccountUI(final CommContext commContext, final AuthUIParentInterface uiParent) {
            Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountUI() starting");
            ...
            if (selectionItems == null || selectionItems.length <= 0) {
                ...
                builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    public void onCancel(DialogInterface dialog) {
                        try {
                            AndroidAccountResolver.this.accountResolved(commContext, (CharSequence) null);
                            uiParent.getParentActivity().finish();
                        } catch (Exception e) {
                            Logger.m643e(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: AlertDialog onClick() failed", e);
                        }
                    }
                });
                ...
                builder2.setItems(selectionItems, new DialogInterface.OnClickListener() {
                ...
                builder2.setOnCancelListener(new DialogInterface.OnCancelListener() {
                    public void onCancel(DialogInterface dialog) {
                        try {
                            ...
                            Logger.m643e(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: AlertDialog onCancel() failed", e);
                        }
                    }
                });
            ...
            if (resultDialog != null) {
                Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountUI() returning an AlertDialog instance");
            } else {
                Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getAndroidAccountUI() returning null");
            }
            return resultDialog;
        }

        private synchronized AlertDialog getDialogInstance(final AlertDialog.Builder builder) {
            Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getDialogInstance() START");
            this._createdDialog = null;
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    String str;
                    try {
                        Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getDialogInstance() Creating a dialog instance on the UI thread");
                        AlertDialog unused = AndroidAccountResolver.this._createdDialog = builder.create();
                        AndroidAccountResolver.this.asyncDialogCreationNotify();
                    } catch (Exception e) {
                        Logger.m643e(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getDialogInstance() failed", e);
                        AndroidAccountResolver.this.asyncDialogCreationNotify();
                    } finally {
                        str = "AuthFlow: AndroidAccountResolver: getDialogInstance() Done creating a dialog instance on the UI thread";
                        Logger.m646v(Area.AUTH.value() | Area.UI.value(), str);
                    }
                }
            });
            try {
                asyncDialogCreationWait();
                Logger.m646v(Area.AUTH.value() | Area.UI.value(), "AuthFlow: AndroidAccountResolver: getDialogInstance() FINISHED");
            } catch (InterruptedException e) {
                throw new AuthException((Throwable) e);
            }
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        Logger.m644i(Area.AUTH.value() | Area.UI.value() | Area.LICENSING.value(), "AuthFlow: AndroidAccountResolver: accountSelected(): Updating License cache success");
                    } catch (Exception e) {
                        Logger.m643e(Area.AUTH.value() | Area.UI.value() | Area.LICENSING.value(), "AuthFlow: AndroidAccountResolver: accountSelected(): Updating License cache failed", e);
                    }
                }
        ...
        public synchronized void accountResolved(CommContext commContext, CharSequence accountName) {
            if (accountName != null) {
                try {
                    ...
                    Logger.m644i(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: accountResolved(): '%1$s'", new Object[]{this._accountNameFromUI}));
                } finally {
                    asyncAccountResolutionNotify();
                }
            } else {
                this._accountNameFromUI = null;
                Logger.m644i(Area.AUTH.value(), "AuthFlow: AndroidAccountResolver: accountResolved(): No account was resolved for use");
                asyncAccountResolutionNotify();
            }
        }
