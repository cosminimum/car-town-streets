...
public abstract class TransactionBucket {
    ...
    protected TransactionBucket(String clientTransactionId, DBTransactions.TransactionType type, Serializable relatedObject) throws IOException {
    ...
    public void setStateString(String state) {
        try {
            ...
            throw new IllegalArgumentException(String.format(Locale.US, "Unable to parse the string '%1$s' into one of our transaction state enums", new Object[]{state}), e);
        }
    }
