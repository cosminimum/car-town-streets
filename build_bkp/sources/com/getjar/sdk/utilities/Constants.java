...
public class Constants {
    ...
    public static List<String> AllowedLocales = Collections.unmodifiableList(Arrays.asList(new String[]{"en_us", "zh_cn", "zh_tw", "fr_fr", "it_it", "de_de", "id_id", "pt_br", "es_es", "es_us", "tr_tr", "vi_vn", "ru_ru", "lt_lt", "ko_kr", "ja_jp"}));
    ...
    /* renamed from: X */
    public static final String f677X = "x";

    /* renamed from: Y */
    public static final String f678Y = "y";
