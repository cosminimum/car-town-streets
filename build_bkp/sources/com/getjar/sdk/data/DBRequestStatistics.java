...
public class DBRequestStatistics extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Logger.m644i(Area.STORAGE.value() | Area.STATS.value(), String.format(Locale.US, "DBRequestStatistics: onUpgrade() Upgrading DB %1$s from version %2$d to %3$d (deletes all data)", new Object[]{_DATABASE_NAME, Integer.valueOf(oldVersion), Integer.valueOf(newVersion)}));
            ...
            synchronized (this._databaseAccessLock) {
                ...
                try {
                    if (existingRequestStats.moveToNext()) {
                        ...
                        Logger.m646v(Area.STORAGE.value() | Area.STATS.value(), String.format(Locale.US, "DBRequestStatistics: addResponseRecord() Updating request stats record [serviceName:%1$s requestType:%2$s responseCount:%3$d]", new Object[]{request.getServiceName().name(), request.getRequestType(), Integer.valueOf(responseCount + 1)}));
                        ...
                        Logger.m646v(Area.STORAGE.value() | Area.STATS.value(), String.format(Locale.US, "DBRequestStatistics: addResponseRecord() Inserting response stats record [serviceName:%1$s requestType:%2$s responseTime:%3$d responseSize:%4$d responseCode:%5$d]", new Object[]{request.getServiceName().name(), request.getRequestType(), Integer.valueOf(response.getResponseTime()), Integer.valueOf(responseSizeInBytes), Integer.valueOf(response.getResponseCode())}));
    ...
    public boolean upsertRequestRecord(com.getjar.sdk.comm.Request r19) {
        ...
        L_0x0071:
            ...
            com.getjar.sdk.logging.Logger.m646v(r1, r3)     // Catch:{ all -> 0x01bd }
    ...
    public boolean checkForRequestEntry(com.getjar.sdk.comm.Request r12) {
        ...
        L_0x004d:
            ...
            com.getjar.sdk.logging.Logger.m643e(r5, r3, r1)     // Catch:{ all -> 0x0061 }
            goto L_0x0049
        L_0x0061:
            r2 = move-exception
            monitor-exit(r4)     // Catch:{ all -> 0x0061 }
