...
public class LicenseEngine {
    ...
    public LicenseInternal acquireUnmanagedProductLicense(String itemId, License.LicenseScope licenseScope) {
        if (StringUtility.isNullOrEmpty(itemId)) {
            ...
            Logger.m644i(Area.LICENSING.value(), String.format(Locale.US, "LicenseEngine -- acquireUnmanagedProductLicense started for %s", new Object[]{itemId}));
            if (this.claimsManager.canModifyUnmanagedLicenses()) {
                ...
                try {
                    ...
                    Logger.m643e(Area.LICENSING.value(), "LicenseEngine acquireUnmanagedProductLicense -- Error", e);
                    return license;
                } catch (InterruptedException e2) {
                    Logger.m643e(Area.LICENSING.value(), "LicenseEngine acquireUnmanagedProductLicense -- Error", e2);
                    return license;
                }
            } else {
                Logger.m642e(Area.LICENSING.value(), "LicenseEngine acquireUnmanagedProductLicense Not having required claims!!");
                return null;
            }
        }
    }
    ...
    public ArrayList<LicenseInternal> getUnmanagedProductLicenses(String[] itemIds) throws InterruptedException {
        Logger.m644i(Area.LICENSING.value(), "LicenseEngine -- getUnmanagedProductLicenses started");
        ...
        Logger.m642e(Area.LICENSING.value(), "LicenseEngine getUnmanagedProductLicenses Not having required claims!!");
        return null;
    }
    ...
    private ArrayList<LicenseInternal> getUnmanagedProductLicensesInternal(String[] itemIds) {
        ...
        Logger.m644i(Area.LICENSING.value(), "LicenseEngine -- getUnmanagedProductLicensesInternal started");
    ...
    public LicenseInternal updateLicenseState(Result result) {
        ...
        if (!(result == null || result.getResponseJson() == null || !this.claimsManager.canModifyUnmanagedLicenses())) {
            ...
            try {
                ...
                Logger.m646v(Area.LICENSING.value(), "LicenseEngine: updateLicenseState() Result did not contain a license");
            }
            if (license != null) {
    ...
    public LicenseInternal updateLicenseState(String itemId, License.LicenseScope licenseScope, LicenseInternal.InternalLicenseState internalLicenseState, Result result) {
        ...
        if (StringUtility.isNullOrEmpty(itemId)) {
            ...
            Logger.m644i(Area.LICENSING.value(), String.format(Locale.US, "LicenseEngine -- updateLicenseState -- started for %s", new Object[]{itemId}));
            if (this.claimsManager.canModifyUnmanagedLicenses()) {
                String eTag = ResultCachingManager.getETagFromResult(result);
                Long ttl = ResultCachingManager.getTtlFromResult(result);
            ...
            Logger.m642e(Area.LICENSING.value(), "LicenseEngine updateLicenseState Not having required claims!!");
            return null;
        }
    }
    ...
    public Boolean isUnmanagedProductLicensed(String itemId) throws InterruptedException {
        ...
        Logger.m644i(Area.LICENSING.value(), String.format(Locale.US, "LicenseEngine -- isUnmanagedProductLicensed started for %s", new Object[]{itemId}));
        if (this.claimsManager.canUseUnmanagedLicenses()) {
            ...
            Logger.m640d(Area.LICENSING.value(), "License found for " + itemId);
            return isLicensed;
        }
        Logger.m642e(Area.LICENSING.value(), "LicenseEngine isUnmanagedProductLicensed Not having required claims!!");
        return false;
    }
    ...
    private Boolean isUnmanagedProductLicensedInternal(String itemId) {
        ...
        Logger.m644i(Area.LICENSING.value() | Area.STORAGE.value(), String.format(Locale.US, "LicenseEngine -- isUnmanagedProductLicensedInternal started for %s", new Object[]{itemId}));
    ...
    public void retrieveServerProductLicenses(boolean r38) throws java.lang.InterruptedException {
        /*
            ...
            com.getjar.sdk.logging.Logger.m640d(r2, r4)
            r0 = r37
        ...
        L_0x0169:
            ...
            r0 = r16
            com.getjar.sdk.logging.Logger.m643e(r2, r4, r0)     // Catch:{ all -> 0x0166 }
        ...
        L_0x0195:
            ...
            com.getjar.sdk.logging.Logger.m641d(r2, r4, r12)     // Catch:{ all -> 0x0166 }
            goto L_0x00fc
        L_0x01a4:
            ...
            com.getjar.sdk.logging.Logger.m640d(r2, r4)     // Catch:{ JSONException -> 0x015b }
        L_0x01af:
        ...
        L_0x01c5:
            ...
            com.getjar.sdk.logging.Logger.m640d(r2, r4)     // Catch:{ all -> 0x0166 }
        ...
        L_0x0237:
            ...
            com.getjar.sdk.logging.Logger.m642e(r2, r4)     // Catch:{ all -> 0x0166 }
            goto L_0x01b7
        L_0x0244:
            com.getjar.sdk.logging.Area r2 = com.getjar.sdk.logging.Area.LICENSING     // Catch:{ all -> 0x0166 }
            long r2 = r2.value()     // Catch:{ all -> 0x0166 }
        ...
        L_0x02b4:
            ...
            com.getjar.sdk.logging.Logger.m642e(r2, r4)
            goto L_0x02a7
        */
