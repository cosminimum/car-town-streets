...
public class EarnStateDatabase extends SQLiteOpenHelper {
    ...
    private EarnStateDatabase(Context context, String name) {
        ...
        Logger.m644i(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "EarnStateDatabase: Opened user specific database '%1$s%2$d'", new Object[]{DATABASE_NAME_PREFIX, Integer.valueOf(AuthManager.getInstance().getUserAccessId().hashCode())}));
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        synchronized (this._databaseAccessLock) {
            Logger.m640d(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Upgrading database '%1$s' from version %2$d to %3$d, which will destroy all old data", new Object[]{DATABASE_NAME_PREFIX, Integer.valueOf(oldVersion), Integer.valueOf(newVersion)}));
    ...
    public com.getjar.sdk.data.earning.EarnStateRecord getAppState(java.lang.String r14) {
        ...
        L_0x0014:
            ...
            com.getjar.sdk.logging.Logger.m646v(r0, r2)     // Catch:{ all -> 0x008d }
            r8 = r9
        L_0x0059:
        ...
        L_0x005f:
            ...
            com.getjar.sdk.logging.Logger.m643e(r0, r2, r10)     // Catch:{ all -> 0x0011 }
            goto L_0x005d
        L_0x0073:
            r0 = move-exception
        L_0x0074:
        ...
        L_0x0079:
            ...
            com.getjar.sdk.logging.Logger.m643e(r1, r3, r10)     // Catch:{ all -> 0x0011 }
            goto L_0x0078
        L_0x008d:
            r0 = move-exception
            r8 = r9
    ...
    public java.util.List<com.getjar.sdk.data.earning.EarnStateRecord> getAllDownloadedOrInstalledAppStates() {
        ...
        L_0x0036:
            ...
            com.getjar.sdk.logging.Logger.m646v(r0, r2)     // Catch:{ all -> 0x002f }
        L_0x0062:
            monitor-exit(r11)     // Catch:{ all -> 0x002f }
            return r8
        L_0x0064:
            ...
            com.getjar.sdk.logging.Logger.m643e(r0, r2, r9)     // Catch:{ all -> 0x002f }
            goto L_0x0036
        L_0x0078:
            r9 = move-exception
            ...
            com.getjar.sdk.logging.Logger.m643e(r1, r3, r9)     // Catch:{ all -> 0x002f }
            goto L_0x002e
        */
    ...
    public java.util.List<com.getjar.sdk.data.earning.EarnStateRecord> getAllAppStates() {
        ...
        L_0x0034:
            ...
            com.getjar.sdk.logging.Logger.m646v(r0, r2)     // Catch:{ all -> 0x002d }
        L_0x0060:
            monitor-exit(r11)     // Catch:{ all -> 0x002d }
            return r8
        L_0x0062:
            ...
            long r0 = r0 | r2
            java.lang.String r2 = "Earning: EarnStateDatabase: getAllAppStates() failed"
            com.getjar.sdk.logging.Logger.m643e(r0, r2, r9)     // Catch:{ all -> 0x002d }
            goto L_0x0034
        L_0x0076:
            r9 = move-exception
            ...
            long r1 = r1 | r3
            java.lang.String r3 = "Earning: EarnStateDatabase: getAllAppStates() failed"
            com.getjar.sdk.logging.Logger.m643e(r1, r3, r9)     // Catch:{ all -> 0x002d }
            goto L_0x002c
        */
    ...
    public void deleteAppState(String packageName) {
        synchronized (this._databaseAccessLock) {
            ...
            Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: deleteAppState() deleted '%1$s'", new Object[]{packageName}));
        }
    }
    ...
    public void deleteOldRecords(long olderThanMilliseconds) {
        synchronized (this._databaseAccessLock) {
            ...
            Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: deleteOldRecords() deleted %1$d records", new Object[]{Integer.valueOf(deleteCount)}));
        }
    }
    ...
    private boolean checkForAppState(String packageName) {
        ...
        try {
            ...
            try {
                ...
                Logger.m643e(Area.EARN.value() | Area.STORAGE.value(), "SQLiteStatement.close() failed", e);
            }
            return z;
        } finally {
            try {
                ...
                Logger.m643e(Area.EARN.value() | Area.STORAGE.value(), "SQLiteStatement.close() failed", e2);
            }
        }
    }
    ...
    public void addAppState(String packageName, String friendlyName, String applicationMetadata, String trackingMetadata) {
        synchronized (this._databaseAccessLock) {
            if (StringUtility.isNullOrEmpty(packageName)) {
                ...
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: Preexisting record found for '%1$s'", new Object[]{packageName}));
            } else {
                ...
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: Added a DOWNLOADED record for '%1$s'", new Object[]{packageName}));
            }
        }
    }
    ...
    public void updateNotificationState(String packageName, NotificationState notificationState) {
        synchronized (this._databaseAccessLock) {
            ...
            Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: setNotificationShown() Updated record for '%1$s'", new Object[]{packageName}));
        }
    }
    ...
    public void updateApplicationMetadata(String packageName, String applicationMetadata) {
        synchronized (this._databaseAccessLock) {
            if (StringUtility.isNullOrEmpty(packageName)) {
                ...
                values.put("applicationMetadata", applicationMetadata);
                getWritableDatabase().update(DATABASE_TABLE, values, "packageName = ?", new String[]{packageName});
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: updateApplicationMetadata() Updated record for '%1$s' with applicationMetadata:%2$s", new Object[]{packageName, applicationMetadata}));
            }
        }
    }
    ...
    public void updateStatus(String packageName, Status status) {
        synchronized (this._databaseAccessLock) {
            if (StringUtility.isNullOrEmpty(packageName)) {
                ...
                getWritableDatabase().update(DATABASE_TABLE, values, "packageName = ?", new String[]{packageName});
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: updateStatus() Updated record for '%1$s' with status:%2$s", new Object[]{packageName, status.name()}));
            }
        }
    }
    ...
    public void updateEarnAmount(String packageName, long amount) {
        synchronized (this._databaseAccessLock) {
            if (StringUtility.isNullOrEmpty(packageName)) {
                ...
                getWritableDatabase().update(DATABASE_TABLE, values, "packageName = ?", new String[]{packageName});
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: updateEarnAmount() Updated record for '%1$s' with amount:%2$d", new Object[]{packageName, Long.valueOf(amount)}));
            }
        }
    }
    ...
    public void updateEarnState(String packageName, EarnState earnState, String earnSubstate) {
        synchronized (this._databaseAccessLock) {
            if (StringUtility.isNullOrEmpty(packageName)) {
                ...
                getWritableDatabase().update(DATABASE_TABLE, values, "packageName = ?", new String[]{packageName});
                Logger.m646v(Area.EARN.value() | Area.STORAGE.value(), String.format(Locale.US, "Earning: EarnStateDatabase: updateEarnState() Updated record for '%1$s' with earnState:%2$s and earnSubstate:%3$s", new Object[]{packageName, earnState.name(), earnSubstate}));
            }
        }
    }
}
