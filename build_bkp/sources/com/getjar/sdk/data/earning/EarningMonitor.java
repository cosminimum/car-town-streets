...
public class EarningMonitor {
    ...
    public void startMonitoring() {
        /*
            ...
            com.getjar.sdk.logging.Logger.m646v(r2, r0)     // Catch:{ all -> 0x00d3 }
        ...
        L_0x0031:
            ...
            com.getjar.sdk.logging.Logger.m646v(r3, r0)     // Catch:{ all -> 0x00d6 }
        L_0x0076:
            r0 = 0
            ...
            com.getjar.sdk.logging.Logger.m646v(r3, r0)     // Catch:{ IllegalThreadStateException -> 0x00d9 }
        L_0x0090:
    ...
    public void stopMonitoring() {
        ...
        L_0x0042:
            ...
            com.getjar.sdk.logging.Logger.m646v(r5, r2)     // Catch:{ all -> 0x00bc }
            r1 = 0
        L_0x004c:
        ...
        L_0x0051:
            ...
            com.getjar.sdk.logging.Logger.m643e(r2, r5, r0)     // Catch:{ all -> 0x0091 }
            com.getjar.sdk.logging.Area r2 = com.getjar.sdk.logging.Area.EARN     // Catch:{ all -> 0x00bc }
            long r2 = r2.value()     // Catch:{ all -> 0x00bc }
            com.getjar.sdk.logging.Area r5 = com.getjar.sdk.logging.Area.TRANSACTION     // Catch:{ all -> 0x00bc }
            long r5 = r5.value()     // Catch:{ all -> 0x00bc }
        ...
        L_0x00b1:
            ...
            com.getjar.sdk.logging.Logger.m646v(r5, r3)     // Catch:{ all -> 0x00bc }
            r1 = 0
        ...
        L_0x00bf:
            ...
            com.getjar.sdk.logging.Logger.m643e(r2, r5, r0)     // Catch:{ Exception -> 0x0051 }
            goto L_0x0020
        L_0x00d4:
    ...
    public EarnStateRecord ensureAppMetadataOnEarnStateRecord(EarnStateRecord appState) {
        ...
        try {
            ...
            Logger.m640d(Area.EARN.value(), String.format(Locale.US, "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() [packageName:'%1$s' metadataCount:%2$d]", new Object[]{appState.getPackageName(), Integer.valueOf(appMetaMap.size())}));
            ...
            if (!appMetaMap.containsKey(Constants.META_PACKAGE_VERSION_CODE) || !appMetaMap.containsKey(Constants.META_PACKAGE_VERSION_NAME)) {
                ...
                if (packageInfo == null) {
                    Logger.m648w(Area.EARN.value(), String.format(Locale.US, "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() [packageName: %1$s] Failed to get PackageInfo", new Object[]{appState.getPackageName()}));
                } else {
                ...
                try {
                    if (appMetaMap.size() > 0) {
                        ...
                        if (!StringUtility.isNullOrEmpty(theAppMetadata)) {
                            ...
                            Logger.m640d(Area.EARN.value(), String.format(Locale.US, "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() Application metadata update [packageName:'%1$s' metadata:'%2$s']", new Object[]{appState.getPackageName(), theAppMetadata}));
                        }
                    }
                } catch (Exception e2) {
                    Logger.m643e(Area.EARN.value(), "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() failed", e2);
                }
            }
        } catch (Exception e3) {
            Logger.m643e(Area.EARN.value(), "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() failed", e3);
            if (doUpdate && appMetaMap != null) {
                try {
                    if (appMetaMap.size() > 0) {
                        ...
                        if (!StringUtility.isNullOrEmpty(theAppMetadata2)) {
                            ...
                            Logger.m640d(Area.EARN.value(), String.format(Locale.US, "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() Application metadata update [packageName:'%1$s' metadata:'%2$s']", new Object[]{appState.getPackageName(), theAppMetadata2}));
                        }
                    }
                } catch (Exception e4) {
                    Logger.m643e(Area.EARN.value(), "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() failed", e4);
                }
            }
        } catch (Throwable th) {
            if (doUpdate && appMetaMap != null) {
                try {
                    if (appMetaMap.size() > 0) {
                        ...
                        if (!StringUtility.isNullOrEmpty(theAppMetadata3)) {
                            ...
                            Logger.m640d(Area.EARN.value(), String.format(Locale.US, "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() Application metadata update [packageName:'%1$s' metadata:'%2$s']", new Object[]{appState.getPackageName(), theAppMetadata3}));
                        }
                    }
                } catch (Exception e5) {
                    Logger.m643e(Area.EARN.value(), "Earning: EarningMonitor: ensureAppMetadataOnEarnStateRecord() failed", e5);
                }
            }
            throw th;
        }
    ...
    private class EarningMonitoringThread extends Thread {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
            com.getjar.sdk.logging.Logger.m648w(com.getjar.sdk.logging.Area.EARN.value() | com.getjar.sdk.logging.Area.TRANSACTION.value(), "Earning: EarningMonitor: EarningMonitoringThread: not yet authed");
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:26:?, code lost:
            com.getjar.sdk.logging.Logger.m643e(com.getjar.sdk.logging.Area.EARN.value() | com.getjar.sdk.logging.Area.TRANSACTION.value(), java.lang.String.format(java.util.Locale.US, "Earning: EarningMonitor: EarningMonitoringThread: failed timeout and notification processing for %1$s", new java.lang.Object[]{r6.getPackageName()}), r10);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:29:?, code lost:
            com.getjar.sdk.logging.Logger.m640d(com.getjar.sdk.logging.Area.EARN.value() | com.getjar.sdk.logging.Area.TRANSACTION.value(), java.lang.String.format(java.util.Locale.US, "Usage: UsageMonitor: UsageMonitoringThread: Received an InterruptedException [_exitMonitoringThread = %1$s]", new java.lang.Object[]{java.lang.Boolean.valueOf(com.getjar.sdk.data.earning.EarningMonitor.access$200(r30.this$0))}));
         */
        ...
        public void run() {
            /*
                ...
                com.getjar.sdk.logging.Logger.m640d(r21, r23)     // Catch:{ Exception -> 0x01cf }
                r17 = 0
                r7 = 0
                r19 = 0
            ...
            L_0x0090:
                ...
                com.getjar.sdk.logging.Logger.m648w(r21, r23)     // Catch:{ Exception -> 0x01cf }
            ...
            L_0x00ae:
                ...
                com.getjar.sdk.logging.Logger.m640d(r21, r23)     // Catch:{ AuthException -> 0x0090, InterruptedException -> 0x0199 }
            ...
            L_0x00e6:
                ...
                com.getjar.sdk.logging.Logger.m640d(r21, r23)     // Catch:{ Exception -> 0x0169, AuthException -> 0x0090, InterruptedException -> 0x0199 }
                r0 = r30
            ...
            L_0x0169:
                ...
                r0 = r21
                r2 = r23
                com.getjar.sdk.logging.Logger.m643e(r0, r2, r10)     // Catch:{ AuthException -> 0x0090, InterruptedException -> 0x0199 }
                goto L_0x00e6
            L_0x0199:
                r12 = move-exception
                com.getjar.sdk.logging.Area r21 = com.getjar.sdk.logging.Area.EARN     // Catch:{ Exception -> 0x01cf }
            ...
            L_0x01cf:
                ...
                r0 = r21
                r2 = r23
                com.getjar.sdk.logging.Logger.m643e(r0, r2, r10)     // Catch:{ all -> 0x02f6 }
                r0 = r30
                ...
                com.getjar.sdk.logging.Logger.m640d(r21, r23)
            L_0x0233:
                return
            L_0x0234:
            ...
            L_0x02f6:
                ...
                com.getjar.sdk.logging.Logger.m640d(r22, r24)
                throw r21
            L_0x0340:
                r0 = r30
                com.getjar.sdk.data.earning.EarningMonitor r0 = com.getjar.sdk.data.earning.EarningMonitor.this     // Catch:{ Exception -> 0x0169, AuthException -> 0x0090, InterruptedException -> 0x0199 }
            ...
            L_0x04b9:
                ...
                com.getjar.sdk.logging.Logger.m640d(r21, r23)     // Catch:{ Exception -> 0x0506, AuthException -> 0x0090, InterruptedException -> 0x0199 }
                r0 = r30
            ...
            if (commContext == null) {
                ...
                try {
                    ...
                    if (operation == null || operation.get() == null || operation.get().getResult() == null || !operation.get().getResult().isSuccessfulResponse()) {
                        Logger.m648w(Area.EARN.value() | Area.TRANSACTION.value(), "Earning: EarningMonitor: EarningMonitoringThread: processOpenEvent() earn operation failed");
                    }
                    ...
                    Logger.m643e(Area.EARN.value() | Area.TRANSACTION.value(), "Earning: EarningMonitor: EarningMonitoringThread: processOpenEvent() failed", e);
                    return false;
                }
            }
        }
    ...
    public Future<Operation> earn(Context context, CommContext commContext, EarnStateRecord appState) throws Exception {
        ...
        if (context == null) {
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Earning: EarningMonitor: earn() for: %1$s", new Object[]{appState.toString()}));
            new HashMap();
            new HashMap();
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Earning: EarningMonitor: earn() Sending Earn transaction for %1$s [clientTransactionId: %2$s]", new Object[]{appState.getPackageName(), clientTransactionId}));
            ...
            return CommManager.createContext(applicationKey, context, (ResultReceiver) new ResultReceiver((Handler) null) {
                ...
                public void onReceiveResult(int resultCode, Bundle resultData) {
                    for (String key : resultData.keySet()) {
                        Logger.m640d(Area.EARN.value() | Area.AUTH.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Earning: EarningMonitor: Callback from the GetJar SDK [%1$s]", new Object[]{resultData.get(key).getClass().getName()}));
                    }
                }
