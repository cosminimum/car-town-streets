...
public class GetJarWebViewSubActivity extends GetJarSubActivityBase implements SharedPreferences.OnSharedPreferenceChangeListener, View.OnTouchListener {
    ...
    ResultReceiver mDismissReceiver = new ResultReceiver((Handler) null) {
        ...
        public void onReceiveResult(int resultCode, Bundle resultData) {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "onReceiveResult:" + resultCode);
    ...
    private BroadcastReceiver mPackageReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            Logger.m640d(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "** PackageReceiver: %1$s [%2$s]", new Object[]{action, Utility.getPackageNameFromBroadcastIntent(intent)}));
    ...
    public void setCurrentPurchaseClientTransactionId(String currentPurchaseClientTransactionId) {
        Logger.m646v(Area.PURCHASE.value() | Area.TRANSACTION.value(), String.format(Locale.US, "setCurrentPurchaseClientTransactionId(%1$s) called from '%2$s'", new Object[]{currentPurchaseClientTransactionId, Thread.currentThread().getStackTrace()[3].getMethodName()}));
    ...
    public String getCurrentPurchaseClientTransactionId() {
        Logger.m646v(Area.PURCHASE.value() | Area.TRANSACTION.value(), String.format(Locale.US, "getCurrentPurchaseClientTransactionId() called from '%1$s' returning '%2$s'", new Object[]{Thread.currentThread().getStackTrace()[3].getMethodName(), this._currentPurchaseClientTransactionId}));
    ...
    private class newPackageReceived implements Runnable {
        ...
        public void run() {
            try {
                Logger.m640d(Area.USAGE.value(), "waiting...");
                Thread.sleep(10000);
                Logger.m640d(Area.USAGE.value(), "finish waiting...");
                this.mReceiver.send(4, (Bundle) null);
            } catch (Exception e) {
                Logger.m643e(Area.USAGE.value(), "newPackageReceived() failed", e);
            }
        }
    }
    ...
    public void waitForAuthorization() {
        Logger.m640d(Area.AUTH.value() | Area.UI.value(), "Waiting for UserAuth is called");
        waitDialogShow();
        try {
            new Thread(new waitForAuth(this.mCommContext, this.mDismissReceiver)).start();
        } catch (Throwable t) {
            waitDialogHide();
            Logger.m643e(Area.AUTH.value() | Area.UI.value(), "newPackageReceived() failed", t);
        }
    }
    ...
    public void startGooglePlayForPurchase(PendingIntent pendingIntent, String callback, CommContext commContext, String clientTransactionId) {
        if (pendingIntent == null) {
            ...
            try {
                ...
                Logger.m643e(Area.TRANSACTION.value() | Area.OFFER.value(), "Purchase failed", e);
    ...
    private boolean isUrlExpired() {
        ...
        Logger.m646v(Area.CONFIG.value() | Area.UI.value(), String.format(Locale.US, "isUrlExpired(): URL cache age: %1$d", new Object[]{age}));
        try {
            ...
            if (age.longValue() >= cachedUrlTtl) {
                Logger.m646v(Area.CONFIG.value() | Area.UI.value(), String.format(Locale.US, "isUrlExpired(): AGE:%1$d >= TTL:%2$d  [Returning:TRUE]", new Object[]{age, Long.valueOf(cachedUrlTtl)}));
                return true;
            }
            Logger.m646v(Area.CONFIG.value() | Area.UI.value(), String.format(Locale.US, "isUrlExpired(): AGE:%1$d < TTL:%2$d  [Returning:FALSE]", new Object[]{age, Long.valueOf(cachedUrlTtl)}));
            return false;
        } catch (Exception e) {
            Logger.m643e(Area.CONFIG.value() | Area.UI.value(), "isUrlExpired(): failed", e);
            return false;
        }
    }

    public static void loadErrorPage(ErrorType type, String subCode, WebView view) {
        Logger.m640d(Area.UI.value(), "loadErrorPage: ErrorType:" + type.toString());
    ...
    private String getHomeUrl() {
        Logger.m640d(Area.CONFIG.value(), String.format(Locale.US, "getHomeUrl(): current '%1$s'", new Object[]{this.mUrl}));
        ...
        if (rewardsPrefsMap.containsKey(Constants.WEB_LAST_KNOWN)) {
            ...
            if (!StringUtility.isNullOrEmpty(historyUrl)) {
                Logger.m640d(Area.CONFIG.value(), String.format(Locale.US, "getHomeUrl(): Last known url: %1$s", new Object[]{historyUrl}));
                if (!isUrlExpired()) {
                    try {
                        new URI(historyUrl);
                        Logger.m640d(Area.CONFIG.value(), String.format(Locale.US, "getHomeUrl(): Selecting unexpired URL from cache: '%1$s'", new Object[]{historyUrl}));
                        this.mUrl = historyUrl;
                    } catch (URISyntaxException e) {
                        Logger.m642e(Area.CONFIG.value(), String.format(Locale.US, "getHomeUrl(): Bad URL value found in cache: '%1$s'", new Object[]{historyUrl}));
        ...
        Logger.m640d(Area.CONFIG.value(), String.format(Locale.US, "getHomeUrl(): returning '%1$s'", new Object[]{this.mUrl}));
        return this.mUrl;
    }
    ...
    private void initWebView() {
        Logger.m648w(Area.UI.value(), "initWebView()");
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            public void onConsoleMessage(String message, int lineNumber, String sourceID) {
                Logger.m640d(Area.UI.value(), String.format(Locale.US, "%1$s -- From line %2$d of %3$s", new Object[]{message, Integer.valueOf(lineNumber), sourceID}));
            }
        });
    }
    ...
    public void simpleReload() {
        Logger.m640d(Area.UI.value(), "Telling the WebView to reload the current URL");
    ...
    public static void updateUIWithEarnResults(String earnState, String earnSubstate, String friendlyName, long amount, String packageName, String legacyItemId) {
        ...
        Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "GetJarActivity: updateUIWithEarnResults() started [earnState:%1$s earnSubstate:%2$s friendlyName:%3$s amount:%4$d packageName:%5$s legacyItemId:%6$s]", new Object[]{earnState, earnSubstate, friendlyName, Long.valueOf(amount), packageName, legacyItemId}));
        try {
            if (mWebView == null) {
                Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "GetJarActivity: updateUIWithEarnResults() not refreshing, WebView is NULL", new Object[0]));
                return;
            }
            if ("SUCCESS".equals(earnState)) {
                Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "GetJarActivity: updateUIWithEarnResults() calling javascript:GJ.successfulEarnInstall()");
                urlFormat = "javascript:GJ.successfulEarnInstall(\"%1$s\",\"%2$s\",\"%3$s\",\"%4$s\",%5$d)";
            } else {
                Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "GetJarActivity: updateUIWithEarnResults() calling javascript:GJ.failedEarnInstall()");
            ...
            Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "GetJarActivity: updateUIWithEarnResults() finished");
        } finally {
            str = "GetJarActivity: updateUIWithEarnResults() finished";
            Logger.m644i(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), str);
        }
    }
    ...
    public void reload() {
        boolean z;
        try {
            Logger.m640d(Area.UI.value(), "GetJarActivity: reload()");
            if (mWebView != null) {
                Logger.m640d(Area.UI.value(), "GetJarActivity: reload() calling javascript:GJ.onFocus()");
                loadUrlInWebView(mWebView, "javascript:GJ.onFocus()");
            } else {
                Logger.m640d(Area.UI.value(), "GetJarActivity: reload() WebView is null");
            }
            if (!z) {
                waitDialogHide();
            }
    ...
    public void close() {
        try {
            ...
            if (clientTransactionId != null) {
                Logger.m640d(Area.PURCHASE.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Cancelling clientTransactionId %1$s", new Object[]{clientTransactionId}));
    ...
    public static void loadUrl(String url) {
        if (mWebView != null) {
            try {
                ...
                Logger.m643e(Area.UI.value(), String.format("loadUrl() failed [url:%1$s]", new Object[]{url}), e);
            }
        }
    }
    ...
    protected static void loadUrlInWebView(final WebView webView, final String url, final boolean clearHistory) {
        Logger.m640d(Area.UI.value(), String.format(Locale.US, "Loading URL '%1$s' from '%2$s'", new Object[]{url, Thread.currentThread().getStackTrace()[3].getMethodName()}));
        if (webView == null) {
            Logger.m642e(Area.UI.value(), "loadUrlInWebView() called with NULL WebView");
        } else if (StringUtility.isNullOrEmpty(url)) {
            Logger.m642e(Area.UI.value(), "loadUrlInWebView() called with NULL or empty url");
        } else if (!Utility.isCurrentThreadTheUIThread()) {
            Logger.m648w(Area.UI.value(), String.format(Locale.US, "Loading URL '%1$s' from non-UI thread! Posting back to UI thread.", new Object[]{url}));
                    ...
                    try {
                        ...
                        if (clearHistory) {
                            try {
                                ...
                                Logger.m643e(Area.UI.value(), "WebView.clearHistory() failed", e);
                            }
                        }
                    } catch (Exception e2) {
                        Logger.m643e(Area.UI.value(), "loadUrlInWebView() failed", e2);
                    }
                }
            });
        } else {
    ...
    public void loadPostAuthUI() {
        String url;
        Logger.m640d(Area.UI.value(), "Waiting for UserAuth is dismissed");
        if (!this._shouldShowLoadingUI) {
            waitDialogHide();
        }
        boolean clearHistory = false;
        Logger.m646v(Area.UI.value(), String.format(Locale.US, "GetJarWebViewSubActivity: dismiss() loadWalletPage=%1$s", new Object[]{Boolean.valueOf(this._loadWalletPage)}));
        Logger.m646v(Area.UI.value(), String.format(Locale.US, "GetJarWebViewSubActivity: dismiss() loadManagedCheckoutPage=%1$s", new Object[]{Boolean.valueOf(this._loadCheckoutPage)}));
        ...
        if (!StringUtility.isNullOrEmpty(url)) {
            Logger.m646v(Area.UI.value(), String.format(Locale.US, "dismiss() Loading '%1$s'", new Object[]{url}));
    ...
    public void showUserSwitchedUIAsNeeded() {
        try {
            if (this.getJarActivity.getPackageName().equals(Constants.GREENJAR_PACKAGE)) {
                Logger.m646v(Area.UI.value(), "USER_SWITCHED_UI: We are Rewards");
                ...
                if (AccountHistoryManager.getInstance().isUserSwitchedUINeeded(AuthManager.getInstance().getUserAccessId())) {
                    Logger.m646v(Area.UI.value(), "USER_SWITCHED_UI: isUserSwitchedUINeeded() == true");
                    ...
                    if (!StringUtility.isNullOrEmpty(currentAccountName)) {
                        ...
                        if (!StringUtility.isNullOrEmpty(previousAccountName)) {
                            Logger.m646v(Area.UI.value(), String.format(Locale.US, "USER_SWITCHED_UI: currentAccountName:%1$s previousAccountName:%2$s", new Object[]{currentAccountName, previousAccountName}));
                            if (!currentAccountName.equalsIgnoreCase(previousAccountName)) {
                                Logger.m646v(Area.UI.value(), "USER_SWITCHED_UI: Showing UI...");
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    try {
                                                        ...
                                                        try {
                                                            ...
                                                            Logger.m643e(Area.UI.value(), "USER_SWITCHED_UI: dialog.dismiss() failed", e);
                                                        }
                                                    } catch (Exception e2) {
                                                        Logger.m643e(Area.UI.value(), "USER_SWITCHED_UI: Work for 'user switched' UI failed", e2);
                                                        try {
                                                            dialog.dismiss();
                                                        } catch (Exception e3) {
                                                            Logger.m643e(Area.UI.value(), "USER_SWITCHED_UI: dialog.dismiss() failed", e3);
                                                        }
                                                    } catch (Throwable th) {
                                                        try {
                                                            dialog.dismiss();
                                                        } catch (Exception e4) {
                                                            Logger.m643e(Area.UI.value(), "USER_SWITCHED_UI: dialog.dismiss() failed", e4);
                                                        }
                                                        throw th;
                                                    }
                                                }
            ...
            Logger.m643e(Area.UI.value(), "USER_SWITCHED_UI: Work for 'user switched' UI failed", e);
        }
    }
    ...
    public void hideManagedDialogs() {
        Logger.m646v(Area.UI.value(), "AuthFlow: hideManagedDialogs() START");
        ...
        Logger.m646v(Area.UI.value(), "AuthFlow: hideManagedDialogs() FINISH");
    }

    public void onSaveInstanceState(Bundle outState) {
        Logger.m640d(Area.OS_ENTRY_POINT.value(), "onSaveInstanceState()");
    ...
    public void onCreate(Bundle savedInstanceState) {
        Logger.m640d(Area.OS_ENTRY_POINT.value(), "GetJarActivity.onCreate()");
        ...
        if (extras != null) {
            ...
            if (!StringUtility.isNullOrEmpty(language)) {
                Language = language;
                Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity.onCreate() -- setting language to " + language);
            }
        }
        if (products == null || products.size() <= 0) {
            Logger.m642e(Area.PURCHASE.value() | Area.OS_ENTRY_POINT.value() | Area.TRANSACTION.value(), String.format(Locale.US, "The Intent used to start the GetJarWebViewSubActivity must contain a Product list value for '%1$s' in its Extras", new Object[]{Constants.PRODUCT_LIST}));
            this.getJarActivity.finish();
            return;
        }
        this.mOffers.clear();
        ...
        if (StringUtility.isNullOrEmpty(commContextId)) {
            Logger.m642e(Area.COMM.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "The Intent used to start the GetJarActivity must contain a value for '%1$s' in its Extras", new Object[]{Constants.GETJAR_CONTEXT_ID_KEY}));
            this.getJarActivity.finish();
            return;
        }
        ...
        if (this.mCommContext == null) {
            Logger.m642e(Area.COMM.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "No CommContext instance found for the ID '%1$s'", new Object[]{commContextId}));
            this.getJarActivity.finish();
            return;
        }
        ...
        try {
            this.mUrl = GetJarConfig.getInstance(this.mCommContext, true).getDirectiveValue(GetJarConfig.KEY_DEFAULT_WEBVIEW_URL);
            Logger.m640d(Area.CONFIG.value() | Area.OS_ENTRY_POINT.value(), "onCreate() -- using mUrl=" + this.mUrl);
            ...
            if (RedemptionEngine.IntentTypeShowWallet.equals(this.getJarActivity.getIntent().getStringExtra(RedemptionEngine.IntentTypeKey))) {
                Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value() | Area.REDEEM.value(), "GetJarWebViewSubActivity: onCreate() setting loadWalletPage flag");
                ...
                Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value() | Area.OFFER.value(), "GetJarWebViewSubActivity: onCreate() setting loadCheckoutPage flag");
            ...
            Logger.m643e(Area.CONFIG.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity.onCreate() failed", e);
    ...
    public void onNewIntent(Intent intent) {
        ...
        Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewSubActivity: onNewIntent()");
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value() | Area.CONFIG.value(), "GetJarActivity -- onConfigurationChanged new orientation =" + orientation);
        mWebView.loadUrl(String.format(Locale.US, "javascript:GJ.orientationChangeHandler(\"%s\")", new Object[]{orientation}));
        super.onConfigurationChanged(newConfig);
    }

    public void onPause() {
        Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity: onPause() START");
        super.onPause();
    ...
    public void onResume() {
        String str;
        String str2;
        Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity: onResume() START");
        try {
            super.onResume();
            ...
            Logger.m646v(Area.EARN.value() | Area.OS_ENTRY_POINT.value(), str);
            ...
            Logger.m646v(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), str2);
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null && intent.getAction().equals(Constants.ACTION_NOTIFY_BUY_GOLD)) {
                if (!intent.hasExtra(Constants.BILLING_FAILURE_REASON)) {
                    ...
                    Logger.m640d(Area.BUY_GOLD.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity BuyingGoldJavascriptNotifier success ");
                    return;
                }
                Logger.m640d(Area.BUY_GOLD.value() | Area.OS_ENTRY_POINT.value(), "GetJarActivity BuyingGoldJavascriptNotifier failure");
    ...
    public void onDestroy() {
        try {
            ...
            Logger.m648w(Area.UI.value() | Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), t.getMessage());
        } finally {
            hideManagedDialogs();
            waitDialogHide();
            super.onDestroy();
    ...
    public void onBackPressed() {
        try {
            if (!mWebView.canGoBack()) {
                Logger.m640d(Area.UI.value(), "onBackPressed() -- on last page, exiting..");
                GlobalActivityRegistrar.getInstance().finishAllActivities();
                close();
                return;
            }
            mWebView.goBack();
            Logger.m640d(Area.UI.value(), "onBackPressed() -- going back..");
        } catch (Throwable t) {
            Logger.m643e(Area.UI.value(), "GetJarActivity.onBackPressed() failed", t);
        }
    }
    ...
    private class ScreenWakeupReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                Logger.m646v(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), "Reloading the WebView due to screen wake-up");
                ...
                Logger.m640d(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), "GetJarJavaScriptInterface ScreenWakeupReceiver sleepReloadInterval=" + webviewSleepReloadInterval);
                if ((System.currentTimeMillis() / 1000) - GetJarWebViewSubActivity.this.mJavaScriptInterface.getLastReloadTime() > webviewSleepReloadInterval) {
                    Logger.m640d(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), "GetJarJavaScriptInterface ScreenWakeupReceiver reloading...");
                    GetJarWebViewSubActivity.mWebView.reload();
                    GetJarWebViewSubActivity.this.mJavaScriptInterface.setLastReloadTime();
                }
            } catch (Exception e) {
                Logger.m643e(Area.USAGE.value() | Area.OS_ENTRY_POINT.value(), "WebView reload failed", e);
            }
        }
    }
    ...
    protected class ManagedPurchaseWithClientTransactionID {
        ...
        protected ManagedPurchaseWithClientTransactionID(ManagedPurchase managedPurchase) {
            ...
            Logger.m646v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Generated a new client transaction ID: '%1$s' [thread:%2$d]", new Object[]{this._clientTransactionId, Long.valueOf(Thread.currentThread().getId())}));
        }
    }
    ...
    protected class ProductWithClientTransactionID {
        ...
        protected ProductWithClientTransactionID(Product product) {
            ...
            this._clientTransactionId = UUID.randomUUID().toString();
            Logger.m646v(Area.PURCHASE.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Generated a new client transaction ID: '%1$s' [thread:%2$d]", new Object[]{this._clientTransactionId, Long.valueOf(Thread.currentThread().getId())}));
        }
    }
            ...
            _ExecutorServiceForGooglePlayResultWork.execute(new Runnable() {
                public void run() {
                    try {
                        ...
                        Logger.m643e(Area.OFFER.value() | Area.TRANSACTION.value(), "InAppPurchaseManager.managedOfferGooglePlayResponse() failed", e);
                    }
                }
            });
        }
