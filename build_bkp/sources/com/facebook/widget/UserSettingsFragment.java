...
public class UserSettingsFragment extends FacebookFragment {
    ...
    /* renamed from: ID */
    private static final String f403ID = "id";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(C0253R.layout.com_facebook_usersettingsfragment, container, false);
        this.loginButton = (LoginButton) view.findViewById(C0253R.C0254id.com_facebook_usersettingsfragment_login_button);
        ...
        this.connectedStateLabel = (TextView) view.findViewById(C0253R.C0254id.com_facebook_usersettingsfragment_profile_name);
        if (view.getBackground() == null) {
            view.setBackgroundColor(getResources().getColor(C0253R.color.com_facebook_blue));
        } else {
    ...
    public void updateUI() {
        if (isAdded()) {
            if (isSessionOpen()) {
                this.connectedStateLabel.setTextColor(getResources().getColor(C0253R.color.com_facebook_usersettingsfragment_connected_text_color));
                this.connectedStateLabel.setShadowLayer(1.0f, BitmapDescriptorFactory.HUE_RED, -1.0f, getResources().getColor(C0253R.color.com_facebook_usersettingsfragment_connected_shadow_color));
                if (this.user != null) {
                ...
                this.connectedStateLabel.setText(getResources().getString(C0253R.string.com_facebook_usersettingsfragment_logged_in));
                Drawable noProfilePic = getResources().getDrawable(C0253R.drawable.com_facebook_profile_default_icon);
                noProfilePic.setBounds(0, 0, getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_usersettingsfragment_profile_picture_width), getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_usersettingsfragment_profile_picture_height));
                this.connectedStateLabel.setCompoundDrawables((Drawable) null, noProfilePic, (Drawable) null, (Drawable) null);
                return;
            }
            int textColor = getResources().getColor(C0253R.color.com_facebook_usersettingsfragment_not_connected_text_color);
            this.connectedStateLabel.setTextColor(textColor);
            this.connectedStateLabel.setShadowLayer(BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, textColor);
            this.connectedStateLabel.setText(getResources().getString(C0253R.string.com_facebook_usersettingsfragment_not_logged_in));
    ...
    public void processImageResponse(String id, ImageResponse response) {
        ...
        if (response != null && (bitmap = response.getBitmap()) != null) {
            ...
            drawable.setBounds(0, 0, getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_usersettingsfragment_profile_picture_width), getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_usersettingsfragment_profile_picture_height));
