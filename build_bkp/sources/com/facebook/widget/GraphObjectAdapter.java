...
class GraphObjectAdapter<T extends GraphObject> extends BaseAdapter implements SectionIndexer {
    ...
    /* renamed from: ID */
    private static final String f400ID = "id";
    ...
    public java.net.URL getPictureUrlOfGraphObject(T r7) {
        /*
            r6 = this;
            r3 = 0
        ...
        L_0x000e:
            ...
            java.net.URL r4 = new java.net.URL     // Catch:{ MalformedURLException -> 0x0033 }
            r4.<init>(r3)     // Catch:{ MalformedURLException -> 0x0033 }
        L_0x0015:
            return r4
        L_0x0016:
    ...
    public View getSectionHeaderView(String sectionHeader, View convertView, ViewGroup parent) {
        ...
        if (result == null) {
            result = (TextView) this.inflater.inflate(C0253R.layout.com_facebook_picker_list_section_header, (ViewGroup) null);
        }
    ...
    private View getActivityCircleView(View convertView, ViewGroup parent) {
        View result = convertView;
        if (result == null) {
            result = this.inflater.inflate(C0253R.layout.com_facebook_picker_activity_circle_row, (ViewGroup) null);
        }
        ((ProgressBar) result.findViewById(C0253R.C0254id.com_facebook_picker_row_activity_circle)).setVisibility(0);
        return result;
    }
    ...
    public View createGraphObjectView(T graphObject, View convertView) {
        ...
        ViewStub checkboxStub = (ViewStub) result.findViewById(C0253R.C0254id.com_facebook_picker_checkbox_stub);
        ...
        ViewStub profilePicStub = (ViewStub) result.findViewById(C0253R.C0254id.com_facebook_picker_profile_pic_stub);
        if (!getShowPicture()) {
    ...
    public void populateGraphObjectView(View view, T graphObject) {
        ...
        TextView titleView = (TextView) view.findViewById(C0253R.C0254id.com_facebook_picker_title);
        if (titleView != null) {
            titleView.setText(title, TextView.BufferType.SPANNABLE);
        }
        CharSequence subtitle = getSubTitleOfGraphObject(graphObject);
        TextView subtitleView = (TextView) view.findViewById(C0253R.C0254id.picker_subtitle);
        ...
        if (getShowCheckbox()) {
            updateCheckboxState((CheckBox) view.findViewById(C0253R.C0254id.com_facebook_picker_checkbox), isGraphObjectSelected(id));
        }
        if (getShowPicture() && (pictureURL = getPictureUrlOfGraphObject(graphObject)) != null) {
            ImageView profilePic = (ImageView) view.findViewById(C0253R.C0254id.com_facebook_picker_image);
    ...
    public String getPictureFieldSpecifier() {
        ImageView picture = (ImageView) createGraphObjectView((GraphObject) null, (View) null).findViewById(C0253R.C0254id.com_facebook_picker_image);
        if (picture == null) {
            return null;
        }
