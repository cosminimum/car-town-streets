...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
    ...
    /* renamed from: ID */
    private static final String f402ID = "id";
    ...
    public PlacePickerFragment(Bundle args) {
        super(GraphPlace.class, C0253R.layout.com_facebook_placepickerfragment, args);
    ...
    public void onInflate(Activity activity, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray a = activity.obtainStyledAttributes(attrs, C0253R.styleable.com_facebook_place_picker_fragment);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (this.showSearchBox && (stub = (ViewStub) view.findViewById(C0253R.C0254id.com_facebook_placepickerfragment_search_box_stub)) != null) {
            this.searchBox = (EditText) stub.inflate();
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(3, C0253R.C0254id.search_box);
            ((ListView) view.findViewById(C0253R.C0254id.com_facebook_picker_list_view)).setLayoutParams(layoutParams);
            if (view.findViewById(C0253R.C0254id.com_facebook_picker_title_bar) != null) {
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
                layoutParams2.addRule(3, C0253R.C0254id.com_facebook_picker_title_bar);
    ...
    public String getDefaultTitleText() {
        return getString(C0253R.string.com_facebook_nearby);
    }
        ...
        PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace> adapter = new PickerFragment<GraphPlace>.PickerFragmentAdapter<GraphPlace>(getActivity()) {
            ...
            public CharSequence getSubTitleOfGraphObject(GraphPlace graphObject) {
                ...
                if (category != null && wereHereCount != null) {
                    return PlacePickerFragment.this.getString(C0253R.string.com_facebook_placepicker_subtitle_format, category, wereHereCount);
                } else if (category == null && wereHereCount != null) {
                    return PlacePickerFragment.this.getString(C0253R.string.com_facebook_placepicker_subtitle_were_here_only_format, wereHereCount);
                } else if (category == null || wereHereCount != null) {
                    return null;
                } else {
                    return PlacePickerFragment.this.getString(C0253R.string.com_facebook_placepicker_subtitle_catetory_only_format, category);
                }
            }

            /* access modifiers changed from: protected */
            public int getGraphObjectRowLayoutId(GraphPlace graphObject) {
                return C0253R.layout.com_facebook_placepickerfragment_list_row;
            }

            /* access modifiers changed from: protected */
            public int getDefaultPicture() {
                return C0253R.drawable.com_facebook_place_default_icon;
            }
        };
