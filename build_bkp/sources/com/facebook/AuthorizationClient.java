...
class AuthorizationClient implements Serializable {
    ...
    public boolean checkInternetPermission() {
        ...
        if (checkPermission("android.permission.INTERNET") != 0) {
            complete(Result.createErrorResult(this.context.getString(C0253R.string.com_facebook_internet_permission_error_title), this.context.getString(C0253R.string.com_facebook_internet_permission_error_message)));
            return false;
        }
