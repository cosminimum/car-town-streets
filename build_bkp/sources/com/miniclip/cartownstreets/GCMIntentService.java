...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    public void showNotification(Context context, String title, String message) {
        ...
        note.setLatestEventInfo(this, title, message, PendingIntent.getActivity(this, 0, new Intent(this, CarTownStreetsActivity.class), 0));
        note.defaults |= 4;
        note.flags |= 16;
        ((NotificationManager) getSystemService("notification")).notify(Newsfeed.NOTIF_ID, note);
    }
