...
public abstract class BaseActivity extends Activity {
    ...
    public void showInterstitialCloseButton() {
        if (this.mCloseButton == null) {
            ...
            states.addState(new int[]{-16842919}, getResources().getDrawable(C2049R.drawable.close_button_normal));
            states.addState(new int[]{16842919}, getResources().getDrawable(C2049R.drawable.close_button_pressed));
