...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(FragmentManagerImpl fm, BackStackRecord bse) {
        int pos;
        int numRemoved = 0;
        for (BackStackRecord.C0000Op op = bse.mHead; op != null; op = op.next) {
            if (op.removed != null) {
        ...
        BackStackRecord.C0000Op op2 = bse.mHead;
        int pos2 = 0;
        while (op2 != null) {
            int pos3 = pos2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            BackStackRecord.C0000Op op = new BackStackRecord.C0000Op();
            int pos2 = pos + 1;
