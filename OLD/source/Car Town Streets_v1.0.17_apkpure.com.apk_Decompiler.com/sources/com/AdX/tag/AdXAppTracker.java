...
public class AdXAppTracker extends BroadcastReceiver {
    ...
    private void pass_on_broadcast(Context paramContext, Intent paramIntent) {
        ...
        try {
            ...
            if (localObject2 != null && (localActivityInfo = localObject2.getReceiverInfo(new ComponentName(paramContext, AdXAppTracker.class), 128)) != null && localActivityInfo.metaData != null && (localObject = localActivityInfo.metaData.keySet()) != null) {
