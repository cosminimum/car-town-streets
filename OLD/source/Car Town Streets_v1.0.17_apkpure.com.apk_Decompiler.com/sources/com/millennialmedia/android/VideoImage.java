...
class VideoImage implements Parcelable, Externalizable {
    ...
    private void deserializeFromObj(JSONObject imageObject) {
        if (imageObject != null) {
            this.imageUrl = imageObject.optString("image", (String) null);
            ...
            this.linkUrl = imageObject.optString(PlusShare.KEY_CALL_TO_ACTION_URL, (String) null);
            this.overlayOrientation = imageObject.optString("overlayOrientation", (String) null);
