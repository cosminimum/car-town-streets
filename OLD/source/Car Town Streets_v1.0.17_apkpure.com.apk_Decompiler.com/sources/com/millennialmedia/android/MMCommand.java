...
class MMCommand implements Runnable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x00ee, code lost:
        com.millennialmedia.android.MMAdViewSDK.Log.e("Exception while executing javascript call %s %s", r15.method.toString(), r1.getMessage());
        r1.printStackTrace();
     */
    ...
    public void run() {
        ...
        L_0x0098:
            ...
            com.millennialmedia.android.MMAdViewSDK.Log.v((java.lang.String) r8)     // Catch:{ Exception -> 0x00ed }
        ...
        L_0x00ed:
            ...
            r9[r13] = r10
            com.millennialmedia.android.MMAdViewSDK.Log.e(r8, r9)
            r1.printStackTrace()
            goto L_0x00cb
        */
