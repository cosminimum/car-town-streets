...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements IProjectionDelegate {
        ...
        private static class C0062a implements IProjectionDelegate {
            private IBinder dU;
        ...
        public static IProjectionDelegate ag(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0062a(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    b screenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
