...
public final class GroundOverlayOptions implements SafeParcelable {
    ...
    public GroundOverlayOptions position(LatLng location, float width, float height) {
        ...
        eg.a(this.CD == null, "Position has already been set using positionFromBounds");
        eg.b(location != null, (Object) "Location must be specified");
        eg.b(width >= BitmapDescriptorFactory.HUE_RED, (Object) "Width must be non-negative");
    ...
    public GroundOverlayOptions transparency(float transparency) {
        eg.b(transparency >= BitmapDescriptorFactory.HUE_RED && transparency <= 1.0f, (Object) "Transparency must be in the range [0..1]");
        this.CE = transparency;
        return this;
    }
