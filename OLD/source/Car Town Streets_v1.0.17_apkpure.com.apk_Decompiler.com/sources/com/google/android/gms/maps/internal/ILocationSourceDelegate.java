...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class a extends Binder implements ILocationSourceDelegate {
        ...
        private static class C0059a implements ILocationSourceDelegate {
            private IBinder dU;
        ...
        public static ILocationSourceDelegate T(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ILocationSourceDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C0059a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(g.a.Y(data.readStrongBinder()));
