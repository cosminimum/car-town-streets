...
public final class LatLngBounds implements SafeParcelable {
    ...
    LatLngBounds(int versionCode, LatLng southwest2, LatLng northeast2) {
        eg.b(southwest2, (Object) "null southwest");
        eg.b(northeast2, (Object) "null northeast");
        eg.a(northeast2.latitude >= southwest2.latitude, "southern latitude exceeds northern latitude (%s > %s)", Double.valueOf(southwest2.latitude), Double.valueOf(northeast2.latitude));
        this.kg = versionCode;
