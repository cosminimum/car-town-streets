...
public class g {
    ...
    public static class a extends WebChromeClient {
        ...
        public void onExceededDatabaseQuota(String url, String databaseIdentifier, long currentQuota, long estimatedSize, long totalUsedQuota, WebStorage.QuotaUpdater quotaUpdater) {
            ...
            long longValue = a2.i.a().longValue() - totalUsedQuota;
            if (longValue <= 0) {
                quotaUpdater.updateQuota(currentQuota);
                return;
            }
            if (currentQuota == 0) {
                if (estimatedSize > longValue || estimatedSize > a2.j.a().longValue()) {
                    estimatedSize = 0;
                }
            } else if (estimatedSize == 0) {
                estimatedSize = Math.min(Math.min(a2.k.a().longValue(), longValue) + currentQuota, a2.j.a().longValue());
            } else {
                if (estimatedSize <= Math.min(a2.j.a().longValue() - currentQuota, longValue)) {
        ...
        public void onReachedMaxAppCacheSize(long spaceNeeded, long totalUsedQuota, WebStorage.QuotaUpdater quotaUpdater) {
            l.a a2 = this.a.a.a().a.a();
            long longValue = a2.g.a().longValue() + spaceNeeded;
            if (a2.h.a().longValue() - totalUsedQuota < longValue) {
