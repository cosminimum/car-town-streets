...
public class d {
    ...
    public d(Ad ad, Activity activity, AdSize adSize, String str, ViewGroup viewGroup, boolean z2) {
        ...
        this.k = false;
        this.h = new Handler();
        this.p = TapjoyConstants.THROTTLE_GET_TAP_POINTS_INTERVAL;
        this.l = false;
        this.n = false;
        this.m = true;
        if (activity == null) {
            ...
            this.b = new m(a4, ad, adView2, interstitialAd2, str, (Activity) null, (Context) null, viewGroup, a3);
            return;
        }
        synchronized (a) {
        ...
        if (adSize == null) {
            ...
            a2 = h.a(adSize, activity.getApplicationContext());
        }
        this.b = new m(a5, ad, adView, interstitialAd, str, activity, applicationContext, viewGroup, a2);
        this.q = new ae(this);
    ...
    private void a(List<String> list, String str, String str2, String str3, Boolean bool, String str4, String str5) {
        ...
        for (String a4 : list) {
            new Thread(new ac(g.a(a4, this.b.d.a(), bool, a2, str, str2, str3, bigInteger, bigInteger2, str4, str5), this.b.f.a())).start();
        }
        this.e.b();
    }
    ...
    public synchronized void x() {
        ...
        if (a2 == null) {
            ...
            while (it.hasNext()) {
                new Thread(new ac((String) it.next(), a2.getApplicationContext())).start();
            }
        }
    }
    ...
    public void a(long j2) {
        synchronized (a) {
            ...
            edit.putLong("Timeout" + this.b.d, j2);
            edit.commit();
            if (this.r) {
                this.i = j2;
            }
