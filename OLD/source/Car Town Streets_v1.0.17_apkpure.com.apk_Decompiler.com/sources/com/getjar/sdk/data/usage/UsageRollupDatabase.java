...
public class UsageRollupDatabase extends SQLiteOpenHelper {
    ...
    private UsageRollupDatabase(Context context, String name) {
        ...
        Logger.i(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "UsageRollupDatabase: Opened database '%1$s'", new Object[]{name}));
    }
        ...
        if (eventType == null) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                if (reportingWindows.size() <= 0) {
                    ...
                    Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: collectAppSessionEvent() Created reporting window [id:%1$d start:%2$d stop:%3$d]", new Object[]{Long.valueOf(windowId), Long.valueOf(eventTimestamp), Long.valueOf(stop)}));
                } else {
                    int i = 0;
                    while (true) {
                    ...
                    while (windowStop < now) {
                        ...
                        if (windowStop >= reportingStart) {
                            ...
                            newWindowsCreated = true;
                            Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: collectAppSessionEvent() Created reporting window [id:%1$d start:%2$d stop:%3$d]", new Object[]{Long.valueOf(newId), Long.valueOf(windowStart), Long.valueOf(windowStop)}));
                ...
                if (windowId < 0) {
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: collectAppSessionEvent() Failed to find or create a reporting window for an event with timestamp %1$d, giving up...", new Object[]{Long.valueOf(eventTimestamp)}));
                    return;
                }
                ...
                if (activeWindow == null) {
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: collectAppSessionEvent() Reporting window %1$d for an event with timestamp %2$d, has been purged, giving up...", new Object[]{Long.valueOf(windowId), Long.valueOf(eventTimestamp)}));
                    return;
                }
    ...
    public java.util.List<com.getjar.sdk.data.usage.AggregateSession> loadAggregateSessions() {
        ...
        L_0x003c:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r8)     // Catch:{ all -> 0x0031 }
            goto L_0x003a
        L_0x0050:
            r8 = move-exception
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r8)     // Catch:{ all -> 0x0031 }
            goto L_0x0030
        */
        ...
        try {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageRollupDatabase: loadAggregateSessions() results.close() failed", e2);
                }
            }
        }
    }
    ...
    private void purgeObsoleteAggregationDataInternal() {
        ...
        if (reportingWindows.size() > windowCount) {
            for (int i = windowCount; i < reportingWindows.size(); i++) {
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: purgeObsoleteAggregationDataInternal() Removed %1$d roll-up records for aged-out reporting window %2$d", new Object[]{Integer.valueOf(deleteCount), Long.valueOf(windowIdToKill)}));
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageRollupDatabase: purgeObsoleteAggregationDataInternal() Removed aged-out reporting window %1$d", new Object[]{Long.valueOf(windowIdToKill)}));
            }
        }
    }
        ...
        try {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageRollupDatabase: loadReportingWindows() results.close() failed", e2);
                }
            }
        }
    }
        ...
        try {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageRollupDatabase: loadAggregateSession() results.close() failed", e2);
                }
            }
        }
    }
