...
public class DBCache extends SQLiteOpenHelper {
    ...
    private DBCache(Context context, String databaseName) {
        ...
        Logger.i(Area.STORAGE.value(), String.format(Locale.US, "DBCache: Opened caching database '%1$s'", new Object[]{databaseName}));
    }
    ...
    public static DBCache getInstanceUserSpecific(Context context, String namespace) {
        ...
        Logger.i(Area.STORAGE.value(), String.format(Locale.US, "DBCache: waitForUserAccess() START [%1$s] [%2$s]", new Object[]{namespace, Logger.getShortStack()}));
        AuthManager.initialize(context);
        AuthManager.getInstance().waitOnAuth();
        Logger.i(Area.STORAGE.value(), String.format(Locale.US, "DBCache: waitForUserAccess() DONE [%1$s]", new Object[]{namespace}));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        synchronized (this._databaseAccessLock) {
            Logger.i(Area.STORAGE.value(), String.format(Locale.US, "Upgrading database from version %1$d to %2$d, which will destroy all old data", new Object[]{Integer.valueOf(oldVersion), Integer.valueOf(newVersion)}));
    ...
    public boolean checkForCacheEntry(java.lang.String r12) {
        ...
        L_0x0041:
            ...
            com.getjar.sdk.logging.Logger.e(r5, r3, r1)     // Catch:{ all -> 0x004e }
            goto L_0x003d
        L_0x004e:
            r2 = move-exception
            monitor-exit(r4)     // Catch:{ all -> 0x004e }
    ...
    public boolean upsertCacheEntry(CacheEntry cacheEntry) {
        ...
        try {
            if (checkForCacheEntry(cacheEntry.getName())) {
                synchronized (this._databaseAccessLock) {
                    Logger.v(Area.STORAGE.value(), String.format(Locale.US, "Updating cache entry %1$s", new Object[]{cacheEntry.toString()}));
            ...
            synchronized (this._databaseAccessLock) {
                ...
                Logger.v(Area.STORAGE.value(), String.format(Locale.US, "Inserting cache entry %1$s", new Object[]{cacheEntry.toString()}));
    ...
    public long getRecordCount() {
        ...
        L_0x0024:
            ...
            com.getjar.sdk.logging.Logger.e(r6, r2, r1)     // Catch:{ all -> 0x0031 }
            goto L_0x0022
        L_0x0031:
            r2 = move-exception
            monitor-exit(r3)     // Catch:{ all -> 0x0031 }
        ...
        L_0x0039:
            ...
            com.getjar.sdk.logging.Logger.e(r4, r6, r1)     // Catch:{ all -> 0x0031 }
            goto L_0x0038
        */
