...
public class UsageDatabase extends SQLiteOpenHelper {
    ...
    private UsageDatabase(Context context, String name) {
        ...
        Logger.i(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "UsageDatabase: Opened database '%1$s'", new Object[]{DATABASE_NAME}));
    }
    ...
    private void trimLruEntries(String tableName, int maxRecordsCap) {
        if (maxRecordsCap < 0) {
            ...
            try {
                ...
                if (count > 0) {
                    Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: trimLruEntries() %1$d LRU rows deleted form %2$s", new Object[]{Integer.valueOf(count), tableName}));
                }
            } finally {
                if (results != null) {
                    try {
    ...
    private void setRecordAsSynced(String tableName, long id) {
        ...
        Logger.w(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: setRecordAsSynced() failed to find record %1$d", new Object[]{Long.valueOf(id)}));
    }
    ...
    private void setSessionAsDisposable(String tableName, String sessionId) {
        ...
        if (updateCount > 0) {
            Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: setSessionAsDisposable() %1$d non-disposable record(s) in %2$s for session ID %3$s, updated as 'disposable'", new Object[]{Integer.valueOf(updateCount), tableName, sessionId}));
        }
    }
    ...
    public java.util.List<com.getjar.sdk.data.usage.ApplicationSessionEvent> appSessionLoadUnsynced() {
        ...
        L_0x003b:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r9)     // Catch:{ all -> 0x0030 }
            goto L_0x0039
        L_0x004f:
            r9 = move-exception
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r9)     // Catch:{ all -> 0x0030 }
            goto L_0x002f
        */
    ...
    public com.getjar.sdk.data.usage.ApplicationLists appSessionLoadOpenStartLists() {
        ...
        L_0x006e:
            ...
            long r1 = r1 | r3
            java.lang.String r3 = "Usage: UsageDatabase: appSessionLoadUnsynced() failed"
            com.getjar.sdk.logging.Logger.e(r1, r3, r10)     // Catch:{ all -> 0x0048 }
            goto L_0x0061
        L_0x0082:
            r10 = move-exception
            ...
            long r1 = r1 | r3
            java.lang.String r3 = "Usage: UsageDatabase: appSessionLoadUnsynced() failed"
            com.getjar.sdk.logging.Logger.e(r1, r3, r10)     // Catch:{ all -> 0x0050 }
            goto L_0x0067
        L_0x0096:
            r10 = move-exception
            ...
            com.getjar.sdk.logging.Logger.e(r2, r4, r10)     // Catch:{ all -> 0x0050 }
            goto L_0x004f
        */
    ...
    public long appSessionStart(String packageName, SessionEvent.Reason reason, String reasonDetails, long eventTimestamp, String phoneSessionId, String appSessionId) {
        ...
        if (StringUtility.isNullOrEmpty(packageName)) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: appSessionStart() [packageName:%1$s timestamp:%2$d sessionId:%3$s phoneSessionId:%4$s]", new Object[]{packageName, Long.valueOf(eventTimestamp), appSessionId, phoneSessionId}));
            }
            trimLruEntries();
            return rowId;
        }
    ...
    public long appSessionStop(String packageName, SessionEvent.Reason reason, String reasonDetails, long eventTimestamp, String phoneSessionId, String appSessionId) {
        ...
        if (StringUtility.isNullOrEmpty(packageName)) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                values.put("disposable", 1);
                rowId = getWritableDatabase().insert(DATABASE_TABLE_APP_SESSIONS, (String) null, values);
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: appSessionStop() [packageName:%1$s timestamp:%2$d sessionId:%3$s phoneSessionId:%4$s] stack:%5$s", new Object[]{packageName, Long.valueOf(eventTimestamp), sessionId, phoneSessionId, Logger.getShortStack()}));
            }
            trimLruEntries();
            return rowId;
        }
    ...
    public long appSessionStop(ApplicationSessionEvent startEvent, SessionEvent.Reason reason, String reasonDetails, long eventTime) {
        ...
        if (startEvent == null) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                values.put("disposable", 1);
                rowId = getWritableDatabase().insert(DATABASE_TABLE_APP_SESSIONS, (String) null, values);
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: appSessionStop() [packageName:%1$s timestamp:%2$d sessionId:%3$s phoneSessionId:%4$s]", new Object[]{startEvent.getPackageName(), Long.valueOf(stopTime), startEvent.getSessionId(), startEvent.getPhoneSessionId()}));
            }
            trimLruEntries();
            return rowId;
        }
    ...
    public com.getjar.sdk.data.usage.ApplicationSessionEvent appSessionLoadStartRecord(java.lang.String r13) {
        ...
        L_0x002d:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r8)     // Catch:{ all -> 0x0041 }
            goto L_0x002b
        L_0x0041:
            r0 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x0041 }
        ...
        L_0x004c:
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r8)     // Catch:{ all -> 0x0041 }
            goto L_0x004b
        */
        ...
        try {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageDatabase: appSessionLoadOpenStartsInternal() failed", e2);
                }
            }
        }
    }
    ...
    public com.getjar.sdk.data.usage.ApplicationSessionEvent appSessionLoad(long r13) {
        ...
        L_0x0038:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r8)     // Catch:{ all -> 0x004c }
            goto L_0x0036
        L_0x004c:
            r0 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x004c }
        ...
        L_0x0057:
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r8)     // Catch:{ all -> 0x004c }
            goto L_0x0056
        */
    ...
    private String getLatestStopApplicationSessionId(String packageName) {
        ...
        try {
            ...
            if (results.moveToNext()) {
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: getLatestStopApplicationSessionId() loaded: %1$s", new Object[]{applicationSessionId}));
            }
            if (results != null) {
                try {
                } catch (Exception e) {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageDatabase: getLatestStopApplicationSessionId() failed", e2);
                }
            }
        }
    }
    ...
    private String getLatestStartApplicationSessionId(String packageName) {
        ...
        try {
            ...
            if (results.moveToNext()) {
                applicationSessionId = results.getString(0);
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: getLatestStartApplicationSessionId() loaded: %1$s", new Object[]{applicationSessionId}));
            }
            if (results != null) {
                try {
                } catch (Exception e) {
            ...
            if (results != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageDatabase: getLatestStartApplicationSessionId() failed", e2);
                }
            }
        }
    }
    ...
    public java.util.List<com.getjar.sdk.data.usage.PhoneSessionEvent> phoneSessionLoadUnsynced() {
        ...
        L_0x003b:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r8)     // Catch:{ all -> 0x0030 }
            goto L_0x0039
        L_0x004f:
            r8 = move-exception
            com.getjar.sdk.logging.Area r1 = com.getjar.sdk.logging.Area.USAGE     // Catch:{ all -> 0x0030 }
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r8)     // Catch:{ all -> 0x0030 }
            goto L_0x002f
        */
    ...
    public void phoneSessionStart(SessionEvent.Reason reason, String reasonDetails, String phoneSessionId) {
        if (reason == null) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: phoneSessionStart() [timestamp:%1$d sessionId:%2$s]", new Object[]{Long.valueOf(now), phoneSessionId}));
            }
            trimLruEntries();
        }
    }
        ...
        if (reason == null) {
            ...
            synchronized (this._databaseAccessLock) {
                ...
                if (startEvent != null) {
                    ...
                    values.put("disposable", 1);
                    getWritableDatabase().insert(DATABASE_TABLE_PHONE_SESSIONS, (String) null, values);
                    Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: phoneSessionStop() [timestamp:%1$d sessionId:%2$s]", new Object[]{Long.valueOf(stopTime), startEvent.getSessionId()}));
                    trimLruEntries();
                }
            }
        }
    ...
    private PhoneSessionEvent getPhoneSessionStart(String phoneSessionId) {
        ...
        try {
            ...
            if (dbResults2.moveToNext()) {
                ...
                Logger.v(Area.USAGE.value() | Area.STORAGE.value(), String.format(Locale.US, "Usage: UsageDatabase: getPhoneSession() loaded: %1$s", new Object[]{result}));
            }
            if (dbResults2 != null) {
                try {
                } catch (Exception e) {
            ...
            if (dbResults2 != null) {
                try {
                    ...
                    Logger.e(Area.USAGE.value() | Area.STORAGE.value(), "Usage: UsageDatabase: getPhoneSession() failed", e2);
                }
            }
        }
    }
