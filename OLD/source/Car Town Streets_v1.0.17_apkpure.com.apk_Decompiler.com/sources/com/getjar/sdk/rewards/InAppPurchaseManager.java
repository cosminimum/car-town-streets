...
public class InAppPurchaseManager {
        ...
        CommContext commContext = CommManager.createContext(applicationKey, context, (ResultReceiver) new ResultReceiver((Handler) null) {
            ...
            public void onReceiveResult(int resultCode, Bundle resultData) {
                for (String key : resultData.keySet()) {
                    Logger.d(Area.OS_ENTRY_POINT.value() | Area.BUY_GOLD.value() | Area.AUTH.value() | Area.COMM.value(), String.format(Locale.US, "InAppPurchaseManager: Callback from the GetJar SDK [%1$s]", new Object[]{resultData.get(key).getClass().getName()}));
                }
            }
        ...
        if (StringUtility.isNullOrEmpty(platformItemId)) {
            ...
            try {
                ...
                while (true) {
                    ...
                    Logger.d(Area.BUY_GOLD.value(), "GooglePurchaseResponse getResponseAsMap " + obj.toString());
                ...
                Logger.e(Area.BUY_GOLD.value(), "GooglePurchaseReponse getResponseAsMap", e);
            }
            return detailsMap;
        }
    }
    ...
    public boolean ensureBoundToGooglePlaySvc() {
        /*
            ...
            com.getjar.sdk.logging.Logger.i(r4, r6)
            r2 = 1
        ...
        L_0x0064:
            ...
            com.getjar.sdk.logging.Logger.d(r6, r4, r0)     // Catch:{ all -> 0x007b }
            r2 = 0
        L_0x0078:
            int r1 = r1 + 1
            goto L_0x0033
    ...
    public boolean isApi3BillingSupported() {
        ...
        editor.commit();
        Logger.i(Area.OFFER.value(), String.format(Locale.US, "InAppPurchaseManager isApi3BillingSupported returning %1$b", new Object[]{Boolean.valueOf(result)}));
        return result;
    }
            ...
            do {
                try {
                    ...
                    if (ownedItems.containsKey("RESPONSE_CODE") && Constants.ResponseCode.valueOf(response).equals(Constants.ResponseCode.RESULT_OK)) {
                        ...
                        Logger.v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "InAppPurchaseManager cancelOrphanedManagedOffers Got %1$d items", new Object[]{Integer.valueOf(purchaseDataList.size())}));
            ...
            for (TransactionBucket transaction : DBTransactions.getInstance(this._commContext.getApplicationContext()).loadAllTransactions()) {
                if (transaction.getType().equals(DBTransactions.TransactionType.MANAGED_OFFER) && !transaction.getClientTransactionId().equals(currentClientTransactionId)) {
                    ...
                    if (googlePendingClientTransactionIds.contains(transaction.getClientTransactionId())) {
                        Logger.v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "InAppPurchaseManager cancelOrphanedManagedOffers skipped [clientTransactionId: %1$s]", new Object[]{transaction.getClientTransactionId()}));
                        ...
                        Logger.v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "InAppPurchaseManager cancelOrphanedManagedOffers CANCELING [clientTransactionId: %1$s]", new Object[]{transaction.getClientTransactionId()}));
                    } else {
                        ...
                        Logger.v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "InAppPurchaseManager cancelOrphanedManagedOffers DONE [clientTransactionId: %1$s]", new Object[]{transaction.getClientTransactionId()}));
                    }
                }
            }
        }
                    ...
                    do {
                        ...
                        if (ownedItems.containsKey("RESPONSE_CODE")) {
                            if (Constants.ResponseCode.valueOf(response).equals(Constants.ResponseCode.RESULT_OK)) {
                                ...
                                continuationToken = ownedItems.getString(IabHelper.INAPP_CONTINUATION_TOKEN);
                                Logger.d(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Got %s items", new Object[]{Integer.valueOf(purchaseDataList.size())}));
    ...
    public boolean consumeManagedOffer(ManagedOfferBucket transaction, boolean isCancelling) {
        ...
        try {
            ...
            Logger.v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Consuming product: %1$s", new Object[]{purchaseData}));
            if (!StringUtility.isNullOrEmpty(purchaseData)) {
                ...
                if (this.isGooglePlayConnected) {
                    ...
                    if (response.equals(Constants.ResponseCode.RESULT_OK)) {
                        ...
                        TransactionManager.updateOfferTransactionState(this._commContext, transaction, DBTransactions.ManagedOfferState.DONE);
                        result = true;
                        Logger.w(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "Unable to consume [marketplaceItemId:%1$s] [reason:%2$s]", new Object[]{transaction.getRelatedObject().getOfferToken(), response}));
                    }
                }
            } else {
