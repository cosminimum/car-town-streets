...
public abstract class GetJarSubActivityBase implements GetJarSubActivity {
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.v(Area.UI.value(), String.format(Locale.US, "AuthFlow: takeoverUI() BEFORE waitDialogWasShowing:%1$s, unableToDownloadDialogWasShowing:%2$s", new Object[]{Boolean.valueOf(GetJarSubActivityBase.this._waitDialogWasShowing), Boolean.valueOf(GetJarSubActivityBase.this._unableToDownloadDialogWasShowing)}));
                    ...
                    Logger.v(Area.UI.value(), String.format(Locale.US, "AuthFlow: takeoverUI() AFTER waitDialogWasShowing:%1$s, unableToDownloadDialogWasShowing:%2$s", new Object[]{Boolean.valueOf(GetJarSubActivityBase.this._waitDialogWasShowing), Boolean.valueOf(GetJarSubActivityBase.this._unableToDownloadDialogWasShowing)}));
                } catch (Exception e) {
    ...
    public void relinquishUI() {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            public void run() {
                try {
                    Logger.v(Area.UI.value(), String.format(Locale.US, "AuthFlow: relinquishUI() BEFORE waitDialogWasShowing:%1$s, unableToDownloadDialogWasShowing:%2$s", new Object[]{Boolean.valueOf(GetJarSubActivityBase.this._waitDialogWasShowing), Boolean.valueOf(GetJarSubActivityBase.this._unableToDownloadDialogWasShowing)}));
                    ...
                    Logger.v(Area.UI.value(), String.format(Locale.US, "AuthFlow: relinquishUI() AFTER waitDialogWasShowing:%1$s, unableToDownloadDialogWasShowing:%2$s", new Object[]{Boolean.valueOf(GetJarSubActivityBase.this._waitDialogWasShowing), Boolean.valueOf(GetJarSubActivityBase.this._unableToDownloadDialogWasShowing)}));
                } catch (Exception e) {
    ...
    public void unableToDownloadDialogShow() {
        Logger.d(Area.UI.value(), String.format(Locale.US, "Showing 'unable to download' dialog [thread:%1$d] [called-from:%2$s()]", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getStackTrace()[3].getMethodName()}));
    ...
    public void unableToDownloadDialogHide() {
        Logger.d(Area.UI.value(), String.format(Locale.US, "Hiding 'unable to download' dialog [thread:%1$d] [called-from:%2$s()]", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getStackTrace()[3].getMethodName()}));
        synchronized (dialogLock) {
    ...
    public void waitDialogShow() {
        Logger.d(Area.UI.value(), String.format(Locale.US, "Showing 'please wait' dialog [thread:%1$d] [called-from:%2$s()]", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getStackTrace()[3].getMethodName()}));
        synchronized (dialogLock) {
    ...
    public void waitDialogHide() {
        Logger.d(Area.UI.value(), String.format(Locale.US, "Hiding 'please wait' dialog [thread:%1$d] [called-from:%2$s()]", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getStackTrace()[3].getMethodName()}));
        synchronized (dialogLock) {
    ...
    public void processWaitDialogQueue() {
        Logger.d(Area.UI.value(), String.format(Locale.US, "process wait dialog called: [thread:%1$d] [called-from:%2$s()]", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getStackTrace()[3].getMethodName()}));
        synchronized (dialogLock) {
