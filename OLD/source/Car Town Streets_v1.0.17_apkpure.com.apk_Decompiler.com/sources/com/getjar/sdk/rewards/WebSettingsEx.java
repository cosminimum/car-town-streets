    ...
    public static void setDefaultZoom(WebSettings webSettings, Object value) {
        try {
            ...
            if (value == null) {
                ...
                Logger.v(Area.UI.value(), String.format(Locale.US, "WebSettings.setDefaultZoom(ZoomDensity.%1$s) successfully called", new Object[]{value}));
            }
        } catch (Exception e) {
            e.printStackTrace();
            Logger.w(Area.UI.value(), String.format(Locale.US, "Unable to call WebSettings.setDefaultZoom(ZoomDensity.%1$s)", new Object[]{value}));
        }
    }
