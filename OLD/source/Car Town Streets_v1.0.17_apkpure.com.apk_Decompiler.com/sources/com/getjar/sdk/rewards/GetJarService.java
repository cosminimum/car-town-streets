...
public class GetJarService extends Service implements ServiceConnection {
    ...
    class RequestPurchase extends BillingRequest {
        ...
        /* access modifiers changed from: protected */
        public long run() throws RemoteException {
            Logger.d(Area.BUY_GOLD.value(), String.format(Locale.US, "GooglePlayBillingService RequestPurchase run mProductId %s", new Object[]{this.mProductId}));
            ...
            Logger.d(Area.BUY_GOLD.value(), String.format(Locale.US, "GetJarService requestBundle: %s", new Object[]{request}));
            if (GetJarService.googlePlayBillingService != null) {
