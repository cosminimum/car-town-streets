            ...
            try {
                ...
                try {
                    ...
                    if (result == null) {
                        ...
                        Logger.d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: ProxyAccountUserAuthProvider: ensureUser() DONE [userAccessId:%1$s, userDeviceId%2$s, authToken:%3$s, claimsCount:%4$d, ttl:%5$d]", new Object[]{authResult.getUserAccessId(), authResult.getUserDeviceId(), authResult.getAuthToken(), Integer.valueOf(authResult.getClaims().size()), Long.valueOf(authResult.getTTL())}));
                        Logger.d(Area.AUTH.value(), "AuthFlow: ProxyAccountUserAuthProvider: ensureUser() DONE");
                        return authResult;
                    } else {
