        ...
        if (StringUtility.isNullOrEmpty(this._sdkUserAgent)) {
            synchronized (this._sdkUserAgentLock) {
                if (StringUtility.isNullOrEmpty(this._sdkUserAgent)) {
                    ...
                    Logger.i(Area.COMM.value(), String.format(Locale.US, "SDK User Agent value: '%1$s'", new Object[]{this._sdkUserAgent}));
                }
            }
        }
                ...
                synchronized (this._webKitUserAgentLock) {
                    if (StringUtility.isNullOrEmpty(this._webKitUserAgent)) {
                        ...
                        if (!StringUtility.isNullOrEmpty(overrideUserAgent)) {
                            Logger.v(Area.COMM.value(), String.format(Locale.US, "[*** OVERRIDE ***] Override value being used: 'webkit.user.agent' = '%1$s'", new Object[]{overrideUserAgent}));
                        } else {
                            ...
                            Logger.i(Area.COMM.value(), String.format(Locale.US, "WebKit User Agent value: '%1$s'", new Object[]{this._webKitUserAgent}));
                        }
                    }
                }
