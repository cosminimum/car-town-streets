...
public class AndroidAccountUserAuthProvider implements UserAuthProvider {
    ...
    public static String getAccountNameFromHash(Context context, String accountNameHash) {
        ...
        if (context == null) {
            ...
            try {
                ...
                Logger.d(Area.AUTH.value(), String.format(Locale.US, str, new Object[]{accountName}));
            }
        }
    }
            ...
            try {
                ...
                try {
                    ...
                    if (result == null) {
                        ...
                        Logger.d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE [userAccessId:%1$s, userDeviceId%2$s, authToken:%3$s, claimsCount:%4$d, ttl:%5$d]", new Object[]{authResult.getUserAccessId(), authResult.getUserDeviceId(), authResult.getAuthToken(), Integer.valueOf(authResult.getClaims().size()), Long.valueOf(authResult.getTTL())}));
                        Logger.d(Area.AUTH.value(), "AuthFlow: AndroidAccountUserAuthProvider: ensureUser() DONE");
                        return authResult;
                    } else {
    ...
    private Map<String, MetadataValue> getProviderData(CommContext commContext, AuthUIParentInterface uiParent, ProviderHint providerHint) {
        ...
        if (!StringUtility.isNullOrEmpty(androidAccountName) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName, commContext)) != null) {
            Logger.d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:cache]", new Object[]{androidAccountName}));
        }
        if (androidAccount == null) {
            if (isProviderHintForMe(providerHint)) {
                ...
                if (!StringUtility.isNullOrEmpty(androidAccountName2) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName2, commContext)) != null) {
                    Logger.d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:hint]", new Object[]{androidAccountName2}));
            ...
            if (androidAccount == null) {
                ...
                if (!StringUtility.isNullOrEmpty(androidAccountName3) && (androidAccount = this._accountResolver.getAndroidAccountFromName(androidAccountName3, commContext)) != null) {
                    Logger.d(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: getProviderData() [account:'%1$s'] [source:ui]", new Object[]{androidAccountName3}));
    ...
    private boolean validateUserAuthProviderAndDataCacheEntry(UserAuthProviderAndDataCacheEntry providerAndData) {
        if (providerAndData == null) {
            ...
            Logger.v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: validateUserAuthProviderAndDataCacheEntry(): Cached provider data is for '%1$s' and is not usable by '%2$s'", new Object[]{providerAndData.getUserAuthProviderType().getName(), getClass().getName()}));
            return false;
    ...
    public com.getjar.sdk.comm.auth.UserAuthProviderAndDataCacheEntry getUserAuthProviderAndData(android.content.Context r14) {
        ...
        L_0x0015:
            ...
            com.getjar.sdk.logging.Logger.d(r6, r8)     // Catch:{ Exception -> 0x004f }
            goto L_0x0014
        L_0x004f:
            r2 = move-exception
            ...
            com.getjar.sdk.logging.Logger.e(r6, r8, r2)
            goto L_0x0014
        */
    ...
    private void setUserAuthProviderAndData(CommContext commContext, String accountName) {
        Logger.v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountUserAuthProvider: Updating cached UserAuthProviderAndDataCacheEntry [type:%1$s data:%2$s]", new Object[]{AndroidAccountUserAuthProvider.class.getName(), accountName}));
    ...
    private class AndroidAccountResolver {
        ...
        public boolean validateAccountAgainstCache(CommContext commContext, CharSequence accountName) {
            ...
            Logger.v(Area.AUTH.value() | Area.STORAGE.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() cached account and available account do not match [cache:%1$s available:%2$s]", new Object[]{cachedAccountName, accountName}));
            return false;
        }
        ...
        public String getAndroidAccountNameViaUI(CommContext commContext, AuthUIParentInterface uiParent) {
            ...
            if (accountNames.length == 1 && validateAccountAgainstCache(commContext, accountNames[0])) {
                        ...
                        new Handler(Looper.getMainLooper()).post(new Runnable() {
                            public void run() {
                                ...
                                try {
                                    ...
                                    Logger.d(Area.AUTH.value() | Area.UI.value(), str);
                                }
                            }
                        });
                ...
                Logger.d(Area.AUTH.value() | Area.UI.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: getAndroidAccountNameViaUI() FINISHED Returning %1$s", new Object[]{this._accountNameFromUI}));
                return this._accountNameFromUI;
            } else {
            ...
            new Handler(Looper.getMainLooper()).post(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Logger.v(Area.AUTH.value() | Area.UI.value(), str);
                    }
                }
            });
            try {
        ...
        public synchronized void accountResolved(CommContext commContext, CharSequence accountName) {
            if (accountName != null) {
                try {
                    ...
                    Logger.i(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: AndroidAccountResolver: accountResolved(): '%1$s'", new Object[]{this._accountNameFromUI}));
                } finally {
