...
public class CommManager {
    ...
    private Operation enqueueRequest(Operation newOperation, boolean isRetry) {
        ...
        if (newOperation == null) {
            ...
            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Adding [isRetry:%2$s]", new Object[]{getLoggingPrefix(newOperation), Boolean.valueOf(isRetry)}));
            synchronized (_RequestPipelineLock) {
                ...
                if (existingOperation != null) {
                    ...
                    if (requestResult != null) {
                        ...
                        if (isRetry) {
                            ...
                            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Returning new Request, added to retry pool", new Object[]{getLoggingPrefix(newOperation)}));
                        } else {
                            _RequestQueue.add(newOperation);
                            newOperation.setState(Operation.Status.WAITING);
                            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Returning new Request, added to priority queue", new Object[]{getLoggingPrefix(newOperation)}));
                        }
                        workPending = true;
                    }
                ...
                if (workPending) {
                    Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s kicking worker thread", new Object[]{getLoggingPrefix(returnOperation)}));
                ...
                synchronized (operation.getFuture()) {
                    try {
                        ...
                        while (operation.getState() == Operation.Status.RETRYING) {
                            ...
                            Logger.v(Area.COMM.value(), String.format(Locale.US, "Request %1$d resulted in a %2$d, retrying in %3$d seconds", new Object[]{Integer.valueOf(operation.getId()), Integer.valueOf(result.getResponseCode()), Long.valueOf(tryAgainInSeconds)}));
        ...
        if (operation == null) {
            ...
            if (operation.getRetryAfterCount() < 5 && (operation.getResult().getResponseCode() == 202 || operation.getResult().getResponseCode() == 503)) {
                ...
                try {
                    ...
                    Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s updateOperationStateFromResult() re-auth retry check failed", new Object[]{getLoggingPrefix(operation)}), e);
                }
            }
        }
    }
    ...
    public Result processesRequestWithRetries(Operation operation) {
        ...
        if (operation == null) {
            ...
            Logger.w(Area.COMM.value(), String.format(Locale.US, "%1$s Operation was cancelled, returning last result", new Object[]{getLoggingPrefix(operation)}));
            return operation.getResult();
                ...
                try {
                    ...
                    if (!operation.isCancelled()) {
                        ...
                        if (failureRetryCount > 0) {
                            Logger.w(Area.COMM.value(), msg);
                        } else {
                            Logger.d(Area.COMM.value(), msg);
                        }
                        if (!operation.isCancelled()) {
                            requestResult = processesRequest(operation, failureRetryCount);
                            if (requestResult == null) {
                                Logger.w(Area.COMM.value(), String.format(Locale.US, "%1$s processesRequest() returned NULL", new Object[]{getLoggingPrefix(operation)}));
                            ...
                            if (!operation.isCancelled()) {
                                ...
                                Logger.w(Area.COMM.value(), String.format(Locale.US, "%1$s Operation was cancelled, returning NULL", new Object[]{getLoggingPrefix(operation)}));
                                return null;
                            }
                        } else {
                            Logger.w(Area.COMM.value(), String.format(Locale.US, "%1$s Operation was cancelled, returning NULL", new Object[]{getLoggingPrefix(operation)}));
                    ...
                    Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s Operation failed [failureRetryCount:%2$d details:'%3$s - %4$s']", new Object[]{getLoggingPrefix(operation), Integer.valueOf(failureRetryCount), exc2.getClass().getName(), exc2.getMessage()}));
                    ...
                    if (!retry || failureRetryCount >= 5) {
                        Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s Operation failed, not retrying, returning NULL", new Object[]{getLoggingPrefix(operation)}));
                        requestResult = null;
    ...
    private com.getjar.sdk.comm.Result processesRequest(com.getjar.sdk.comm.Operation r53, int r54) throws java.lang.Exception {
        ...
        L_0x000a:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.w(r7, r0)     // Catch:{ URISyntaxException -> 0x007b }
        ...
        L_0x0084:
            ...
            java.lang.String r46 = java.lang.String.format(r46, r47, r48)     // Catch:{ URISyntaxException -> 0x007b }
            r0 = r46
            com.getjar.sdk.logging.Logger.i(r7, r0)     // Catch:{ URISyntaxException -> 0x007b }
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.d(r7, r0)     // Catch:{ UnsupportedEncodingException -> 0x0703, all -> 0x06fe }
        ...
        L_0x01b2:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.d(r7, r0)     // Catch:{ all -> 0x0356 }
            r0 = r25
            org.apache.http.client.methods.HttpPost r0 = (org.apache.http.client.methods.HttpPost) r0     // Catch:{ all -> 0x0356 }
            r7 = r0
        ...
        L_0x0263:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.v(r7, r0)     // Catch:{ all -> 0x02c0 }
            r0 = r24
            r1 = r32
            r2 = r45
        ...
        L_0x02d3:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.i(r0, r8)     // Catch:{ URISyntaxException -> 0x0343 }
        ...
        L_0x0329:
            ...
            r0 = r46
            r2 = r43
            com.getjar.sdk.logging.Logger.w(r0, r2)     // Catch:{ URISyntaxException -> 0x0343 }
        L_0x0342:
        ...
        L_0x0346:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.w(r7, r0)     // Catch:{ all -> 0x0356 }
            goto L_0x016c
        L_0x0356:
            r7 = move-exception
            r24 = r25
        ...
        L_0x041c:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.v(r7, r0)     // Catch:{ Exception -> 0x04d0 }
        L_0x04a9:
        ...
        L_0x04d0:
            ...
            java.lang.String r46 = java.lang.String.format(r46, r47, r48)     // Catch:{ all -> 0x02c0 }
            r0 = r46
            com.getjar.sdk.logging.Logger.e(r7, r0, r15)     // Catch:{ all -> 0x02c0 }
            goto L_0x04a9
        L_0x04f9:
        ...
        L_0x0507:
            ...
            java.lang.String r46 = java.lang.String.format(r46, r47, r48)     // Catch:{ all -> 0x02c0 }
            r0 = r46
            com.getjar.sdk.logging.Logger.d(r7, r0)     // Catch:{ all -> 0x02c0 }
            r4 = 0
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.i(r7, r0)     // Catch:{ all -> 0x02c0 }
        ...
        L_0x05fd:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.w(r7, r0)     // Catch:{ all -> 0x0708 }
        L_0x0652:
        ...
        L_0x0668:
            ...
            r0 = r46
            com.getjar.sdk.logging.Logger.i(r7, r0)     // Catch:{ URISyntaxException -> 0x0343 }
        ...
        L_0x06b8:
            ...
            long r7 = r7.value()     // Catch:{ URISyntaxException -> 0x0343 }
            r0 = r43
            com.getjar.sdk.logging.Logger.w(r7, r0)     // Catch:{ URISyntaxException -> 0x0343 }
        L_0x06d3:
            r7 = r3
            goto L_0x004c
        L_0x06d6:
        ...
        L_0x06d9:
            ...
            long r7 = r7.value()     // Catch:{ URISyntaxException -> 0x0343 }
            r0 = r43
            com.getjar.sdk.logging.Logger.d(r7, r0)     // Catch:{ URISyntaxException -> 0x0343 }
            goto L_0x06d3
        L_0x06e5:
            java.lang.String r8 = ""
            goto L_0x0329
        L_0x06e9:
            ...
            r0 = r46
            r2 = r43
            com.getjar.sdk.logging.Logger.d(r0, r2)     // Catch:{ URISyntaxException -> 0x0343 }
            goto L_0x0342
        L_0x06f8:
            r7 = move-exception
            goto L_0x01b2
    ...
    private void startWorker() {
        Logger.i(Area.COMM.value(), String.format(Locale.US, "%1$s startWorker()", new Object[]{getLoggingPrefix()}));
        synchronized (_WorkerThreadLock) {
            ...
            if (!_WorkerThread.isAlive()) {
                _WorkerThread.start();
                Logger.i(Area.COMM.value(), String.format(Locale.US, "%1$s Thread started", new Object[]{getLoggingPrefix()}));
            } else {
                Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Thread already running", new Object[]{getLoggingPrefix()}));
            }
        }
    }
    ...
    private void stopWorker() {
        /*
            ...
            com.getjar.sdk.logging.Logger.i(r1, r3)
            ...
            com.getjar.sdk.logging.Logger.v(r3, r1)     // Catch:{ all -> 0x0097 }
        ...
        L_0x003f:
            ...
            r6[r7] = r8     // Catch:{ all -> 0x0097 }
            java.lang.String r1 = java.lang.String.format(r1, r5, r6)     // Catch:{ all -> 0x0097 }
            com.getjar.sdk.logging.Logger.i(r3, r1)     // Catch:{ all -> 0x0097 }
        L_0x0095:
            monitor-exit(r2)     // Catch:{ all -> 0x0097 }
            goto L_0x003e
        L_0x0097:
        ...
        L_0x009d:
            ...
            com.getjar.sdk.logging.Logger.e(r3, r1, r0)     // Catch:{ all -> 0x0131 }
            r1 = 0
            _WorkerThread = r1     // Catch:{ all -> 0x0097 }
            com.getjar.sdk.logging.Area r1 = com.getjar.sdk.logging.Area.COMM     // Catch:{ all -> 0x0097 }
            long r3 = r1.value()     // Catch:{ all -> 0x0097 }
        ...
        L_0x0131:
            ...
            com.getjar.sdk.logging.Logger.i(r3, r5)     // Catch:{ all -> 0x0097 }
            throw r1     // Catch:{ all -> 0x0097 }
        */
    ...
    public long getSleepTime() {
        ...
        if (sleepTime == Long.MAX_VALUE) {
            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s returning a sleep time of MAX_VALUE", new Object[]{getLoggingPrefix()}));
        } else {
            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s returning a sleep time of %2$d milliseconds", new Object[]{getLoggingPrefix(), Long.valueOf(sleepTime)}));
        }
        return sleepTime;
    }
    ...
    private static CommContext createContextInternal(String applicationToken, String encryptionKey, Context androidContext, ResultReceiver resultReceiver, ProviderHint providerHint, LaunchWork launchWork) {
        ...
        Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Calling configureAppenders()", new Object[]{getLoggingPrefix()}));
        try {
        ...
        Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Creating CommContext instance", new Object[]{getLoggingPrefix()}));
    ...
    private static class DoLaunchWork implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (LaunchWork.DEALS.equals(this._launchWork)) {
                    ...
                    if (!AuthManager.getInstance().isNewUser()) {
                        try {
                            ...
                            Logger.i(Area.LICENSING.value(), String.format(Locale.US, "%1$s Updating License cache success", new Object[]{CommManager.getLoggingPrefix()}));
                        } catch (Exception e) {
                            Logger.e(Area.LICENSING.value(), String.format(Locale.US, "%1$s Updating License cache failed", new Object[]{CommManager.getLoggingPrefix()}), e);
                        }
                        doTransactionRelatedLaunchWork(launchWorkContext);
                    }
                    if (AuthManager.getInstance().getClaimsManager(launchWorkContext.getApplicationContext()).canBuy()) {
                        try {
                            ...
                            Logger.e(Area.TRANSACTION.value(), String.format(Locale.US, "%1$s getGoldOffers() failed", new Object[]{CommManager.getLoggingPrefix()}), e2);
                        }
                    }
                } else {
                ...
                Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s DoLaunchWork.run() failed", new Object[]{CommManager.getLoggingPrefix()}), e3);
            }
        }
        ...
        private void doTransactionRelatedLaunchWork(CommContext launchWorkContext) {
            try {
                ...
                Logger.e(Area.TRANSACTION.value(), String.format(Locale.US, "%1$s Recovering orphaned transactions failed", new Object[]{CommManager.getLoggingPrefix()}), e);
            }
            if (AuthManager.getInstance().getClaimsManager(launchWorkContext.getApplicationContext()).canPurchaseManagedProducts()) {
                try {
                    ...
                    Logger.i(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "%1$s cancelOrphanedManagedOffers() success", new Object[]{CommManager.getLoggingPrefix()}));
                } catch (Exception e2) {
                    Logger.e(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "%1$s cancelOrphanedManagedOffers() failed", new Object[]{CommManager.getLoggingPrefix()}), e2);
                }
                try {
                    InAppPurchaseManager.getInstance(launchWorkContext.getApplicationContext()).processOutstandingPurchases(false);
                    Logger.i(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "%1$s processOutstandingPurchases() success", new Object[]{CommManager.getLoggingPrefix()}));
                } catch (Exception e3) {
                    Logger.e(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "%1$s processOutstandingPurchases() failed", new Object[]{CommManager.getLoggingPrefix()}), e3);
                }
            }
        }
    }
    ...
    private class RequestCallable implements Callable<Result> {
        ...
        public Result call() throws Exception {
            ...
            if (requestResult == null) {
                Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s Received a NULL result", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
            } else {
                Logger.d(Area.COMM.value(), String.format(Locale.US, "%1$s Received response code: %2$d", new Object[]{CommManager.getLoggingPrefix(this._operation), Integer.valueOf(requestResult.getResponseCode())}));
        ...
        private void cleanup() {
            synchronized (CommManager._RequestPipelineLock) {
                Logger.d(Area.COMM.value(), String.format(Locale.US, "%1$s RequestFutureTask has completed work, doing cleanup work [state:%2$s]", new Object[]{CommManager.getLoggingPrefix(this._operation), this._operation.getState()}));
                try {
                    CommManager.this.updateOperationStateFromResult(this._operation);
                } catch (Exception e) {
                    Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s updateOperationStateFromResult() failed", new Object[]{CommManager.getLoggingPrefix(this._operation)}), e);
                }
                if (CommManager._ActiveRequests.remove(this._operation)) {
                    Logger.i(Area.COMM.value(), String.format(Locale.US, "%1$s Completed Request has been removed from _ActiveRequests", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
                } else {
                    Logger.i(Area.COMM.value(), String.format(Locale.US, "%1$s Completed Request was not found in _ActiveRequests", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
                }
                if (!Operation.Status.RETRYING.equals(this._operation.getState())) {
                    if (CommManager._RequestQueue.remove(this._operation)) {
                        Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s Found completed Request in _RequestQueue", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
                    }
                    if (CommManager._RetryRequests.remove(this._operation)) {
                        Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s Found completed Request in _RetryRequests", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
                    }
                }
                Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s kicking worker thread", new Object[]{CommManager.getLoggingPrefix(this._operation)}));
        ...
        public void run() {
            ...
            while (!CommManager._WorkerThreadStopping) {
                try {
                    ...
                    synchronized (CommManager._RequestPipelineLock) {
                        Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s queued:%2$d active:%3$d retry:%4$d", new Object[]{CommManager.getLoggingPrefix(), Integer.valueOf(CommManager._RequestQueue.size()), Integer.valueOf(CommManager._ActiveRequests.size()), Integer.valueOf(CommManager._RetryRequests.size())}));
                        long now = System.currentTimeMillis();
                        ...
                        for (Operation retryOperation2 : requestsToMove) {
                            ...
                            Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s moved request from retry to queue", new Object[]{CommManager.getLoggingPrefix(retryOperation2)}));
                        }
                        ...
                        Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Worker Thread is waiting to be notified", new Object[]{CommManager.getLoggingPrefix()}));
                        CommManager._RequestPipelineLock.wait(sleepTime);
                        Logger.v(Area.COMM.value(), String.format(Locale.US, "%1$s Worker Thread is awake", new Object[]{CommManager.getLoggingPrefix()}));
                    }
                    if (CommManager._WorkerThreadStopping) {
                        break;
                    }
                } catch (Exception e) {
                    Logger.e(Area.COMM.value(), String.format(Locale.US, "%1$s failure", new Object[]{CommManager.getLoggingPrefix()}), e);
                    try {
                        Thread.sleep(5000);
                    } catch (Exception e2) {
                    }
            ...
            Logger.i(Area.COMM.value(), String.format(Locale.US, "%1$s Worker Thread exited", new Object[]{CommManager.getLoggingPrefix()}));
        }
    }
