...
public class ApplicationKeyDatabase extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        synchronized (this._databaseAccessLock) {
            Logger.d(Area.STORAGE.value(), String.format(Locale.US, "Upgrading database '%1$s' from version %2$d to %3$d, which will destroy all old data", new Object[]{DATABASE_NAME, Integer.valueOf(oldVersion), Integer.valueOf(newVersion)}));
    ...
    public java.lang.String getApplicationKey() {
        ...
        L_0x0023:
            ...
            com.getjar.sdk.logging.Logger.v(r0, r2)     // Catch:{ all -> 0x003d }
        ...
        L_0x0030:
            ...
            com.getjar.sdk.logging.Logger.e(r0, r2, r9)     // Catch:{ all -> 0x003d }
            goto L_0x0023
        L_0x003d:
            r0 = move-exception
            monitor-exit(r11)     // Catch:{ all -> 0x003d }
        ...
        L_0x0046:
            ...
            com.getjar.sdk.logging.Logger.e(r1, r3, r9)     // Catch:{ all -> 0x003d }
            goto L_0x0045
        */
