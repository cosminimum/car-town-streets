.class public Lcom/getjar/sdk/comm/persistence/PurchaseUnmanagedBucket;
.super Lcom/getjar/sdk/comm/persistence/TransactionBucket;
.source "PurchaseUnmanagedBucket.java"
...
.method public constructor <init>()V
    ...
    invoke-virtual {p0, v0}, Lcom/getjar/sdk/comm/persistence/PurchaseUnmanagedBucket;->setType(Lcom/getjar/sdk/comm/persistence/DBTransactions$TransactionType;)V
...
# virtual methods
.method public getRelatedObject()Lcom/getjar/sdk/comm/persistence/RelatedPurchaseData;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    .prologue
    .line 71
    iget-object v0, p0, Lcom/getjar/sdk/comm/persistence/PurchaseUnmanagedBucket;->_relatedObject:Ljava/lang/String;
    ...
    check-cast v0, Lcom/getjar/sdk/comm/persistence/RelatedPurchaseData;
...
.method public bridge synthetic getRelatedObject()Ljava/io/Serializable;
    ...
    .prologue
    .line 12
    invoke-virtual {p0}, Lcom/getjar/sdk/comm/persistence/PurchaseUnmanagedBucket;->getRelatedObject()Lcom/getjar/sdk/comm/persistence/RelatedPurchaseData;
...
.method public getState()Lcom/getjar/sdk/comm/persistence/DBTransactions$PurchaseState;
    .locals 2
...
.method public setState(Lcom/getjar/sdk/comm/persistence/DBTransactions$PurchaseState;)V
    .locals 1
    .param p1, "state"    # Lcom/getjar/sdk/comm/persistence/DBTransactions$PurchaseState;

    .prologue
    .line 54
    invoke-virtual {p1}, Lcom/getjar/sdk/comm/persistence/DBTransactions$PurchaseState;->name()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/getjar/sdk/comm/persistence/PurchaseUnmanagedBucket;->setStateString(Ljava/lang/String;)V
...
.method protected setStateString(Ljava/lang/String;)V
    ...
    const-string v3, "Can not set the state for PurchaseBucket to \'%1$s\'"
...
.method public setType(Lcom/getjar/sdk/comm/persistence/DBTransactions$TransactionType;)V
    ...
    const-string v2, "Can not set the TransactionType for PurchaseBucket to \'%1$s\'"
...
.method protected setTypeString(Ljava/lang/String;)V
    ...
    const-string v3, "Can not set the TransactionType for PurchaseBucket to \'%1$s\'"
