...
public class rotatedBannerImg extends RelativeLayout implements MoPubView.OnAdFailedListener, MoPubView.OnAdLoadedListener {
    ...
    public rotatedBannerImg(Context context, int alignment) {
        ...
        this.mOfflineAd.setLayoutParams(new LayoutParams((int) (50.0f * density), (int) (320.0f * density)));
    ...
    public void setAlignment(int alignment) {
        ...
        if (alignment == cocojava.ALIGN_RIGHT) {
            float density = cocojava.mDensity;
            LayoutParams sideBar3Params = new LayoutParams((int) (50.0f * density), (int) (320.0f * density));
    ...
    public void reAdd() {
        ...
        adLayoutVerticleClick.setLayoutParams(new LayoutParams((int) (((double) density) * 320.0d), (int) (((double) density) * 320.0d)));
    ...
    public void runAnimation() {
        this.mAnimationHandler.postDelayed(new Runnable() {
            public void run() {
                ...
                LayoutParams rlp = new LayoutParams((int) (cocojava.mDensity * 50.0f), (int) (cocojava.mDensity * 320.0f));
