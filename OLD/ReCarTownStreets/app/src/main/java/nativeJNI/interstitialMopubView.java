...
public class interstitialMopubView extends RelativeLayout implements View.OnClickListener {
    ...
    /* access modifiers changed from: package-private */
    public void showAd() {
        LayoutParams paramsDialog;
        LayoutParams paramsS;
        LayoutParams paramsR;
        if (!adView.AdLoaded()) {
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            paramsDialog = new LayoutParams((int) (((float) cocojava.mWidth) * density), (int) (((float) cocojava.mHeight) * density));
        } else {
            paramsDialog = new LayoutParams(cocojava.mWidth, cocojava.mHeight);
        }
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            LayoutParams params = new LayoutParams((int) (220.0f * density), (int) (50.0f * density));
            params.addRule(12);
            params.addRule(9);
            paramsS = params;
        } else {
            LayoutParams params2 = new LayoutParams(paramsDialog.width / 2, (int) (50.0f * density));
            params2.addRule(12);
            params2.addRule(9);
            paramsS = params2;
        }
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            LayoutParams params3 = new LayoutParams((int) (220.0f * density), (int) (50.0f * density));
            params3.addRule(12);
            params3.addRule(11);
            paramsR = params3;
        } else {
            LayoutParams params4 = new LayoutParams(paramsDialog.width / 2, (int) (50.0f * density));
            params4.addRule(12);
            params4.addRule(11);
            paramsR = params4;
        }
        ...
        LayoutParams paramsN = new LayoutParams((int) (300.0f * density), (int) (250.0f * density));
