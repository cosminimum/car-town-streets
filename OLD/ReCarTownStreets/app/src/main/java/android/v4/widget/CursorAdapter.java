...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public void init(Context context, Cursor c, int flags) {
        ...
        this.mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow(PurchaseDatabase.PURCHASED_PRODUCT_ID_COL) : -1;
        if ((flags & 2) == 2) {
    ...
    public Cursor swapCursor(Cursor newCursor) {
        ...
        if (newCursor != null) {
            ...
            this.mRowIDColumn = newCursor.getColumnIndexOrThrow(PurchaseDatabase.PURCHASED_PRODUCT_ID_COL);
