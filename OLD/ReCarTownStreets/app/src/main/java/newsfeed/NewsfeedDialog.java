...
public class NewsfeedDialog extends RelativeLayout implements View.OnClickListener {
    ...
    public NewsfeedDialog(Context context, Newsfeed newsfeed, boolean urgent) {
        super(context);
        LayoutParams paramsFull2;
        LayoutParams paramsFull3;
        LayoutParams paramsContent1;
        String htmlContent;
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            paramsFull2 = new LayoutParams((int) (490.0f * density), (int) (325.0f * density));
        } else {
            paramsFull2 = new LayoutParams((int) (320.0f * density), (int) (440.0f * density));
        }
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            paramsFull3 = new LayoutParams((int) (450.0f * density), (int) (265.0f * density));
        } else {
            paramsFull3 = new LayoutParams((int) (280.0f * density), (int) (380.0f * density));
        }
        ...
        if (cocojava.mINGAME_LANDSCAPE) {
            paramsContent1 = new LayoutParams((int) (430.0f * density), (int) (215.0f * density));
        } else {
            paramsContent1 = new LayoutParams((int) (260.0f * density), (int) (330.0f * density));
        }
        ...
        LayoutParams layoutParams2 = new LayoutParams((int) (55.0f * density), (int) (55.0f * density));
        ...
        if (!urgent && this.mNewsfeed.messagesNum < 1) {
            ...
            LayoutParams layoutParams4 = new LayoutParams(((int) (534.0f * density * bScale)) + ((int) (60.0f * density * bScale)), ((int) (73.0f * density * bScale)) + ((int) (35.0f * density * bScale)));
            layoutParams4.addRule(14);
            layoutParams4.addRule(12);
            RelativeLayout navButtons = new RelativeLayout(this.mContext);
            navButtons.setLayoutParams(layoutParams4);
            LayoutParams layoutParams5 = new LayoutParams((int) (116.0f * density * bScale), (int) (73.0f * density * bScale));
            ...
            LayoutParams paramsCenter1 = new LayoutParams((int) (302.0f * density * bScale), (int) (73.0f * density * bScale));
            ...
            LayoutParams layoutParams6 = new LayoutParams((int) (116.0d * ((double) (density * bScale))), (int) (73.0d * ((double) (density * bScale))));
            ...
            LayoutParams layoutParams7 = new LayoutParams((int) (126.0f * density), (int) (50.0f * density));
