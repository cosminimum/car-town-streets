        ...
        if (!(url == null || context == null)) {
            ...
            try {
                ...
                if (httpResponse == null) {
                    MMAdViewSDK.Log.m4416d("HTTP response is null");
                    mMJSResponse = null;
                } else {
                    HttpEntity httpEntity = httpResponse.getEntity();
                    if (httpEntity == null) {
                        MMAdViewSDK.Log.m4416d("Null HTTP entity");
                        mMJSResponse = null;
                    } else if (httpEntity.getContentLength() == 0) {
                        MMAdViewSDK.Log.m4416d("Millennial ad return failed. Zero content length returned.");
                        mMJSResponse = null;
                    } else {
                                ...
                                if (videoAd != null) {
                                    if (videoAd.isValid()) {
                                        try {
                                            ...
                                            MMAdViewSDK.Log.m4420e("Caching interrupted: %s", e.getMessage());
                                        }
                                    }
                                }
                            } catch (IllegalStateException e1) {
                                e1.printStackTrace();
                                MMAdViewSDK.Log.m4416d("Millennial ad return failed. Invalid response data.");
                                mMJSResponse = null;
                ...
                MMAdViewSDK.Log.m4416d("HTTP error: " + e2.getMessage());
                mMJSResponse = null;
            }
        }
        mMJSResponse = null;
