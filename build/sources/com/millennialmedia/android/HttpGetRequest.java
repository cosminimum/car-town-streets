...
class HttpGetRequest {
    ...
    public HttpResponse get(String url) throws Exception {
        try {
            ...
            MMAdViewSDK.Log.m4419e("Out of memory!");
            return null;
        }
    }
    ...
    public void trackConversion(String goalId, String auid, boolean isFirstLaunch, long installTime, TreeMap<String, String> extraParams) throws Exception {
        try {
            ...
            MMAdViewSDK.Log.m4417d("Sending conversion tracker report: %s", url);
            this.getRequest.setURI(new URI(url));
            HttpResponse response = this.client.execute(this.getRequest);
            if (response.getStatusLine().getStatusCode() == 200) {
                MMAdViewSDK.Log.m4429v("Conversion tracker reponse code: %d", Integer.valueOf(response.getStatusLine().getStatusCode()));
            } else {
                MMAdViewSDK.Log.m4420e("Conversion tracker unable to complete report: %d", Integer.valueOf(response.getStatusLine().getStatusCode()));
            }
        } catch (IOException e) {
            MMAdViewSDK.Log.m4420e("Unable to track conversion. %s", e.getMessage());
        }
    }
    ...
    static java.lang.String convertStreamToString(java.io.InputStream r7) throws java.io.IOException {
        ...
        L_0x003c:
            r4 = 0
            r1 = 0
            com.millennialmedia.android.MMAdViewSDK.Log.m4418d((java.lang.Throwable) r0)     // Catch:{ all -> 0x0049 }
        ...
        L_0x005a:
            r0 = move-exception
            com.millennialmedia.android.MMAdViewSDK.Log.m4418d((java.lang.Throwable) r0)
            goto L_0x0055
        L_0x005f:
            r0 = move-exception
            com.millennialmedia.android.MMAdViewSDK.Log.m4418d((java.lang.Throwable) r0)
    ...
    static void log(final String url) {
        if (url != null && url.length() > 0) {
            new Thread(new Runnable() {
                public void run() {
                    MMAdViewSDK.Log.m4429v("Logging event to: %s", url);
                    try {
                        new HttpGetRequest().get(url);
                    } catch (Exception e) {
                        MMAdViewSDK.Log.m4428v(e.getMessage());
                    }
                }
            }).start();
        }
