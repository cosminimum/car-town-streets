...
public class TapjoyURLConnection {
    ...
    public com.tapjoy.TapjoyHttpURLResponse getResponseFromURL(java.lang.String r17, java.lang.String r18, int r19) {
        /*
            r16 = this;
            ...
            com.tapjoy.TapjoyLog.m4436i(r13, r14)     // Catch:{ Exception -> 0x01ea }
            java.lang.String r13 = "TapjoyURLConnection"
            java.lang.StringBuilder r14 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x01ea }
            r14.<init>()     // Catch:{ Exception -> 0x01ea }
        ...
        L_0x00cd:
            ...
            com.tapjoy.TapjoyLog.m4435e(r13, r14)
        ...
        L_0x013c:
            ...
            com.tapjoy.TapjoyLog.m4436i(r13, r14)
            java.lang.String r13 = "TapjoyURLConnection"
            java.lang.StringBuilder r14 = new java.lang.StringBuilder
            r14.<init>()
        ...
        L_0x01bb:
            ...
            com.tapjoy.TapjoyLog.m4435e(r13, r14)     // Catch:{ Exception -> 0x00cc }
            goto L_0x01b8
        L_0x01d9:
    ...
    public String connectToURL(String url, String params) {
        ...
        try {
            ...
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "baseURL: " + url);
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "requestURL: " + requestURL);
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        TapjoyLog.m4435e(TAPJOY_URL_CONNECTION, "Exception: " + e.toString());
                        return httpResponse;
                    }
                }
                httpResponse = sb.toString();
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "--------------------");
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "response size: " + httpResponse.length());
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "response: ");
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "" + httpResponse);
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "--------------------");
    ...
    public String getContentLength(String url) {
        ...
        TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "content-length: " + contentLength);
    ...
    public String connectToURLwithPOST(String url, Hashtable<String, String> params, Hashtable<String, String> paramsData) {
        try {
            ...
            for (Map.Entry<String, String> item : params.entrySet()) {
                ...
                TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "key: " + item.getKey() + ", value: " + Uri.encode(item.getValue()));
            }
            if (paramsData != null) {
                if (paramsData.size() > 0) {
                    for (Map.Entry<String, String> item2 : paramsData.entrySet()) {
                        ...
                        TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "key: " + item2.getKey() + ", value: " + Uri.encode(item2.getValue()));
                    }
                }
            }
            httpPost.setEntity(new UrlEncodedFormEntity(pairs));
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "HTTP POST: " + httpPost.toString());
            ...
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "--------------------");
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "response status: " + response.getStatusLine().getStatusCode());
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "response size: " + httpResponse.length());
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "response: ");
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "" + httpResponse);
            TapjoyLog.m4436i(TAPJOY_URL_CONNECTION, "--------------------");
