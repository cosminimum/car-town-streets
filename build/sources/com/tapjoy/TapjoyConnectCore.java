...
public class TapjoyConnectCore {
    ...
    public TapjoyConnectCore(Context applicationContext) {
        ...
        init();
        TapjoyLog.m4436i("TapjoyConnect", "URL parameters: " + getURLParams());
        ...
        try {
            ...
            if (manager != null) {
                ...
                if (appInfo == null || appInfo.metaData == null) {
                    TapjoyLog.m4436i("TapjoyConnect", "No metadata present.");
                } else {
                    for (String key : TapjoyConnectFlag.FLAG_ARRAY) {
                        Object obj = appInfo.metaData.get("tapjoy." + key);
                        if (!(obj == null || (value = obj.toString()) == null)) {
                            TapjoyLog.m4436i("TapjoyConnect", "Found manifest flag: " + key + ", " + value);
                            connectFlags.put(key, value);
                        }
                    }
                    TapjoyLog.m4436i("TapjoyConnect", "Metadata successfully loaded");
                }
            }
        } catch (Exception e) {
            TapjoyLog.m4435e("TapjoyConnect", "Error reading manifest meta-data: " + e.toString());
        }
        try {
            ...
            try {
                ...
                TapjoyLog.m4436i("TapjoyConnect", "deviceID: " + deviceID);
                boolean invalidDeviceID = false;
                if (deviceID == null) {
                    TapjoyLog.m4435e("TapjoyConnect", "Device id is null.");
                    invalidDeviceID = true;
                } else if (deviceID.length() == 0 || deviceID.equals("000000000000000") || deviceID.equals("0")) {
                    TapjoyLog.m4435e("TapjoyConnect", "Device id is empty or an emulator.");
                    invalidDeviceID = true;
                } else {
                    deviceID = deviceID.toLowerCase();
                }
                TapjoyLog.m4436i("TapjoyConnect", "ANDROID SDK VERSION: " + Build.VERSION.SDK);
                if (Integer.parseInt(Build.VERSION.SDK) >= 9) {
                    TapjoyLog.m4436i("TapjoyConnect", "TRYING TO GET SERIAL OF 2.3+ DEVICE...");
                    serialID = new TapjoyHardwareUtil().getSerial();
                    if (invalidDeviceID) {
                        deviceID = serialID;
                    }
                    TapjoyLog.m4436i("TapjoyConnect", "====================");
                    TapjoyLog.m4436i("TapjoyConnect", "SERIAL: deviceID: [" + deviceID + "]");
                    TapjoyLog.m4436i("TapjoyConnect", "====================");
                    if (deviceID == null) {
                        TapjoyLog.m4435e("TapjoyConnect", "SERIAL: Device id is null.");
                        invalidDeviceID = true;
                    } else if (deviceID.length() == 0 || deviceID.equals("000000000000000") || deviceID.equals("0") || deviceID.equals("unknown")) {
                        TapjoyLog.m4435e("TapjoyConnect", "SERIAL: Device id is empty or an emulator.");
                        invalidDeviceID = true;
                    } else {
                        deviceID = deviceID.toLowerCase();
                ...
                TapjoyLog.m4435e("TapjoyConnect", "Error getting deviceID. e: " + e2.toString());
                deviceID = null;
            }
            if (userID.length() == 0) {
                userID = deviceID;
            ...
            try {
                ...
                TapjoyLog.m4435e("TapjoyConnect", "Error getting screen density/dimensions/layout: " + e3.toString());
            }
            try {
                ...
                TapjoyLog.m4435e("TapjoyConnect", "Error getting device mac address: " + e4.toString());
            }
            ...
            TapjoyLog.m4436i("TapjoyConnect", "APP_ID = [" + appID + "]");
            TapjoyLog.m4436i("TapjoyConnect", "ANDROID_ID: [" + androidID + "]");
            TapjoyLog.m4436i("TapjoyConnect", "CLIENT_PACKAGE = [" + clientPackage + "]");
            TapjoyLog.m4436i("TapjoyConnect", "deviceID: [" + deviceID + "]");
            TapjoyLog.m4436i("TapjoyConnect", "sha2DeviceID: [" + sha2DeviceID + "]");
            TapjoyLog.m4436i("TapjoyConnect", "serial_id: [" + serialID + "]");
            TapjoyLog.m4436i("TapjoyConnect", "mac_address: [" + macAddress + "]");
            TapjoyLog.m4436i("TapjoyConnect", "sha1_mac_address: [" + sha1MacAddress + "]");
            TapjoyLog.m4436i("TapjoyConnect", "deviceName: [" + deviceModel + "]");
            TapjoyLog.m4436i("TapjoyConnect", "deviceManufacturer: [" + deviceManufacturer + "]");
            TapjoyLog.m4436i("TapjoyConnect", "deviceType: [" + deviceType + "]");
            TapjoyLog.m4436i("TapjoyConnect", "libraryVersion: [" + libraryVersion + "]");
            TapjoyLog.m4436i("TapjoyConnect", "deviceOSVersion: [" + deviceOSVersion + "]");
            TapjoyLog.m4436i("TapjoyConnect", "COUNTRY_CODE: [" + deviceCountryCode + "]");
            TapjoyLog.m4436i("TapjoyConnect", "LANGUAGE_CODE: [" + deviceLanguage + "]");
            TapjoyLog.m4436i("TapjoyConnect", "density: [" + deviceScreenDensity + "]");
            TapjoyLog.m4436i("TapjoyConnect", "screen_layout: [" + deviceScreenLayoutSize + "]");
            TapjoyLog.m4436i("TapjoyConnect", "carrier_name: [" + carrierName + "]");
            TapjoyLog.m4436i("TapjoyConnect", "carrier_country_code: [" + carrierCountryCode + "]");
            TapjoyLog.m4436i("TapjoyConnect", "mobile_country_code: [" + mobileCountryCode + "]");
            TapjoyLog.m4436i("TapjoyConnect", "mobile_network_code: [" + mobileNetworkCode + "]");
            TapjoyLog.m4436i("TapjoyConnect", "store_name: [" + storeName + "]");
            TapjoyLog.m4436i("TapjoyConnect", "referralURL: [" + referralURL + "]");
            if (connectFlags != null) {
                TapjoyLog.m4436i("TapjoyConnect", "Connect Flags:");
                TapjoyLog.m4436i("TapjoyConnect", "--------------------");
                for (Map.Entry<String, String> item : connectFlags.entrySet()) {
                    TapjoyLog.m4436i("TapjoyConnect", "key: " + item.getKey() + ", value: " + Uri.encode(item.getValue()));
                    if (item.getKey().equals(TapjoyConnectFlag.SHA_2_UDID) && !sdkType.equals(TapjoyConstants.TJC_SDK_TYPE_CONNECT)) {
                        TapjoyLog.m4438w("TapjoyConnect", "WARNING -- only the Connect/Advertiser SDK can support sha_2_udid");
                        connectFlags.remove(TapjoyConnectFlag.SHA_2_UDID);
                    }
                }
            }
        } catch (Exception e5) {
            TapjoyLog.m4435e("TapjoyConnect", "Error initializing Tapjoy parameters.  e=" + e5.toString());
        }
    }
    ...
    private class PaidAppTimerTask extends TimerTask {
        ...
        public void run() {
            ...
            TapjoyLog.m4436i("TapjoyConnect", "elapsed_time: " + TapjoyConnectCore.this.elapsed_time + " (" + ((TapjoyConnectCore.this.elapsed_time / 1000) / 60) + "m " + ((TapjoyConnectCore.this.elapsed_time / 1000) % 60) + "s)");
            ...
            if (TapjoyConnectCore.this.elapsed_time >= TapjoyConstants.PAID_APP_TIME) {
                TapjoyLog.m4436i("TapjoyConnect", "timer done...");
                if (TapjoyConnectCore.paidAppActionID != null && TapjoyConnectCore.paidAppActionID.length() > 0) {
                    TapjoyLog.m4436i("TapjoyConnect", "Calling PPA actionComplete...");
        ...
        if (document != null) {
            ...
            if (nodeValue != null && nodeValue.length() > 0) {
                ...
                while (true) {
                    ...
                    TapjoyLog.m4436i("TapjoyConnect", "parse: " + data.substring(current, index).trim());
                    allPackageNames.add(data.substring(current, index).trim());
                    current = index + 1;
                }
                TapjoyLog.m4436i("TapjoyConnect", "parse: " + data.substring(current).trim());
                ...
                for (ApplicationInfo appInfo : context.getPackageManager().getInstalledApplications(0)) {
                    if ((appInfo.flags & 1) != 1 && allPackageNames.contains(appInfo.packageName)) {
                        TapjoyLog.m4436i("TapjoyConnect", "MATCH: installed packageName: " + appInfo.packageName);
    ...
    public boolean handlePayPerActionResponse(String response) {
        ...
        if (document != null) {
            ...
            if (nodeValue == null || !nodeValue.equals("true")) {
                TapjoyLog.m4435e("TapjoyConnect", "Completed Pay-Per-Action call failed.");
            } else {
                TapjoyLog.m4436i("TapjoyConnect", "Successfully sent completed Pay-Per-Action to Tapjoy server.");
                return true;
            }
        }
        return false;
    ...
    public void release() {
        ...
        TapjoyLog.m4436i("TapjoyConnect", "Releasing core static instance.");
    }
    ...
    public static String getVideoParams() {
        ...
        TapjoyLog.m4436i("TapjoyConnect", "video parameters: " + params);
        return params;
    }
    ...
    public static String getConnectionType() {
        ...
        try {
            ...
            if (!(connectivityManager == null || connectivityManager.getActiveNetworkInfo() == null)) {
                ...
                TapjoyLog.m4436i("TapjoyConnect", "connectivity: " + connectivityManager.getActiveNetworkInfo().getType());
                TapjoyLog.m4436i("TapjoyConnect", "connection_type: " + type);
            }
        } catch (Exception e) {
            TapjoyLog.m4435e("TapjoyConnect", "getConnectionType error: " + e.toString());
        }
        return type;
    }
    ...
    public static String getVerifier(long time) {
        try {
            ...
            TapjoyLog.m4435e("TapjoyConnect", "getVerifier ERROR: " + e.toString());
            return "";
        }
    }
    ...
    public static String getAwardPointsVerifier(long time, int amount, String guid) {
        try {
            ...
            TapjoyLog.m4435e("TapjoyConnect", "getAwardPointsVerifier ERROR: " + e.toString());
            return "";
        }
    }
    ...
    public static String getEventVerifier(String eventData) {
        try {
            ...
            TapjoyLog.m4435e("TapjoyConnect", "getEventVerifier ERROR: " + e.toString());
            return "";
        }
    }
    ...
    public static void setUserID(String id) {
        ...
        new Thread(new Runnable() {
            public void run() {
                TapjoyLog.m4436i("TapjoyConnect", "setUserID...");
                ...
                if (result != null) {
                    ...
                    TapjoyLog.m4436i("TapjoyConnect", "setUserID successful...");
                }
            }
        }).start();
    }
    ...
    public void actionComplete(String actionID) {
        TapjoyLog.m4436i("TapjoyConnect", "actionComplete: " + actionID);
        ...
        TapjoyLog.m4436i("TapjoyConnect", "PPA URL parameters: " + actionURLParams3);
        new Thread(new PPAThread(actionURLParams3)).start();
    }

    public void enablePaidAppWithActionID(String paidAppPayPerActionID) {
        TapjoyLog.m4436i("TapjoyConnect", "enablePaidAppWithActionID: " + paidAppPayPerActionID);
        ...
        TapjoyLog.m4436i("TapjoyConnect", "paidApp elapsed: " + this.elapsed_time);
    ...
    public class ConnectThread implements Runnable {
        ...
        public void run() {
            TapjoyLog.m4436i("TapjoyConnect", "starting connect call...");
            ...
            if (httpResponse != null && httpResponse.statusCode == 200) {
                if (TapjoyConnectCore.handleConnectResponse(httpResponse.response)) {
                    TapjoyLog.m4436i("TapjoyConnect", "Successfully connected to tapjoy site.");
                }
                if (TapjoyConnectCore.matchingPackageNames.length() > 0) {
                    ...
                    if (httpResponse2 != null && httpResponse2.statusCode == 200) {
                        TapjoyLog.m4436i("TapjoyConnect", "Successfully pinged sdkless api.");
                    }
                }
            }
        }
    ...
    public void setCurrencyMultiplier(float multiplier) {
        TapjoyLog.m4436i("TapjoyConnect", "setVirtualCurrencyMultiplier: " + multiplier);
