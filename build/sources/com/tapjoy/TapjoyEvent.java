...
public class TapjoyEvent {
    ...
    public void sendEvent(int type, String eventData) {
        TapjoyLog.m4436i(TAPJOY_EVENT, "sendEvent type: " + type);
        ...
        public void run() {
            ...
            if (httpResponse != null) {
                switch (httpResponse.statusCode) {
                    case 200:
                        TapjoyLog.m4436i(TapjoyEvent.TAPJOY_EVENT, "Successfully sent Tapjoy event");
                        return;
                    case 400:
                        TapjoyLog.m4435e(TapjoyEvent.TAPJOY_EVENT, "Error sending event: " + httpResponse.response);
                        return;
                    default:
                        TapjoyLog.m4435e(TapjoyEvent.TAPJOY_EVENT, "Server/network error: " + httpResponse.statusCode);
                        return;
                }
            } else {
                TapjoyLog.m4435e(TapjoyEvent.TAPJOY_EVENT, "Server/network error");
            }
        }
    }
}
