...
public class TJCOffersWebView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras == null) {
            TapjoyLog.m4435e("Offers", "Tapjoy offers meta data initialization fail.");
            ...
            TapjoyLog.m4436i("Offers", "urlParams: [" + this.urlParams + "]");
        ...
        TapjoyLog.m4436i("Offers", "clientPackage: [" + this.clientPackage + "]");
        ...
        TapjoyLog.m4436i("Offers", "Opening URL = [" + this.offersURL + "]");
    }
    ...
    public void onResume() {
        ...
        if (this.resumeCalled && TapjoyConnectCore.getInstance() != null) {
            TapjoyLog.m4436i("Offers", "call connect");
    ...
    private class TapjoyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            TapjoyLog.m4436i("Offers", "URL = [" + url + "]");
            if (url.startsWith("tjvideo://")) {
                ...
                while (index < url.length() && index != -1) {
                    ...
                    if (mode == 0) {
                        ...
                        if (c == '&') {
                            ...
                            word = "";
                            TapjoyLog.m4436i("Offers", "k:v: " + key + ", " + value);
                ...
                if (mode == 1 && word.length() > 0) {
                    ...
                    TapjoyLog.m4436i("Offers", "k:v: " + key + ", " + value2);
                ...
                TapjoyLog.m4436i("Offers", "videoID: " + videoID);
                TapjoyLog.m4436i("Offers", "currencyAmount: " + currencyAmount);
                TapjoyLog.m4436i("Offers", "currencyName: " + currencyName);
                TapjoyLog.m4436i("Offers", "clickURL: " + clickURL);
                TapjoyLog.m4436i("Offers", "webviewURL: " + webviewURL);
                TapjoyLog.m4436i("Offers", "videoURL: " + videoURL);
                if (TapjoyVideo.getInstance().startVideo(videoID, currencyName, currencyAmount, clickURL, webviewURL, videoURL)) {
                    TapjoyLog.m4436i("Offers", "VIDEO");
                    return true;
                }
                TapjoyLog.m4435e("Offers", "Unable to play video: " + videoID);
                ...
                try {
                    ...
                    TapjoyLog.m4435e("Offers", "e: " + e.toString());
                    return true;
                }
            } else if (url.contains(TapjoyConstants.TJC_BASE_REDIRECT_DOMAIN)) {
                TapjoyLog.m4436i("Offers", "Open redirecting URL = [" + url + "]");
                view.loadUrl(url);
                return true;
            } else {
                TapjoyLog.m4436i("Offers", "Opening URL in new browser = [" + url + "]");
                TJCOffersWebView.this.startActivity(new Intent("android.intent.action.VIEW", Uri.parse(url)));
                TapjoyLog.m4436i("Offers", "skipOfferWall: " + TJCOffersWebView.this.skipOfferWall);
