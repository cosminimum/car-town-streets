...
public class UsageMonitor {
                ...
                if (UsageScreenReceiver.getInstance().isScreenOn(this._context)) {
                    if (!_DebugHookSuppressMonitoring) {
                        synchronized (this._monitoringThreadLock) {
                            ...
                            Logger.m646v(value, String.format("Start monitoring being attempted while in monitoring state '%1$s'", objArr));
                            if (this._monitoringState == MonitoringState.STOPPED) {
                                ...
                                Logger.m646v(Area.USAGE.value(), "UsageMonitor: usage monitoring thread [instantiated]");
                                this._requestThreadExit = false;
                                this._monitoringThread.start();
                                Logger.m646v(Area.USAGE.value(), "UsageMonitor: usage monitoring thread [start() called]");
                            } else {
                                Logger.m646v(Area.USAGE.value(), String.format("Start monitoring found monitoring already running on thread '%1$d'", new Object[]{Long.valueOf(this._monitoringThread.getId())}));
                            }
                            ...
                            Logger.m646v(Area.USAGE.value(), String.format(Locale.US, "UsageMonitor: usage monitoring thread started [thread id: %1$d]", new Object[]{Long.valueOf(this._monitoringThread.getId())}));
                        }
                    }
                }
            }
    ...
    public void stopMonitoring() {
        ...
        L_0x0019:
            ...
            com.getjar.sdk.logging.Logger.m646v(r7, r4)     // Catch:{ all -> 0x00cf }
        ...
        L_0x0075:
            ...
            com.getjar.sdk.logging.Logger.m646v(r4, r7)     // Catch:{ Exception -> 0x00d2 }
        ...
        L_0x00bc:
            ...
            com.getjar.sdk.logging.Logger.m646v(r7, r4)     // Catch:{ all -> 0x0143 }
            r1 = 0
        L_0x00c6:
        ...
        L_0x00d2:
            ...
            com.getjar.sdk.logging.Logger.m643e(r4, r7, r0)     // Catch:{ all -> 0x011f }
            com.getjar.sdk.logging.Area r4 = com.getjar.sdk.logging.Area.USAGE     // Catch:{ all -> 0x0143 }
            long r7 = r4.value()     // Catch:{ all -> 0x0143 }
            java.util.Locale r5 = java.util.Locale.US     // Catch:{ all -> 0x0143 }
            java.lang.String r9 = "UsageMonitor: usage monitoring thread stopped [thread id: %1$s]"
        ...
        L_0x0111:
            ...
            com.getjar.sdk.logging.Logger.m643e(r4, r7, r0)     // Catch:{ Exception -> 0x00d2 }
            goto L_0x0075
        L_0x011f:
            r4 = move-exception
        ...
        L_0x0138:
            ...
            com.getjar.sdk.logging.Logger.m646v(r7, r5)     // Catch:{ all -> 0x0143 }
            r1 = 0
    ...
    private class UsageMonitoringThread extends Thread {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:54:?, code lost:
            com.getjar.sdk.logging.Logger.m643e(com.getjar.sdk.logging.Area.USAGE.value(), "UsageMonitor: UsageMonitoringThread: run() failed", r15);
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:61:0x013a, code lost:
            com.getjar.sdk.logging.Logger.m640d(com.getjar.sdk.logging.Area.USAGE.value(), java.lang.String.format(java.util.Locale.US, "UsageMonitor: UsageMonitoringThread: exiting [thread:%1$d]", new java.lang.Object[]{java.lang.Long.valueOf(java.lang.Thread.currentThread().getId())}));
         */
        ...
        public void run() {
            /*
                ...
                com.getjar.sdk.logging.Logger.m640d(r4, r11)     // Catch:{ Exception -> 0x011b }
                r0 = r34
                com.getjar.sdk.data.usage.UsageMonitor r4 = com.getjar.sdk.data.usage.UsageMonitor.this     // Catch:{ Exception -> 0x011b }
            ...
            L_0x0083:
                ...
                com.getjar.sdk.logging.Logger.m642e(r4, r11)     // Catch:{ InterruptedException -> 0x0252 }
                r0 = r34
            ...
            L_0x00eb:
                ...
                com.getjar.sdk.logging.Logger.m649w(r4, r11, r15)     // Catch:{ Exception -> 0x00f8 }
                goto L_0x0083
            L_0x00f8:
                r15 = move-exception
                r16 = 1
            ...
            L_0x011b:
                ...
                com.getjar.sdk.logging.Logger.m643e(r4, r11, r15)     // Catch:{ all -> 0x016d }
                r0 = r34
                ...
                com.getjar.sdk.logging.Logger.m640d(r4, r11)
            L_0x015e:
                return
            L_0x015f:
                r15 = move-exception
                ...
                com.getjar.sdk.logging.Logger.m643e(r4, r11, r15)     // Catch:{ Exception -> 0x011b }
                goto L_0x0060
            L_0x016d:
                r4 = move-exception
                r0 = r34
                ...
                com.getjar.sdk.logging.Logger.m640d(r11, r5)
                throw r4
            L_0x01ad:
                r15 = move-exception
                com.getjar.sdk.logging.Area r4 = com.getjar.sdk.logging.Area.USAGE     // Catch:{ Exception -> 0x011b }
            ...
            L_0x01d7:
                ...
                com.getjar.sdk.logging.Logger.m646v(r4, r11)     // Catch:{ InterruptedException -> 0x0252 }
            ...
            L_0x0252:
                ...
                com.getjar.sdk.logging.Logger.m640d(r4, r11)     // Catch:{ all -> 0x02f2 }
                long r4 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x00f8 }
                long r4 = r4 - r22
                long r28 = r28 + r4
                r0 = r34
            ...
            L_0x03de:
                ...
                com.getjar.sdk.logging.Logger.m649w(r11, r5, r15)     // Catch:{ Exception -> 0x00f8 }
                goto L_0x0324
            L_0x03ec:
                r15 = move-exception
                com.getjar.sdk.logging.Area r5 = com.getjar.sdk.logging.Area.USAGE     // Catch:{ Exception -> 0x00f8 }
            ...
            L_0x046f:
                ...
                com.getjar.sdk.logging.Logger.m643e(r11, r5, r15)     // Catch:{ Exception -> 0x011b }
                goto L_0x0112
            L_0x047d:
                r15 = move-exception
                com.getjar.sdk.logging.Area r5 = com.getjar.sdk.logging.Area.USAGE     // Catch:{ Exception -> 0x011b }
        ...
        private void updateLastChecked() {
            try {
                ...
                editor.commit();
                Logger.m646v(Area.USAGE.value(), "UsageMonitor: UsageMonitoringThread: updateLastChecked() updated");
            } catch (Exception e) {
                Logger.m643e(Area.USAGE.value(), "UsageMonitor: UsageMonitoringThread: updateLastChecked() failed", e);
            }
        }
    }
            ...
            return CommManager.createContext(applicationKey, context, (ResultReceiver) new ResultReceiver((Handler) null) {
                ...
                public void onReceiveResult(int resultCode, Bundle resultData) {
                    for (String key : resultData.keySet()) {
                        Logger.m640d(Area.USAGE.value() | Area.AUTH.value() | Area.COMM.value(), String.format(Locale.US, "UsageMonitor: Callback from the GetJar SDK [%1$s]", new Object[]{resultData.get(key).getClass().getName()}));
                    }
                }
