...
public class UsageManager {
    ...
    public boolean isMonitoringEnabled() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager isMonitoringEnabled: %1$s", new Object[]{value.toString()}));
    ...
    private boolean getBackgroundSendEnabled() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getBackgroundSendEnabled: %1$s", new Object[]{value.toString()}));
        return value.booleanValue();
    }
    ...
    private boolean getRequestSendEnabled() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getRequestSendEnabled: %1$s", new Object[]{value.toString()}));
        return value.booleanValue();
    }
    ...
    private Pattern getPackagePattern() {
        ...
        if (StringUtility.isNullOrEmpty(newRegEx)) {
            ...
            try {
                ...
                Logger.m648w(Area.USAGE.value() | Area.CONFIG.value(), String.format(Locale.US, "UsageManager: getPackagePattern() Bad regex pattern [%1$s]", new Object[]{getFilterRegex()}));
            }
        }
    ...
    public int getBackgroundBatchCount() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getBackgroundBatchCount: %1$s", new Object[]{value.toString()}));
    ...
    private String getFilterRegex() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getFilterRegex: %1$s", new Object[]{value}));
        return value;
    }
    ...
    private String getBackgroundTypeFilter() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getBackgroundTypeFilter: %1$s", new Object[]{value}));
        return value;
    }
    ...
    private boolean isFilterSystemEnabled() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager isFilterSystemEnabled: %1$s", new Object[]{value.toString()}));
        return value.booleanValue();
    }
    ...
    public int getBackgroundSendIntervalMilliseconds() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getBackgroundSendIntervalMilliseconds: %1$s", new Object[]{value2.toString()}));
    ...
    public int getRequestTimeWindowMilliseconds() {
        ...
        Integer value2 = Integer.valueOf(value.intValue() * 1000);
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getRequestTimeWindowMilliseconds: %1$s", new Object[]{value2.toString()}));
        return value2.intValue();
    }
    ...
    public int getRequestTimeWindowCount() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getRequestTimeWindowCount: %1$s", new Object[]{value.toString()}));
        return value.intValue();
    }
    ...
    private int getRequestMaxCount() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getRequestMaxCount: %1$s", new Object[]{value.toString()}));
        return value.intValue();
    }
    ...
    private String getRequestSort() {
        ...
        Logger.m640d(Area.USAGE.value() | Area.CONFIG.value(), String.format("UsageManager getRequestSort: %1$s", new Object[]{value}));
        return value;
    }
    ...
    public long startAppSession(String packageName, SessionEvent.Reason reason, String reasonDetails, String phoneSessionId, String appSessionId) {
        ...
        try {
            ...
            Logger.m643e(Area.USAGE.value(), "UsageManager: startAppSession() collectAppSessionEvent() failed", e);
    ...
    public long stopAppSession(ApplicationSessionEvent startEvent, SessionEvent.Reason reason, String reasonDetails) {
        ...
        try {
            ...
            Logger.m643e(Area.USAGE.value(), "UsageManager: stopAppSession() collectAppSessionEvent() failed", e);
            if (StringUtility.isNullOrEmpty(reasonDetails)) {
                reasonDetails = Logger.getThrowableDump(e);
            } else {
                reasonDetails = reasonDetails + " | " + Logger.getThrowableDump(e);
    ...
    public boolean shouldFilterFromUsage(String packageName) {
        ...
        if (isFilterSystemEnabled()) {
            try {
                ...
                Logger.m648w(Area.USAGE.value(), String.format(Locale.US, "UsageManager: Failed to get app flags [packageName:'%1$s' error:'%2$s']", new Object[]{packageName, e.getClass().getName()}));
            }
        }
        return false;
    }
    ...
    public boolean shouldFilterTypeFromUsage(ReportUsageData.UsageType usageType) {
                    ...
                    for (String type : typeFilter.trim().split("\\|")) {
                        if (type != null) {
                            try {
                                ...
                                Logger.m649w(Area.USAGE.value(), String.format("Illegal value [%s] for usage type filter", new Object[]{type}), e);
        ...
        Logger.m640d(Area.USAGE.value(), String.format(Locale.US, "UsageManager shouldFilterTypeFromUsage returning %s for %s", new Object[]{Boolean.toString(result), usageType.name()}));
        return result;
    }
    ...
    public void closeAllOpenAppSessions(SessionEvent.Reason reason, String reasonDetails, long eventTime) {
        ...
        if (openSessions.size() > 0) {
            Logger.m646v(Area.USAGE.value(), String.format(Locale.US, "UsageManager: stopPhoneSession() Closing %1$d open app session(s)", new Object[]{Integer.valueOf(openSessions.size())}));
            for (ApplicationSessionEvent appEvent : openSessions) {
                try {
                    ...
                    Logger.m643e(Area.USAGE.value(), "UsageManager: closeAllOpenAppSessions() collectAppSessionEvent() failed", e);
                    if (StringUtility.isNullOrEmpty(reasonDetails)) {
                        reasonDetails = Logger.getThrowableDump(e);
                    } else {
                        reasonDetails = reasonDetails + " | " + Logger.getThrowableDump(e);
    ...
    private List<AggregateUsageRecord> getCollapsedSortedAggregateSessions() {
        ...
        if (Constants.META_PACKAGE_NAME.equals(requestSort)) {
            ...
            Logger.m642e(Area.USAGE.value(), String.format(Locale.US, "UsageManager: Unrecognized sort column '%1$s'", new Object[]{requestSort}));
            comparatorToUse = ComparatorTotalUseDuration;
        }
