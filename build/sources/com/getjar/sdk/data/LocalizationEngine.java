...
public class LocalizationEngine {
    ...
    private RecommendedPrices getRecommendedPricesInternal(Collection<Pricing> prices, boolean allowStale) throws InterruptedException, ExecutionException {
        ...
        Logger.m640d(Area.LOCALIZATION.value(), "LocalizationEngine getRecommendedPricesInternal() start");
        ...
        for (Pricing price : prices) {
            ...
            if (recommendedPrice != null) {
                ...
                Logger.m640d(Area.LOCALIZATION.value(), "LocalizationEngine getRecommendedPricesInternal() returning null");
                return null;
            }
        }
        ...
        _ExecutorService.execute(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.m643e(Area.LOCALIZATION.value(), "LocalizationEngine retrieveFailed ", e);
                }
            }
        });
    }
