...
public class RedemptionEngine {
    ...
    public static Intent buildRedeemVoucherIntent(String packageName, String voucherToken, Context context) throws JSONException, NoSuchAlgorithmException, UnsupportedEncodingException {
        Logger.m640d(Area.REDEEM.value() | Area.OFFER.value(), "RedemptionEngine: buildRedeemVoucherIntent() START");
        if (context == null) {
            throw new IllegalArgumentException("'context' cannot be NULL");
            ...
            Logger.m640d(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: buildRedeemVoucherIntent() [packageName:%1$s voucherToken:%2$s]", new Object[]{packageName, voucherToken}));
            ...
            Logger.m640d(Area.REDEEM.value() | Area.OFFER.value(), "RedemptionEngine: buildRedeemVoucherIntent() FINISH");
            return redeemIntent;
        }
    }
    ...
    public static JSONArray getProviderFilterJson(Context context) throws JSONException, NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        Logger.m640d(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: buildRedeemVoucherIntent() [hashedAccountName:%1$s userDeviceId:%2$s hashedUserDeviceId:%3$s]", new Object[]{hashedAccountName, userDeviceId, hashedUserDeviceId}));
    ...
    public static void showWalletPage(GetJarContext getJarContext) {
        ...
        Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "RedemptionEngine: showWalletPage() intent sent");
    }
    ...
    public static void showCheckoutPage(final GetJarContext getJarContext, Intent receivedIntent) {
        if (getJarContext == null) {
            ...
            try {
                ...
                Logger.m643e(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() failed", e);
            }
            ...
            _ExecutorService.execute(new Runnable() {
                public void run() {
                    String str;
                    try {
                        Logger.m640d(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() START");
                        ...
                        if (!AuthManager.getInstance().isAuthed() || StringUtility.isNullOrEmpty(currentAccountName) || !currentAccountName.equalsIgnoreCase(targetAccountName)) {
                            Logger.m646v(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() calling ensureAuthResetCurrent()");
                            ...
                            Logger.m646v(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() called ensureAuthResetCurrent()");
                        }
                        ConsumableProduct dummyProduct = new ConsumableProduct("12312", "lightning Sword", "strike enemy with lightning", 2);
                        Intent intent = new Intent(getJarContext.getAndroidContext(), GetJarActivity.class);
                        intent.putParcelableArrayListExtra(Constants.PRODUCT_LIST, new ArrayList(Arrays.asList(new ConsumableProduct[]{dummyProduct})));
                        ...
                        getJarContext.getAndroidContext().startActivity(intent);
                        Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() intent sent");
                    } catch (Exception e) {
                        Logger.m643e(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPage() failed", e);
                    } finally {
                        str = "RedemptionEngine: showCheckoutPage() FINISH";
                        Logger.m640d(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), str);
                    }
                }
            });
        }
        ...
        if (getJarContext == null) {
            ...
            _ExecutorService.execute(new Runnable() {
                public void run() {
                    String str;
                    try {
                        Logger.m640d(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPageFor34() START");
                        ...
                        if (!AuthManager.getInstance().isAuthed() || !AuthManager.getInstance().getUserAccessId().equalsIgnoreCase(sourceUserAccessId)) {
                            Logger.m646v(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPageFor34() calling ensureAuthResetCurrent()");
                            HashMap<String, String> providerData = new HashMap<>(3);
                            ...
                            AuthManager.getInstance().ensureAuthResetCurrent(new ProviderHint(new EnforcedAccountUserAuthProvider().getProviderFilter(), providerData), true);
                            Logger.m646v(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPageFor34() called ensureAuthResetCurrent()");
                        }
                        ConsumableProduct dummyProduct = new ConsumableProduct("12312", "lightning Sword", "strike enemy with lightning", 2);
                        ...
                        Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPageFor34() intent sent");
                    } catch (Exception e) {
                        Logger.m643e(Area.UI.value() | Area.PURCHASE.value() | Area.OFFER.value(), "RedemptionEngine: showCheckoutPageFor34() failed", e);
                    } finally {
            ...
            try {
                ...
                _ExecutorService.execute(new Runnable() {
                    /* JADX WARNING: Code restructure failed: missing block: B:10:?, code lost:
                        com.getjar.sdk.logging.Logger.m643e(com.getjar.sdk.logging.Area.REDEEM.value() | com.getjar.sdk.logging.Area.OFFER.value(), java.lang.String.format(java.util.Locale.US, "RedemptionEngine: redeemVoucherFromIntent() callback.redeemStarted() failed [%1$s]", new java.lang.Object[]{r5}), r11);
                     */
                    ...
                    /* JADX WARNING: Code restructure failed: missing block: B:14:?, code lost:
                        ...
                        com.getjar.sdk.logging.Logger.m643e(com.getjar.sdk.logging.Area.REDEEM.value() | com.getjar.sdk.logging.Area.OFFER.value(), java.lang.String.format(java.util.Locale.US, "RedemptionEngine: redeemVoucherFromIntent() failed [%1$s]", new java.lang.Object[]{r5}), r12);
                     */
                    /* JADX WARNING: Code restructure failed: missing block: B:15:0x00aa, code lost:
                        com.getjar.sdk.logging.Logger.m640d(com.getjar.sdk.logging.Area.REDEEM.value() | com.getjar.sdk.logging.Area.OFFER.value(), java.lang.String.format(java.util.Locale.US, "RedemptionEngine: redeemVoucherFromIntent() FINISH [%1$s]", new java.lang.Object[]{r5}));
                     */
                    ...
                    public void run() {
                        /*
                            ...
                            com.getjar.sdk.logging.Logger.m640d(r3, r1)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            r0 = r17
                        ...
                        L_0x0030:
                            ...
                            com.getjar.sdk.logging.Logger.m646v(r3, r1)     // Catch:{ Exception -> 0x005e, AuthException -> 0x007e }
                        ...
                        L_0x005e:
                            ...
                            r7[r8] = r5     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            java.lang.String r1 = java.lang.String.format(r1, r6, r7)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            com.getjar.sdk.logging.Logger.m643e(r3, r1, r11)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            goto L_0x0030
                        L_0x007e:
                            r12 = move-exception
                            r0 = r17
                            ...
                            com.getjar.sdk.logging.Logger.m643e(r3, r1, r12)     // Catch:{ all -> 0x0227 }
                            ...
                            com.getjar.sdk.logging.Logger.m640d(r3, r1)
                        L_0x00c8:
                            return
                        L_0x00c9:
                            com.getjar.sdk.logging.Area r1 = com.getjar.sdk.logging.Area.REDEEM     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            ...
                            r7[r8] = r5     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            java.lang.String r1 = java.lang.String.format(r1, r6, r7)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            com.getjar.sdk.logging.Logger.m646v(r3, r1)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            r0 = r17
                        ...
                        L_0x0163:
                            ...
                            java.lang.String r1 = java.lang.String.format(r1, r6, r7)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            com.getjar.sdk.logging.Logger.m644i(r3, r1)     // Catch:{ AuthException -> 0x007e, Exception -> 0x0187 }
                            goto L_0x0113
                        L_0x0187:
                            r12 = move-exception
                            r0 = r17
                        ...
                        L_0x0227:
                            ...
                            com.getjar.sdk.logging.Logger.m640d(r3, r6)
                            throw r1
                        L_0x0247:
                        ...
                        L_0x02af:
                            ...
                            goto L_0x00c8
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.getjar.sdk.data.RedemptionEngine.C03683.run():void");
                    }
                });
    ...
    public String getDeveloperProductId(Result result) {
        ...
        if (!(result == null || (signedPayload = result.getSignedPayloadObject()) == null || !signedPayload.has("developer_product_id"))) {
            try {
                ...
                Logger.m643e(Area.REDEEM.value() | Area.OFFER.value(), "Unable to get a string value for 'developer_product_id'", e);
            }
        }
        return null;
    }
    ...
    public void makeSuccessCallbacks(String workId, String productId, String signedPayload, String signature, List<VoucherRedemptionListener> callbacks) {
        for (VoucherRedemptionListener callback : callbacks) {
            try {
                Logger.m646v(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: making callback.redeemSucceeded() [%1$s]", new Object[]{workId}));
                callback.redeemSucceeded(workId, productId, signedPayload, signature);
            } catch (Exception ce) {
                Logger.m643e(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: callback.redeemSucceeded() failed [%1$s]", new Object[]{workId}), ce);
            }
        }
    }
    ...
    public void makeFailureCallbacks(String workId, VoucherRedemptionListener.FailureReason reason, List<VoucherRedemptionListener> callbacks) {
        for (VoucherRedemptionListener callback : callbacks) {
            try {
                Logger.m646v(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: making callback.redeemFailed() [%1$s]", new Object[]{workId}));
                callback.redeemFailed(workId, reason);
            } catch (Exception ce) {
                Logger.m643e(Area.REDEEM.value() | Area.OFFER.value(), String.format(Locale.US, "RedemptionEngine: callback.redeemFailed() failed [%1$s]", new Object[]{workId}), ce);
            }
        }
    }
