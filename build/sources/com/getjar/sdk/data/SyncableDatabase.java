...
public abstract class SyncableDatabase<T extends DatabaseRecordBase> extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        synchronized (this._databaseAccessLock) {
            Logger.m640d(Area.STORAGE.value(), String.format(Locale.US, "Upgrading database from version %1$d to %2$d [deleting old data from table '%3$s']", new Object[]{Integer.valueOf(oldVersion), Integer.valueOf(newVersion), getTableName()}));
    ...
    public void setRecordAsSynced(long id) {
        synchronized (this._databaseAccessLock) {
            if (checkForRecord(id)) {
                ...
                Logger.m648w(Area.STORAGE.value(), String.format(Locale.US, "Usage: %1$s: setRecordAsSynced() failed to find record %2$d", new Object[]{getClass().getName(), Long.valueOf(id)}));
            }
        }
    }
    ...
    public void trimLruEntries() {
        ...
        L_0x0050:
            ...
            r4[r5] = r6     // Catch:{ all -> 0x0011 }
            java.lang.String r2 = java.lang.String.format(r2, r3, r4)     // Catch:{ all -> 0x0011 }
            com.getjar.sdk.logging.Logger.m646v(r0, r2)     // Catch:{ all -> 0x0011 }
        L_0x009a:
            monitor-exit(r12)     // Catch:{ all -> 0x0011 }
            goto L_0x001e
        L_0x009c:
