...
public class GetJarJavaScriptInterface extends JavaScriptAPI {
    ...
    public void purchaseUnmanagedOffer(String theProductId, String theTrackingMetadata) {
        if (!this._isExist) {
            Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value() | Area.UI.value(), "JavaScriptAPI: purchaseUnmanagedOffer() -- theProductId=" + theProductId);
            ...
            if (offer != null) {
                ...
                try {
                    ...
                    if (trackingMetadataMap.size() > 0) {
                        Logger.m646v(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value() | Area.AUTH.value(), String.format(Locale.US, "JavaScriptAPI: Making a purchase with client transaction ID: '%1$s' [thread:%2$d]", new Object[]{offer.getClientTransactionId(), Long.valueOf(Thread.currentThread().getId())}));
                        ...
                        new Thread(new Runnable() {
                            public void run() {
                                ...
                                try {
                                    Logger.m646v(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: Waiting on purchase reserve future");
                                    if (!(reserveFuture == null || reserveFuture.get() == null)) {
                                        ((Operation) reserveFuture.get()).mapResultToCallbacks(callback);
                                        callbackMade = true;
                                    }
                                    Logger.m646v(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: Done waiting on purchase reserve future");
                                    ...
                                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: Purchase call-back thread failed", e);
                                    Logger.m646v(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: Done waiting on purchase reserve future");
                                    GetJarJavaScriptInterface.this._parentActivity.waitDialogHide();
                                    if (0 == 0) {
                                        callback.serviceRequestFailed((Result) null, (Exception) null, "unknown", GetJarJavaScriptInterface.this._commContext);
                    ...
                    Logger.m642e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: ERROR: unable to send purchaseOffer transaction, empty tracking data.");
                    this._parentActivity.waitDialogHide();
                } catch (Exception exc) {
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchaseUnmanagedOffer() failed", exc);
                    this._parentActivity.waitDialogHide();
                }
            } else {
                Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchaseUnmanagedOffer() -- offer with theProductId=" + theProductId + " was not found..");
            }
        }
    }
    ...
    public void requestEarnInstall(String thePackageName, String theFriendlyName, String theDownloadUrl, String theAppMetadata, String theTrackingMetadata) {
        if (!this._isExist) {
            try {
                ...
                try {
                    Logger.m643e(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: requestEarnInstall() failed [thread:%1$d]", new Object[]{Long.valueOf(Thread.currentThread().getId())}), e);
                    this._parentActivity.unableToDownloadDialogShow();
                } catch (Exception exc) {
                    Logger.m643e(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", exc);
                }
            }
        }
    }
    ...
    public void requestPurchaseInstall(String thePackageName, String theFriendlyName, String theDownloadUrl, String theAppMetadata, String theTrackingMetadata) {
        if (!this._isExist) {
            try {
                ...
                try {
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: requestPurchaseInstall() failed [thread:%1$d]", new Object[]{Long.valueOf(Thread.currentThread().getId())}), e);
                    this._parentActivity.unableToDownloadDialogShow();
                } catch (Exception exc) {
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", exc);
                }
            }
        }
    }
    ...
    public void closeView() {
        Logger.m640d(Area.JS_API.value() | Area.UI.value(), "JavaScriptAPI: closeView is called");
        this._isExist = true;
    ...
    public void reloadViewNoSafety(boolean reauth) {
        Logger.m640d(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: reloadViewNoSafety(%1$s)", new Object[]{Boolean.toString(reauth)}));
        reloadViewInternal(reauth, false);
    }

    @JavascriptInterface
    public void reloadView(boolean reauth) {
        Logger.m640d(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: reloadView(%1$s)", new Object[]{Boolean.toString(reauth)}));
    ...
    public String getUnmanagedOffers() {
        ...
        for (Map.Entry<String, GetJarWebViewSubActivity.ProductWithClientTransactionID> offerRecord : this._productIdToProduct.entrySet()) {
            try {
                ...
                Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: productId=" + offerRecord.getValue().getProduct().getProductId(), je);
            }
        }
    ...
    public String getProductThumbnailString(String productId, String boundWidth, String boundHeight) {
        ...
        try {
            Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value(), "JavaScriptAPI: getProductThumbnailString() loading resource ID");
            ...
            if (resourceId == null || resourceId.intValue() <= 0) {
                Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value(), String.format(Locale.US, "JavaScriptAPI: getProductThumbnailString() no resource ID found for product '%1$s', returning null", new Object[]{productId}));
                return null;
            }
            Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value(), "JavaScriptAPI: getProductThumbnailString() loading resource");
            ...
            Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value(), "JavaScriptAPI: getProductThumbnailString() resource found");
            return image;
        } catch (Exception e) {
            Logger.m640d(Area.JS_API.value() | Area.PURCHASE.value(), "JavaScriptAPI: getProductThumbnailString() failed to load resource, returning null");
            return null;
        }
    }
                    ...
                    GetJarJavaScriptInterface.this._parentActivity.getParentActivity().runOnUiThread(new Runnable() {
                        public void run() {
                            try {
                                ...
                                Logger.m643e(Area.JS_API.value() | Area.TRANSACTION.value() | Area.BUY_GOLD.value(), "JavaScriptAPI: requestGoldOffers() failed", e);
                            }
                        }
                    });
                } catch (Exception e) {
    ...
    public void buyGold(String platformItemId, String trackingMetadata) {
        ...
        try {
            ...
            Logger.m648w(Area.JS_API.value() | Area.TRANSACTION.value() | Area.BUY_GOLD.value(), "JavaScriptAPI: ERROR: Invalid tracking data.");
    ...
    public String getUnmanagedOffer(String theProductId) {
        ...
        if (offer != null) {
            try {
                ...
                Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: productId=" + theProductId, je);
            }
        }
        return jo.toString();
    }
    ...
    public String getDisplayMetrics() {
        ...
        Logger.m644i(Area.JS_API.value() | Area.UI.value(), "JavaScriptAPI: getDisplayMetrics() -- _parentActivity cannot be null.");
            ...
            this._parentActivity.getParentActivity().runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        Logger.m643e(Area.JS_API.value() | Area.UI.value(), "JavaScriptAPI: configureWebView() failed", e);
                    }
                }
            });
        }
    ...
    public String getCapabilities() {
        ...
        try {
            ...
            Logger.m643e(Area.JS_API.value() | Area.AUTH.value(), "ClaimsManager.getCapabilities() failed", e);
        }
        ...
        for (Map.Entry<String, String> entry : caps.entrySet()) {
            try {
                ...
                Logger.m643e(Area.JS_API.value() | Area.AUTH.value(), "JavaScriptAPI: getCapabilities() failed", e2);
            }
        }
    ...
    public String getAuthToken() {
        ...
        try {
            ...
            Logger.m640d(Area.JS_API.value() | Area.AUTH.value(), String.format(Locale.US, "JavaScriptAPI: getAuthToken() returning: '%1$s'", new Object[]{result}));
            return result;
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.AUTH.value(), "JavaScriptAPI: getAuthToken() failed", e);
            return result;
        }
    }
    ...
    public String getDisplayLanguageTag() {
        ...
        try {
            ...
            Logger.m640d(Area.JS_API.value() | Area.UI.value() | Area.LOCALIZATION.value(), String.format(Locale.US, "JavaScriptAPI: getDisplayLanguageTag() returning: '%1$s'", new Object[]{result}));
            return result;
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.UI.value() | Area.LOCALIZATION.value(), "JavaScriptAPI: getDisplayLanguageTag() failed", e);
            return result;
        }
    }
    ...
    public String getDeviceDetails() {
        ...
        try {
            ...
            Logger.m640d(Area.JS_API.value() | Area.CONFIG.value(), String.format(Locale.US, "JavaScriptAPI: getDeviceDetails() returning:\r\n%1$s", new Object[]{deviceDetailsJson.toString(4)}));
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.CONFIG.value(), "JavaScriptAPI: getDeviceDetails() failed", e);
        }
    ...
    public String getRecentlyUsedApps() {
        ...
        try {
            if (UsageManager.getInstance(this._commContext.getApplicationContext()).isRequestSendEnabled()) {
                ...
                Logger.m640d(Area.JS_API.value() | Area.USAGE.value(), String.format(Locale.US, "JavaScriptAPI: getRecentlyUsedApps() %d recent apps", new Object[]{Integer.valueOf(recentPackageNames.size())}));
                for (String packageName : recentPackageNames) {
                    appArray.put(packageName);
                }
            }
            Logger.m640d(Area.JS_API.value() | Area.USAGE.value(), String.format(Locale.US, "JavaScriptAPI: getRecentlyUsedApps() returning:\r\n%1$s", new Object[]{appArray.toString(4)}));
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.USAGE.value(), "JavaScriptAPI: getRecentlyUsedApps() failed", e);
        }
    ...
    public String getUsageSessionRecords() {
        String str;
        Logger.m646v(Area.JS_API.value() | Area.USAGE.value(), "JavaScriptAPI: getUsageSessionRecords() START");
        ...
        try {
            ...
            if (report != null) {
                ...
                if (report.getRecords().size() > 0) {
                    Logger.m646v(Area.JS_API.value() | Area.USAGE.value(), String.format(Locale.US, "JavaScriptAPI: getUsageSessionRecords() reporting on %1$d aggregated usage session records", new Object[]{Integer.valueOf(report.getRecords().size())}));
            ...
            Logger.m643e(Area.JS_API.value() | Area.USAGE.value(), "JavaScriptAPI: getUsageSessionRecords() failed", e);
        } finally {
            str = "JavaScriptAPI: getUsageSessionRecords() FINISH";
            Logger.m646v(Area.JS_API.value() | Area.USAGE.value(), str);
        }
    ...
    public void log(String message, String level) {
        if (StringUtility.isNullOrEmpty(message)) {
            Logger.m640d(Area.JS_API.value() | Area.UI.value(), "No message provided to log by javascript");
            return;
        }
        ...
        if (level.equalsIgnoreCase("VERBOSE")) {
            Logger.m646v(Area.JS_API.value() | Area.UI.value(), message2);
        } else if (level.equalsIgnoreCase("DEBUG")) {
            Logger.m640d(Area.JS_API.value() | Area.UI.value(), message2);
        } else if (level.equalsIgnoreCase("INFO")) {
            Logger.m644i(Area.JS_API.value() | Area.UI.value(), message2);
        } else if (level.equalsIgnoreCase("WARN")) {
            Logger.m648w(Area.JS_API.value() | Area.UI.value(), message2);
        } else if (level.equalsIgnoreCase("ERROR")) {
            Logger.m642e(Area.JS_API.value() | Area.UI.value(), message2);
        } else {
            Logger.m640d(Area.JS_API.value() | Area.UI.value(), message2);
        }
    }
    ...
    public boolean canBuy() {
        try {
            ...
            Logger.m643e(Area.JS_API.value() | Area.TRANSACTION.value() | Area.CONFIG.value() | Area.BUY_GOLD.value(), "ClaimsManager.canBuy() failed", e);
            return false;
        }
    }
    ...
    public boolean canEarn() {
        try {
            ...
            Logger.m643e(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value() | Area.CONFIG.value(), "ClaimsManager.canEarn() failed", e);
            return false;
        }
    }
    ...
    public boolean canPurchaseUnmanagedProducts() {
        try {
            ...
            Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.CONFIG.value() | Area.TRANSACTION.value(), "ClaimsManager.canPurchaseUnmanagedProducts() failed", e);
            return false;
        }
    }
    ...
    private void _requestInstall(String thePackageName, String theFriendlyName, String theDownloadUrl, String theAppMetadata, String theTrackingMetadata, Constants.RequestInstallType theRequestType) {
        if (StringUtility.isNullOrEmpty(thePackageName)) {
            ...
            try {
                Logger.m640d(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: _requestInstall(packageName:%1$s, friendlyName:%2$s, downloadUrl:%3$s, requestType:%4$s)", new Object[]{thePackageName, theFriendlyName, theDownloadUrl, theRequestType.name()}));
                Logger.m646v(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: _requestInstall() applicationMetadata: %1$s", new Object[]{theAppMetadata}));
                Logger.m646v(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: _requestInstall() trackingMetadata: %1$s", new Object[]{theTrackingMetadata}));
                ...
                if (Constants.RequestInstallType.EARN.equals(theRequestType)) {
                    ...
                    Logger.m646v(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value() | Area.STORAGE.value(), "JavaScriptAPI: _requestInstall() starting usage monitoring thread");
                    EarningMonitor.getInstance(this._commContext.getApplicationContext()).startMonitoring();
                }
                Logger.m640d(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: Pushing download URL to the Android OS [downloadURl: %1$s]", new Object[]{theDownloadUrl}));
                ...
                Logger.m643e(Area.JS_API.value() | Area.EARN.value() | Area.TRANSACTION.value(), "JavaScriptAPI: _requestInstall() failed", e);
            }
        }
    }
    ...
    private class ReauthThread implements Runnable {
        ...
        public void run() {
            try {
                ...
                Logger.m643e(Area.JS_API.value() | Area.AUTH.value(), "JavaScriptAPI: ReauthThread.run() failed", e);
            } finally {
                GetJarJavaScriptInterface.this._parentActivity.waitDialogHide();
            }
        }
    ...
    private void reloadViewInternal(boolean reauth, boolean doSafety) {
        this._parentActivity.waitDialogShow();
        Logger.m640d(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: reloadView called from thread.id:%1$d thread.name:%2$s", new Object[]{Long.valueOf(Thread.currentThread().getId()), Thread.currentThread().getName()}));
        if (!this._isExist) {
            Logger.m640d(Area.JS_API.value() | Area.UI.value(), "JavaScriptAPI: reloadView past isExist");
            if (reauth) {
                ...
                if (!doSafety || lastAttemptDelta >= TapjoyConstants.THROTTLE_GET_TAP_POINTS_INTERVAL) {
                    Logger.m640d(Area.JS_API.value() | Area.AUTH.value(), "JavaScriptAPI: reloadView is re-authorizing");
                    try {
                        new Thread(new ReauthThread()).start();
                    } catch (Exception e) {
                        Logger.m643e(Area.JS_API.value() | Area.AUTH.value(), "JavaScriptAPI: reloadViewInternal() failed", e);
                    }
                } else {
                    Logger.m648w(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: A re-authorization/reload attempt was made %1$d milliseconds ago, skipping this attempt request", new Object[]{Long.valueOf(lastAttemptDelta)}));
    ...
    private class PurchaseCallback implements CallbackInterface {
        ...
        public void serviceRequestSucceeded(Result result, String requestId, CommContext commContext) {
            try {
                ...
                if (!substate.equals(Constants.RequestInstallSubState.FUNDS_INSUFFICIENT_FAILURE.name())) {
                    ...
                    Logger.m640d(value, String.format(locale, "JavaScriptAPI: PurchaseCallback: Request %1$s on CommContext %2$s resulted in a call to serviceRequestSucceeded()", objArr));
                ...
                try {
                    ...
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", e);
                    commContext.addException(e);
                }
            } catch (Exception e2) {
                Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", e2);
                commContext.addException(e2);
                try {
                    GetJarJavaScriptInterface.this._parentActivity.waitDialogHide();
                } catch (Exception e3) {
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", e3);
                ...
                try {
                    ...
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: failure", e4);
        ...
        public void serviceRequestFailed(Result result, Exception cause, String requestId, CommContext commContext) {
            ...
            try {
                ...
                objArr[2] = message;
                Logger.m640d(value, String.format(locale, "JavaScriptAPI: PurchaseCallback: Request %1$s on CommContext %2$s resulted in a call to serviceRequestFailed(). %3$s", objArr));
                if (cause != null) {
                    Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchase failed", cause);
                }
