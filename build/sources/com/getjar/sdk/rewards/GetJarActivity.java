...
public class GetJarActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        String str;
        Logger.m644i(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onCreate() START");
        ...
        try {
            ...
            if (getIntent().getBooleanExtra(Constants.EXTRA_WEBVIEW, false)) {
                ...
                Logger.m644i(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: Using GetJarWebViewSubActivity");
                ...
                Logger.m644i(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: Using GetJarUserAuthSubActivity");
            } else {
                Logger.m642e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: unknown UI requested");
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onCreate() failed", e);
            finish();
        } finally {
            str = "GetJarActivity: onCreate() DONE";
            Logger.m644i(Area.OS_ENTRY_POINT.value() | Area.UI.value(), str);
        }
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onNewIntent() failed", e);
        }
    }
    ...
    public void onResume() {
        ...
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onResume() failed", e);
        }
    }
    ...
    public void onPause() {
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onPause() failed", e);
        } finally {
            super.onPause();
        }
    }
    ...
    public void onDestroy() {
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onDestroy() failed", e);
        } finally {
            super.onDestroy();
        }
    }
    ...
    public void onBackPressed() {
        try {
            ...
            Logger.m643e(Area.UI.value(), "GetJarActivity: onBackPressed() failed", e);
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onSaveInstanceState() failed", e);
        }
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        try {
            ...
            Logger.m643e(Area.OS_ENTRY_POINT.value() | Area.UI.value(), "GetJarActivity: onConfigurationChanged() failed", e);
        }
    }
}
