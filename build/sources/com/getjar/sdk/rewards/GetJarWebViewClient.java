...
public class GetJarWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        try {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "GetJarWebViewClient: shouldOverrideUrlLoading() OverrideURl: %1$s", new Object[]{url}));
            ...
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: shouldOverrideUrlLoading() failed", e);
        }
        return true;
    }
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        try {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onPageStarted()");
            this._parentActivity.waitDialogHide();
        } catch (Exception e) {
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onPageStarted() failed", e);
        }
    }

    public void onPageFinished(WebView view, String url) {
        try {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "GetJarWebViewClient: onPageFinished() URL:%1$s", new Object[]{url}));
            if (this._parentActivity.getShouldShowLoadingUI()) {
                Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onPageFinished() Setting ShouldShowLoadingUI to FALSE");
            ...
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onPageFinished() failed", e);
        }
    }

    public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
        try {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "GetJarWebViewClient: onReceivedError() Error while loading URL '%1$s' [errorCode:%2$d description:%3$s]", new Object[]{failingUrl, Integer.valueOf(errorCode), description}));
            super.onReceivedError(view, errorCode, description, failingUrl);
            this._parentActivity.setShouldShowLoadingUI(false);
            this._parentActivity.waitDialogHide();
            GetJarWebViewSubActivity.loadUrlInWebView(view, Constants.DEFAULT_ERROR_PAGE);
        } catch (Exception e) {
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onReceivedError() failed", e);
        }
    }

    public void onLoadResource(WebView view, String url) {
        try {
            Logger.m646v(Area.UI.value() | Area.OS_ENTRY_POINT.value(), String.format(Locale.US, "GetJarWebViewClient: onLoadResource() Loading Resource '%1$s'", new Object[]{url}));
        } catch (Exception e) {
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onLoadResource() failed", e);
        }
    }

    public void onFormResubmission(WebView view, Message dontResend, Message resend) {
        try {
            Logger.m640d(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onFormResubmission()");
            resend.sendToTarget();
        } catch (Exception e) {
            Logger.m643e(Area.UI.value() | Area.OS_ENTRY_POINT.value(), "GetJarWebViewClient: onFormResubmission() failed", e);
        }
    }
    ...
    public static void saveUrl(String url, CommContext commContext, Context androidContext) {
        try {
            ...
            Logger.m643e(Area.STORAGE.value(), String.format(Locale.US, "saveUrl(%1$s) failed", new Object[]{url}), e);
        }
    }
    ...
    private static boolean shouldFilterUrl(String url) {
        try {
            ...
            Logger.m640d(Area.CONFIG.value(), String.format(Locale.US, "shouldFilterUrl(%1$s)", new Object[]{String.format(Locale.US, "%1$s://%2$s%3$s", new Object[]{urlclass.getProtocol(), urlclass.getAuthority(), urlclass.getPath()})}));
            ...
            Logger.m643e(Area.CONFIG.value(), String.format(Locale.US, "shouldFilterUrl(%1$s) failed", new Object[]{url}), e);
            return false;
        }
    }
}
