...
public class JavaScriptAPI {
    ...
    protected static void makeJavaScriptCallback(String callbackTarget, String resultJson) {
        Logger.m640d(Area.JS_API.value(), String.format(Locale.US, "Attempting to callback: %1$s", new Object[]{resultJson}));
        try {
    ...
    public String getAccounts() {
        String str;
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: getAccounts() START");
        ...
        try {
            ...
            Logger.m643e(Area.JS_API.value(), "getAccounts() failed", e);
        } finally {
            str = "JavaScriptAPI: getAccounts() FINISH";
            Logger.m646v(Area.JS_API.value(), str);
        }
    ...
    public void setAccount(final String accountName, final String providerFilter) {
        if (StringUtility.isNullOrEmpty(accountName)) {
            Logger.m642e(Area.JS_API.value(), "'accountName' cannot be null or empty");
        } else if (StringUtility.isNullOrEmpty(providerFilter)) {
            Logger.m642e(Area.JS_API.value(), "'providerFilter' cannot be null or empty");
        } else if (!providerFilter.equals(new AndroidAccountUserAuthProvider().getProviderFilter())) {
            Logger.m642e(Area.JS_API.value(), String.format(Locale.US, "Unsupported 'providerFilter' value [%1$s]", new Object[]{providerFilter}));
        } else {
            Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: setAccount() START");
                ...
                _ExecutorService.execute(new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            Logger.m643e(Area.JS_API.value(), "JavaScriptAPI: setAccount() failed", e);
                        } finally {
    ...
    public java.lang.String getAppDetails(java.lang.String r15) {
        /*
            ...
            com.getjar.sdk.logging.Logger.m646v(r7, r9)
        ...
        L_0x0070:
            ...
            com.getjar.sdk.logging.Logger.m643e(r7, r9, r1)     // Catch:{ all -> 0x00a5 }
            com.getjar.sdk.logging.Area r7 = com.getjar.sdk.logging.Area.JS_API
            long r7 = r7.value()
            java.lang.String r9 = "JavaScriptAPI: getAppDetails() FINISH"
            com.getjar.sdk.logging.Logger.m646v(r7, r9)
        ...
        L_0x0088:
            ...
            com.getjar.sdk.logging.Logger.m648w(r7, r9)     // Catch:{ Exception -> 0x0070 }
            goto L_0x0051
        L_0x00a5:
            r7 = move-exception
            ...
            com.getjar.sdk.logging.Logger.m646v(r8, r10)
            throw r7
        L_0x00b2:
            r1 = move-exception
            com.getjar.sdk.logging.Area r7 = com.getjar.sdk.logging.Area.JS_API     // Catch:{ Exception -> 0x0070 }
    ...
    public String redeemVoucher(String packageName, String voucherToken) {
        ...
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: redeemVoucher() START");
        try {
            ...
            Logger.m643e(Area.JS_API.value() | Area.REDEEM.value() | Area.OFFER.value(), "redeemVoucher() failed", e);
        } catch (Throwable th) {
            Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: redeemVoucher() FINISH");
            throw th;
        }
    ...
    public void setCurrentManagedOfferDetails(String managedOfferDetails) {
        Logger.m646v(Area.OFFER.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI setCurrentManagedOfferDetails [%1$s]", new Object[]{managedOfferDetails}));
    ...
    public void purchaseManagedOffer(String offerId, String purchaseMetadata, String trackingMetadata, String callback) {
        if (StringUtility.isNullOrEmpty(offerId)) {
            Logger.m642e(Area.TRANSACTION.value() | Area.OFFER.value() | Area.JS_API.value(), "'offerId' cannot be null or empty");
        } else if (StringUtility.isNullOrEmpty(purchaseMetadata)) {
            Logger.m642e(Area.TRANSACTION.value() | Area.OFFER.value() | Area.JS_API.value(), "'purchaseMetadata' cannot be null or empty");
        } else if (StringUtility.isNullOrEmpty(trackingMetadata)) {
            Logger.m642e(Area.TRANSACTION.value() | Area.OFFER.value() | Area.JS_API.value(), "'trackingMetadata' cannot be null or empty");
        } else if (StringUtility.isNullOrEmpty(callback)) {
            Logger.m642e(Area.TRANSACTION.value() | Area.OFFER.value() | Area.JS_API.value(), "'callback' cannot be null or empty");
        } else {
            ...
            _ExecutorService.execute(new Runnable() {
                public void run() {
                    ...
                    Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: purchaseManagedOffer() START");
                    try {
                        Logger.m646v(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: purchaseManagedOffer() purchaseMetadata:'%1$s'", new Object[]{str}));
                        Logger.m646v(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), String.format(Locale.US, "JavaScriptAPI: purchaseManagedOffer() trackingMetadata:'%1$s'", new Object[]{str2}));
                        ...
                        if (InAppPurchaseManager.ManagedOfferStatus.SUCCESS.equals(status)) {
                            ...
                            if (InAppPurchaseManager.getInstance(JavaScriptAPI.this._parentActivity.getParentActivity()).isGooglePlayConnected()) {
                                ...
                                if (transaction == null || !transaction.getState().equals(DBTransactions.ManagedOfferState.RESERVED)) {
                                    ...
                                    Logger.m648w(Area.OFFER.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchaseManagedOffer() 'marketplace_product_id' not found in purchaseMetadata");
                                ...
                                Logger.m642e(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchaseManagedOffer() Couldn't connect to google play");
                            ...
                            Logger.m642e(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), "JavaScriptAPI: purchaseManagedOffer() Reserve failed");
                        ...
                        Logger.m643e(Area.OFFER.value(), "JavaScriptAPI: purchaseManagedOffer() Unknown failure", e2);
    ...
    public String getManagedOffer() {
        String str;
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: getManagedOffer() START");
        try {
    ...
    public void performManagedCheckout(String managedOfferDetails) {
        String str;
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: performManagedCheckout() START");
        try {
            this._currentManagedOfferDetails = managedOfferDetails;
    ...
    public void getLocalizedPriceBuckets(final String priceBuckets, final String callback) {
        if (StringUtility.isNullOrEmpty(priceBuckets)) {
            Logger.m642e(Area.JS_API.value() | Area.LOCALIZATION.value(), "JavaScriptAPI: getLocalizedPriceBuckets() received null or empty 'priceBuckets'");
        }
        if (StringUtility.isNullOrEmpty(callback)) {
            Logger.m642e(Area.JS_API.value() | Area.LOCALIZATION.value(), "JavaScriptAPI: getLocalizedPriceBuckets() received null or empty 'callback'");
        }
        _callbackToStartTimeMap.put(callback, Long.valueOf(System.currentTimeMillis()));
        _ExecutorService.execute(new Runnable() {
            public void run() {
                String str;
                Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: getLocalizedPriceBuckets() START");
                try {
                    ...
                    if (!InAppPurchaseManager.getInstance(JavaScriptAPI.this._parentActivity.getParentActivity()).isGooglePlayConnected()) {
                        Logger.m642e(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), "JavaScriptAPI: getLocalizedPriceBuckets() Unable to connect to Google play");
                        ...
                        Logger.m640d(Area.OFFER.value(), String.format(Locale.US, "JavaScriptAPI: getLocalizedPriceBuckets() Price buckets: %1$s", new Object[]{localizedPrices}));
                    ...
                    Logger.m643e(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), "JavaScriptAPI: getLocalizedPriceBuckets() Invalid JSON", e);
                    ...
                    Logger.m643e(Area.OFFER.value() | Area.JS_API.value() | Area.TRANSACTION.value(), "JavaScriptAPI: getLocalizedPriceBuckets() Unknown failure", e2);
    ...
    public boolean canViewManagedProducts() {
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: canViewManagedProducts() START");
        try {
            ...
            Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: canViewManagedProducts() FINISH");
            return canViewManagedProducts;
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.PURCHASE.value() | Area.CONFIG.value() | Area.TRANSACTION.value(), "canViewManagedProducts() failed", e);
            Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: canViewManagedProducts() FINISH");
            return false;
        } catch (Throwable th) {
            Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: canViewManagedProducts() FINISH");
    ...
    public boolean canPurchaseManagedProducts() {
        String str;
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: canPurchaseManagedProducts() START");
        try {
            return AuthManager.getInstance().getClaimsManager(this._commContext.getApplicationContext()).canPurchaseManagedProducts();
        } catch (Exception e) {
            Logger.m643e(Area.JS_API.value() | Area.TRANSACTION.value() | Area.CONFIG.value() | Area.OFFER.value(), "ClaimsManager.canBuy() failed", e);
            return false;
        } finally {
    ...
    public void launchGooglePlay(String packageName, String reason) {
        String str;
        Logger.m646v(Area.JS_API.value(), "JavaScriptAPI: launchGooglePlay() START");
        try {
            if (StringUtility.isNullOrEmpty(packageName)) {
                Logger.m642e(Area.JS_API.value() | Area.UI.value(), "launchGooglePlay(): Null or empty packageName provided by javascript");
                return;
            }
            ...
            Logger.m642e(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "launchGooglePlay(): Unsupported reason value '%1$s', must be one of: %2$s", new Object[]{reason, GooglePlayLaunchReason.getSupportedReasons()}));
        } finally {
    ...
    public static void addDataAndMakeJSCallback(String callback, JSONObject resultJson, boolean success, boolean moneyTaken, boolean recoverable, JavaScriptCallbackFailureReason reason, Throwable throwable) {
        Long time;
        if (StringUtility.isNullOrEmpty(callback)) {
            Logger.m642e(Area.JS_API.value(), "'callback' is null. Unable to make callback");
        } else if (reason == null) {
            Logger.m642e(Area.JS_API.value(), "'reason' is null. Unable to make callback");
        } else {
            ...
            try {
                ...
                Logger.m641d(Area.JS_API.value(), "JSON error", e);
            }
    ...
    public void launch(String thePackageName, String additionalData) {
        try {
            Logger.m640d(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: package name:'%1$s' additiona data:'%2$s'", new Object[]{thePackageName, additionalData}));
            ...
            Logger.m643e(Area.JS_API.value() | Area.UI.value(), String.format(Locale.US, "JavaScriptAPI: launch(%1$s) failed", new Object[]{thePackageName}), e);
        }
    }
}
