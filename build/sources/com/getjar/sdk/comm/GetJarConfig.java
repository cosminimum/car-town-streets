...
public class GetJarConfig {
    ...
    public static synchronized GetJarConfig getInstance(CommContext theCommContext, boolean connectToServer) {
        ...
        synchronized (GetJarConfig.class) {
            ...
            if (sInstances.containsKey(DEFAULT_LOOKUP_KEY)) {
                Logger.m640d(Area.CONFIG.value(), "GetJarConfig()::getInstance() -- re-using existing GetJarConfig instance");
                getJarConfig = sInstances.get(DEFAULT_LOOKUP_KEY);
            } else {
                Logger.m640d(Area.CONFIG.value(), "GetJarConfig()::getInstance() -- creating a new GetJarConfig instance");
    ...
    private synchronized void initialize(com.getjar.sdk.comm.CommContext r12, boolean r13) {
        ...
        L_0x0027:
            ...
            com.getjar.sdk.logging.Logger.m640d(r7, r9)     // Catch:{ all -> 0x0014 }
            com.getjar.sdk.comm.CommContext r7 = r11.mCommContext     // Catch:{ all -> 0x0014 }
            android.content.Context r7 = r7.getApplicationContext()     // Catch:{ all -> 0x0014 }
            ...
            com.getjar.sdk.logging.Logger.m640d(r7, r9)     // Catch:{ JSONException -> 0x0136 }
        L_0x007b:
            r0 = r1
        L_0x007c:
            ...
            com.getjar.sdk.logging.Logger.m640d(r7, r9)     // Catch:{ IOException -> 0x00db }
        L_0x00b4:
            if (r5 != 0) goto L_0x00ef
            java.lang.String r4 = "** FATAL ERROR: invalid configuration, unable to proceed.."
            com.getjar.sdk.logging.Area r7 = com.getjar.sdk.logging.Area.CONFIG     // Catch:{ all -> 0x0014 }
            long r7 = r7.value()     // Catch:{ all -> 0x0014 }
            com.getjar.sdk.logging.Logger.m642e(r7, r4)     // Catch:{ all -> 0x0014 }
        ...
        L_0x00c8:
            ...
            com.getjar.sdk.logging.Logger.m643e(r7, r9, r3)     // Catch:{ all -> 0x0014 }
            goto L_0x007c
        L_0x00db:
            r3 = move-exception
            com.getjar.sdk.logging.Area r7 = com.getjar.sdk.logging.Area.CONFIG     // Catch:{ all -> 0x0014 }
    ...
    private synchronized void initialize(Context androidContext2) {
        ...
        try {
            ...
            if (_validateJsonDirectives(configJson)) {
                ...
                isConfigReady = true;
                Logger.m640d(Area.CONFIG.value(), "_initialize() -- OK: config is ready (using DEFAULTS)..");
            }
        } catch (IOException e) {
            Logger.m643e(Area.CONFIG.value(), "_initialize() failed", e);
        }
        if (!isConfigReady) {
            Logger.m642e(Area.CONFIG.value(), "** FATAL ERROR: invalid configuration, unable to proceed..");
    ...
    private org.json.JSONObject _getDefaultDirectives() throws java.io.IOException {
        ...
        L_0x001d:
            ...
            com.getjar.sdk.logging.Logger.m640d(r5, r7)     // Catch:{ all -> 0x006a }
            r5 = 0
    ...
    private boolean _validateJsonDirectives(JSONObject theJson) {
        ...
        try {
            ...
            Logger.m643e(Area.CONFIG.value(), "_validateJsonDirectives failed", e);
            return false;
        }
    }
    ...
    private synchronized void _persistIntoSharedPrefs(JSONObject theJson) {
        ...
        Logger.m640d(Area.CONFIG.value() | Area.STORAGE.value(), "_persistIntoSharedPrefs() -- OK: stored key=config, val=" + theJson.toString());
    }

    public String getDirectiveValue(String theDirectiveKey) {
        String directiveVal;
        Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() START [key='%1$s']", new Object[]{theDirectiveKey}));
        try {
            ...
            if (!StringUtility.isNullOrEmpty(overrideValue)) {
                Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() Using OVERRIDE defined value: '%1$s' = '%2$s'", new Object[]{theDirectiveKey, overrideValue}));
                directiveVal = overrideValue.trim();
                Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() FINISHED [key='%1$s']", new Object[]{theDirectiveKey}));
            } else {
                ...
                if (!StringUtility.isNullOrEmpty(directiveVal)) {
                    Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() Using SERVER defined value: '%1$s' = '%2$s'", new Object[]{theDirectiveKey, directiveVal}));
                    directiveVal = directiveVal.trim();
                    Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() FINISHED [key='%1$s']", new Object[]{theDirectiveKey}));
                } else {
                    directiveVal = this.mDirectives.getString(theDirectiveKey);
                    if (!StringUtility.isNullOrEmpty(directiveVal)) {
                        Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() Using CONFIG value: '%1$s' = '%2$s'", new Object[]{theDirectiveKey, directiveVal}));
                        directiveVal = directiveVal.trim();
                        Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() FINISHED [key='%1$s']", new Object[]{theDirectiveKey}));
                    }
                    if (StringUtility.isNullOrEmpty(directiveVal)) {
            ...
            Logger.m643e(Area.CONFIG.value(), "getDirectiveValue failed", e);
        } catch (Throwable th) {
            Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() FINISHED [key='%1$s']", new Object[]{theDirectiveKey}));
            throw th;
        }
    ...
    public String getDirectiveValue(String theDirectiveKey, String defaultValue) {
        ...
        try {
            ...
            Logger.m646v(Area.CONFIG.value(), String.format(Locale.US, "GetJarConfig getDirectiveValue() Using DEFAULT value: '%1$s' = '%2$s'", new Object[]{theDirectiveKey, defaultValue}));
            return value;
        }
    }
