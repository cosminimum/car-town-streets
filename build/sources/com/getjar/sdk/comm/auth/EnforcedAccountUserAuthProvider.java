...
public class EnforcedAccountUserAuthProvider implements UserAuthProvider {
    ...
    public UserAuthResult ensureUser(String currentAuthToken, CommContext commContext, String authFlowId, AuthUIParentInterface uiParent, ProviderHint providerHint) {
        if (StringUtility.isNullOrEmpty(currentAuthToken)) {
            ...
            Logger.m640d(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() START");
            try {
                if (!StringUtility.isNullOrEmpty(sourceAccountNameHash)) {
                    ...
                    Logger.m640d(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() DONE");
                ...
                if (result == null) {
                    Logger.m642e(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() failed to get results");
                    ...
                    Logger.m648w(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() got failure results");
                    ...
                    if (result.checkForBlacklistedOrUnsupported(commContext)) {
                        Logger.m640d(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() We are blacklisted or unsupported");
                ...
                Logger.m643e(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() failed", e);
                Logger.m640d(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: ensureUser() DONE");
    ...
    private UserAuthResult makeWrappedProviderCall(CommContext commContext, String accountNameHash, String currentAuthToken, String authFlowId, AuthUIParentInterface uiParent, String previousAccountName) {
        Logger.m646v(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: EnforcedAccountUserAuthProvider: makeWrappedProviderCall() for '%1$s'", new Object[]{accountNameHash}));
    ...
    private Map<String, MetadataValue> getProviderData(CommContext commContext, AuthUIParentInterface uiParent, ProviderHint providerHint) {
        if (commContext == null) {
            ...
            if (deviceMetadata == null || deviceMetadata.size() <= 0) {
                Logger.m648w(Area.AUTH.value(), "AuthFlow: EnforcedAccountUserAuthProvider: getProviderData() failed to get device metadata");
                return null;
            }
