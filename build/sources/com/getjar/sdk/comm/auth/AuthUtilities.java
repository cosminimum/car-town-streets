...
class AuthUtilities {
    ...
    protected static long getTTLFromClaims(Map<String, String> claims, long defaultValue) {
        ...
        if (claims.containsKey(expiresInKey)) {
            try {
                ...
                Logger.m642e(Area.AUTH.value(), e.getMessage());
            }
            try {
                Logger.m644i(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: getTTLFromClaims() found expiresInSecs of %1$d", new Object[]{expiresInMinutes}));
            } catch (Exception e2) {
                Logger.m643e(Area.AUTH.value(), "AuthFlow: getTTLFromClaims() failed", e2);
            }
        }
        if (expiresInMinutes == null && claims.containsKey(expiresOnKey)) {
            try {
                ...
                Logger.m642e(Area.AUTH.value(), e3.getMessage());
            }
            Logger.m644i(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: getTTLFromClaims() found expiresOnEpoch of %1$d", new Object[]{expiresOnEpoch}));
        }
        if (expiresInMinutes != null) {
            ttl = expiresInMinutes.longValue() * TapjoyConstants.THROTTLE_GET_TAP_POINTS_INTERVAL;
            if (ttl <= 0) {
                Logger.m648w(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: getTTLFromClaims() parsed an ExpiresIn resulting in a TTL of %1$d", new Object[]{Long.valueOf(ttl)}));
                ttl = 0;
            }
        } else if (expiresOnEpoch != null) {
            ttl = expiresOnEpoch.longValue() - System.currentTimeMillis();
            if (ttl <= 0) {
                Logger.m648w(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: getTTLFromClaims() parsed an ExpiresOn resulting in a TTL of %1$d", new Object[]{Long.valueOf(ttl)}));
                ttl = 0;
            }
        }
        Logger.m644i(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: getTTLFromClaims() returning a TTL of %1$d", new Object[]{Long.valueOf(ttl)}));
        return ttl;
    }
        ...
        if (result == null) {
            ...
            if (result != null) {
                try {
                    ...
                    Logger.m643e(Area.AUTH.value(), "AuthFlow: getClaimsFromResult() failed", e);
                }
            }
            return resultMap;
        }
    ...
    protected static java.util.Map<java.lang.String, com.getjar.sdk.comm.auth.SettingsValue> getSettingsFromResult(com.getjar.sdk.comm.Result r12) {
        ...
        L_0x006d:
            ...
            com.getjar.sdk.logging.Logger.m648w(r9, r11)     // Catch:{ Exception -> 0x00b3 }
        L_0x009a:
            int r1 = r1 + 1
            goto L_0x006d
        L_0x009d:
        ...
        L_0x00a6:
            ...
            com.getjar.sdk.logging.Logger.m649w(r9, r11, r0)     // Catch:{ Exception -> 0x00b3 }
            goto L_0x009a
        L_0x00b3:
            r0 = move-exception
            r5 = r6
        L_0x00b5:
            ...
            com.getjar.sdk.logging.Logger.m643e(r9, r11, r0)
        L_0x00c0:
        ...
        for (int i = 0; i < claims.length(); i++) {
            try {
                ...
                if (!StringUtility.isNullOrEmpty(key) && !StringUtility.isNullOrEmpty(value)) {
                    ...
                    map.put(name, value);
                    Logger.m646v(Area.AUTH.value(), String.format(Locale.US, "AuthFlow: claim found [key:%1$s  value:%2$s]", new Object[]{name, value}));
                }
            } catch (Exception e) {
                Logger.m643e(Area.AUTH.value(), "AuthFlow: addClaimsToMap() failed", e);
            }
        }
    }
}
