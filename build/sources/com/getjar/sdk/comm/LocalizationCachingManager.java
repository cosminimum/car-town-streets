...
public class LocalizationCachingManager {
    ...
    public void addPricingToCache(String theLookup, String price, Long ttl, String eTag) {
        if (StringUtility.isNullOrEmpty(theLookup)) {
            ...
            Logger.m640d(Area.LOCALIZATION.value() | Area.STORAGE.value(), "LocalizationCachingManager -- addPricingToCache -- started ");
            if (ttl == null) {
                Logger.m642e(Area.LOCALIZATION.value() | Area.STORAGE.value(), "LocalizationCachingManager -- addLicenseToCache ttl cannot be null");
                ttl = 86400000L;
            }
    ...
    public String getCachedPriceInternal(String theLookup, boolean onlyValid) {
        ...
        try {
            ...
            Logger.m649w(Area.LOCALIZATION.value() | Area.STORAGE.value(), String.format(Locale.US, "LocalizationCachingManager: getCachedPrice() failed for key[=%s] value[=%s]. Returning default value[null]", new Object[]{theLookup, cacheValue}), e);
        }
        return null;
    }
