...
public class Result implements Serializable {
    ...
    private String getResponseBodyValueAsString(String key) {
        try {
            ...
            Logger.m643e(Area.COMM.value(), String.format(Locale.US, "Unable to get a string value for '%1$s'", new Object[]{key}), e);
        }
        return null;
    }
    ...
    private String getResponseBodyValueAsRawString(String key) {
        ...
        try {
            ...
            Logger.m643e(Area.COMM.value(), String.format(Locale.US, "Unable to get a raw string value for '%1$s'", new Object[]{key}), e);
        }
        return null;
    }
    ...
    public String getErrorResponseCode() {
        try {
            ...
            Logger.m643e(Area.COMM.value(), String.format(Locale.US, "Unable to get an error code from '%1$s'", new Object[]{this._responseBody}), e);
        }
        return null;
    }
    ...
    public String getErrorResponseSubcode() {
        try {
            ...
            Logger.m643e(Area.COMM.value(), String.format(Locale.US, "Unable to get an error subcode from '%1$s'", new Object[]{this._responseBody}), e);
        }
        return null;
    }
    ...
    public boolean checkForUnauthorizedAndOKToReAuth(CommContext commContext) throws JSONException {
        ...
        if (isUnauthorized) {
            ...
            Logger.m646v(value, String.format(locale, "checkForUnauthorizedAndOKToReAuth() isUnauthorized=%1$s and isNotOKToReAuth=%2$s, returning %3$s for:\r\n%4$s", objArr));
        }
    ...
    public boolean checkForBlacklistedOrUnsupported(CommContext commContext) throws JSONException {
        ...
        Logger.m646v(value, String.format(locale, "checkForBlacklistedOrUnsupported() returning %1$s %2$s", objArr));
        if (blacklisted || unsupported) {
            return true;
        }
        return false;
