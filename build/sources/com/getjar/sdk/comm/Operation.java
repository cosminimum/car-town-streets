...
public class Operation implements Future<Result> {
    ...
    public void promotePriority() {
        ...
        if (this._priority > 1) {
            ...
            if (promote) {
                Logger.m646v(Area.COMM.value(), String.format(Locale.US, "Operation: promotePriority() BEFORE Promoting request %1$d [priority:%2$d lastPriorityPromotionTimestamp:%3$d]", new Object[]{Integer.valueOf(getId()), Integer.valueOf(this._priority), Long.valueOf(this._lastPriorityPromotionTimestamp)}));
                this._lastPriorityPromotionTimestamp = System.currentTimeMillis();
                this._priority--;
                Logger.m646v(Area.COMM.value(), String.format(Locale.US, "Operation: promotePriority() AFTER Promoted request %1$d [priority:%2$d lastPriorityPromotionTimestamp:%3$d]", new Object[]{Integer.valueOf(getId()), Integer.valueOf(this._priority), Long.valueOf(this._lastPriorityPromotionTimestamp)}));
            }
        }
    }
