...
public class NotificationsUtility {
    ...
    public static void showEarnedFromPurchaseNotification(android.content.Context r18, java.lang.String r19, long r20) {
        ...
        L_0x0018:
            ...
            com.getjar.sdk.logging.Logger.m640d(r12, r14)
            r2 = 0
            r10 = 0
        ...
        L_0x006f:
            ...
            com.getjar.sdk.logging.Logger.m643e(r12, r14, r1)
            goto L_0x0066
        L_0x0083:
    ...
    public static void showRedeemReminderNotification(Context context) {
        ...
        Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "NotificationsUtility: showRedeemReminderNotification() START");
        Intent launchIntent = RedemptionEngine.buildShowWalletIntent(context);
        if (launchIntent == null) {
            Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "NotificationsUtility: showRedeemReminderNotification() Rewards not installed, sending install reminder");
            ...
            Logger.m640d(Area.UI.value() | Area.REDEEM.value() | Area.OFFER.value(), "NotificationsUtility: showRedeemReminderNotification() Rewards installed, sending open reminder");
    ...
    public static boolean showOpenNotification(Context context, String packageName, String appName) {
        if (context == null) {
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "NotificationsUtility: showOpenNotification() '%1$s'", new Object[]{packageName}));
            ...
            if (launchIntent == null) {
                Logger.m648w(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "NotificationsUtility showOpenNotification() '%1$s' has been uninstalled, skipping OPEN notification", new Object[]{packageName}));
                return false;
            }
    ...
    public static void showInstallNotification(Context context, String packageName, String appName) {
        if (context == null) {
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "NotificationsUtility: showInstallNotification() '%1$s'", new Object[]{packageName}));
            if (!packageName.equals(Constants.GREENJAR_PACKAGE)) {
    ...
    public static void clearInstallNotification(Context context, String packageName) {
        if (context == null) {
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "NotificationsUtility: clearInstallNotification() '%1$s'", new Object[]{packageName}));
    ...
    public static void clearOpenNotification(Context context, String packageName) {
        if (context == null) {
            ...
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), String.format(Locale.US, "NotificationsUtility: clearOpenNotification() '%1$s'", new Object[]{packageName}));
    ...
    public static void pushFailNotification(CommContext context, String message) {
        try {
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "Send Fail Notification");
            ...
            Logger.m643e(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "pushFailNotification() failed", e);
        }
    }

    public static void pushSuccessNotification(CommContext context, String message) {
        try {
            Logger.m640d(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "Send Success Notification");
            PackageManager packageManager = context.getApplicationContext().getPackageManager();
            ...
            Logger.m643e(Area.EARN.value() | Area.TRANSACTION.value() | Area.UI.value(), "pushSuccessNotification() failed", e);
        }
    }
}
