...
public class Licensing {
    ...
    public License acquireUnmanagedProductLicense(String theProductId, License.LicenseScope licenseScope) throws InterruptedException, ExecutionException {
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), "Licensing acquireUnmanagedProductLicense started");
    ...
    public Future<License> acquireUnmanagedProductLicenseAsync(String theProductId, License.LicenseScope licenseScope) {
        ...
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), String.format(Locale.US, "Licensing acquireUnmanagedProductLicenseAsync(%s,%s) started", new Object[]{theProductId, licenseScope.name()}));
    ...
    public Future<License> acquireUnmanagedProductLicenseAsync(String theProductId, License.LicenseScope licenseScope, AcquireUnmanagedProductLicenseListener licensingListener) {
        ...
        if (licenseScope == null) {
            ...
            Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), String.format(Locale.US, "Licensing acquireUnmanagedProductLicenseAsync(%s,%s,licensingListener) started", new Object[]{theProductId, licenseScope.name()}));
    ...
    public Boolean isUnmanagedProductLicensed(String theProductId) throws InterruptedException, ExecutionException {
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), "Licensing isUnmanagedProductLicensed started");
    ...
    public Future<Boolean> isUnmanagedProductLicensedAsync(String theProductId, IsUnmanagedProductLicensedListener licensingListener) {
        if (StringUtility.isNullOrEmpty(theProductId)) {
            ...
            Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), String.format(Locale.US, "Licensing isUnmanagedProductLicensedAsync(%s, licensingListener) started", new Object[]{theProductId}));
    ...
    public Future<Boolean> isUnmanagedProductLicensedAsync(String theProductId) {
        ...
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), String.format(Locale.US, "Licensing isUnmanagedProductLicensedAsync(%s) started", new Object[]{theProductId}));
    ...
    public ArrayList<License> getUnmanagedProductLicenses(String[] theProductIds) throws InterruptedException, ExecutionException {
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), "Licensing getUnmanagedProductLicenses(theProductIds) started");
    ...
    public Future<ArrayList<License>> getUnmanagedProductLicensesAsync(String[] theProductIds) {
        ...
        Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), "Licensing getUnmanagedProductLicensesAsync(theProductIds) started");
    ...
    public Future<ArrayList<License>> getUnmanagedProductLicensesAsync(String[] theProductIds, GetUnmanagedProductLicensesListener licensingListener) {
        if (theProductIds == null || theProductIds.length <= 0) {
            ...
            Logger.m644i(Area.LICENSING.value() | Area.DEVELOPER_API.value(), "Licensing getUnmanagedProductLicensesAsync(theProductIds, licensingListener) started");
    ...
    private class AcquireUnmanagedProductLicenseCallable implements Callable<License> {
        ...
        public License call() throws Exception {
            ...
            if (this.licensingListener != null) {
                Logger.m644i(Area.LICENSING.value(), String.format(Locale.US, "Licensing AcquireUnmanagedProductLicenseCallback sending callback for %s", new Object[]{this.theProductId}));
    ...
    private class IsUnmanagedProductLicensedCallable implements Callable<Boolean> {
        ...
        public Boolean call() throws Exception {
            ...
            if (this.licensingListener != null) {
                Logger.m644i(Area.LICENSING.value(), String.format(Locale.US, "Licensing IsUnmanagedProductLicensedCallback sending callback for %s", new Object[]{this.theProductId}));
    ...
    private class GetUnmanagedProductLicensesCallable implements Callable<ArrayList<License>> {
        ...
        public ArrayList<License> call() throws Exception {
            ...
            if (this.licensingListener != null) {
                Logger.m644i(Area.LICENSING.value(), "Licensing GetUnmanagedProductLicensesCallback sending callback");
