...
public class Request {
    ...
    /* renamed from: ME */
    private static final String f396ME = "me";
    ...
    public static Request newMeRequest(Session session2, final GraphUserCallback callback2) {
        return new Request(session2, f396ME, (Bundle) null, (HttpMethod) null, new Callback() {
    ...
    public static Request newPlacesSearchRequest(Session session2, Location location, int radiusInMeters, int resultsLimit, String searchText, final GraphPlaceListCallback callback2) {
        if (location != null || !Utility.isNullOrEmpty(searchText)) {
            ...
            parameters2.putString(ServerProtocol.DIALOG_PARAM_TYPE, "place");
    ...
    private void serializeToBatch(JSONArray batch, Bundle attachments) throws JSONException, IOException {
        ...
        if (this.graphObject != null) {
            ...
            batchEntry.put(BATCH_BODY_PARAM, TextUtils.join(com.getjar.sdk.utilities.Utility.QUERY_APPENDIX, keysAndValues));
        }
    ...
    private static class Serializer implements KeyValueSerializer {
        ...
        public void writeFile(java.lang.String r14, android.os.ParcelFileDescriptor r15) throws java.io.IOException {
            /*
                r13 = this;
                r12 = 0
                java.lang.String r7 = "content/unknown"
                r13.writeContentDisposition(r14, r14, r7)
                r4 = 0
                r1 = 0
                r6 = 0
                android.os.ParcelFileDescriptor$AutoCloseInputStream r5 = new android.os.ParcelFileDescriptor$AutoCloseInputStream     // Catch:{ all -> 0x0062 }
                r5.<init>(r15)     // Catch:{ all -> 0x0062 }
                java.io.BufferedInputStream r2 = new java.io.BufferedInputStream     // Catch:{ all -> 0x006e }
                r2.<init>(r5)     // Catch:{ all -> 0x006e }
                r7 = 8192(0x2000, float:1.14794E-41)
                byte[] r0 = new byte[r7]     // Catch:{ all -> 0x0071 }
            L_0x0017:
                int r3 = r2.read(r0)     // Catch:{ all -> 0x0071 }
                r7 = -1
                if (r3 == r7) goto L_0x0026
                java.io.BufferedOutputStream r7 = r13.outputStream     // Catch:{ all -> 0x0071 }
                r8 = 0
                r7.write(r0, r8, r3)     // Catch:{ all -> 0x0071 }
                int r6 = r6 + r3
                goto L_0x0017
            L_0x0026:
            ...
            L_0x0030:
                ...
                r13.writeLine(r7, r8)
                r13.writeRecordBoundary()
                com.facebook.internal.Logger r7 = r13.logger
                ...
                java.lang.String r9 = "<Data: %d>"
                r10 = 1
                java.lang.Object[] r10 = new java.lang.Object[r10]
                java.lang.Integer r11 = java.lang.Integer.valueOf(r6)
                r10[r12] = r11
                java.lang.String r9 = java.lang.String.format(r9, r10)
                r7.appendKeyValue(r8, r9)
                return
            L_0x0062:
                r7 = move-exception
            L_0x0063:
