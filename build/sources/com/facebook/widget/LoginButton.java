...
public class LoginButton extends Button {
    ...
    public LoginButton(Context context, AttributeSet attrs) {
        ...
        if (attrs.getStyleAttribute() == 0) {
            setTextColor(getResources().getColor(C0253R.color.com_facebook_loginview_text_color));
            setTextSize(0, getResources().getDimension(C0253R.dimen.com_facebook_loginview_text_size));
            setPadding(getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_padding_left), getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_padding_top), getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_padding_right), getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_padding_bottom));
            setWidth(getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_width));
            setHeight(getResources().getDimensionPixelSize(C0253R.dimen.com_facebook_loginview_height));
            setGravity(17);
            ...
            setBackgroundResource(C0253R.drawable.com_facebook_loginbutton_blue);
            initializeActiveSessionWithCachedToken(context);
        }
    }
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, C0253R.styleable.com_facebook_login_view);
    ...
    public void setButtonText() {
        if (this.sessionTracker == null || this.sessionTracker.getOpenSession() == null) {
            setText(this.loginText != null ? this.loginText : getResources().getString(C0253R.string.com_facebook_loginview_log_in_button));
        } else {
            setText(this.logoutText != null ? this.logoutText : getResources().getString(C0253R.string.com_facebook_loginview_log_out_button));
        }
    }
    ...
    private class LoginClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (openSession == null) {
                ...
                String logout = LoginButton.this.getResources().getString(C0253R.string.com_facebook_loginview_log_out_action);
                String cancel = LoginButton.this.getResources().getString(C0253R.string.com_facebook_loginview_cancel_action);
                if (LoginButton.this.user == null || LoginButton.this.user.getName() == null) {
                    message = LoginButton.this.getResources().getString(C0253R.string.com_facebook_loginview_logged_in_using_facebook);
                } else {
                    message = String.format(LoginButton.this.getResources().getString(C0253R.string.com_facebook_loginview_logged_in_as), new Object[]{LoginButton.this.user.getName()});
                }
