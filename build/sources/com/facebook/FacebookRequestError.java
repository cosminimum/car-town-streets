    ...
    private FacebookRequestError(int requestStatusCode2, int errorCode2, int subErrorCode2, String errorType2, String errorMessage2, JSONObject requestResultBody2, JSONObject requestResult2, Object batchRequestResult2, HttpURLConnection connection2, FacebookException exception2) {
        ...
        if (isLocalException) {
            ...
            if (errorCode2 == 1 || errorCode2 == 2) {
                ...
                messageId = C0253R.string.com_facebook_requesterror_permissions;
                ...
                if (subErrorCode2 == EC_USER_CHECKPOINTED || subErrorCode2 == EC_UNCONFIRMED_USER) {
                    ...
                    messageId = C0253R.string.com_facebook_requesterror_web_login;
                    shouldNotify = true;
                } else {
                    errorCategory = Category.AUTHENTICATION_REOPEN_SESSION;
                    messageId = subErrorCode2 == EC_APP_NOT_INSTALLED ? C0253R.string.com_facebook_requesterror_relogin : subErrorCode2 == EC_PASSWORD_CHANGED ? C0253R.string.com_facebook_requesterror_password_changed : C0253R.string.com_facebook_requesterror_reconnect;
                }
            }
        ...
        try {
            if (singleResult.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.contains(responseCode)) {
                    return new FacebookRequestError(responseCode, -1, -1, (String) null, (String) null, singleResult.has(BODY_KEY) ? (JSONObject) Utility.getStringPropertyAsJSON(singleResult, BODY_KEY, Response.NON_JSON_RESPONSE_PROPERTY) : null, singleResult, batchResult, connection2);
                }
            }
