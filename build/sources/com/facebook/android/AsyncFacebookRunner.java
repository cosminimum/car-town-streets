...
public class AsyncFacebookRunner {
    ...
    public void logout(final Context context, final RequestListener listener, final Object state) {
        new Thread() {
            public void run() {
                try {
                    String response = AsyncFacebookRunner.this.f398fb.logoutImpl(context);
    ...
    public void request(String graphPath, Bundle parameters, String httpMethod, RequestListener listener, Object state) {
        ...
        new Thread() {
            public void run() {
                try {
                    requestListener.onComplete(AsyncFacebookRunner.this.f398fb.requestImpl(str, bundle, str2), obj);
                } catch (FileNotFoundException e) {
