...
import com.miniclip.Chartboost.C1786Chartboost;
import com.miniclip.GetJar.C1787GetJar;
import com.miniclip.GooglePlayServices.C1793GooglePlayServices;
...
public class CarTownStreetsActivity extends InAppActivity implements C1787GetJar.GetJarListener, C1793GooglePlayServices.GooglePlayServicesListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUSE_FACEBOOK = true;
        C1793GooglePlayServices.Setup(this);
        ...
        C1786Chartboost.onCreate(this, "52308a3916ba479948000000", "9464551ce5ceebf76f181c0eb4f0905078e1cfbe");
    ...
    public void logCustomEvent(String eventId, String jsonString) {
        ...
        try {
            ...
            FlurryAgent.logEvent(eventId, (Map) map);
    ...
    public void onStart() {
        super.onStart();
        C1786Chartboost.onStart();
        C1793GooglePlayServices.gPlay.onStart();
    ...
    public void onStop() {
        super.onStop();
        C1786Chartboost.onStop();
        C1793GooglePlayServices.gPlay.onStop();
    ...
    public void onDestroy() {
        super.onDestroy();
        C1786Chartboost.onDestroy();
    }

    public void onBackPressed() {
        if (!C1786Chartboost.onBackPressed()) {
            super.onBackPressed();
        }
    }
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent intent) {
        ...
        C1793GooglePlayServices.gPlay.onActivityResult(requestCode, responseCode, intent);
    }
}
