...
/* renamed from: com.miniclip.Chartboost.Chartboost */
public class C1786Chartboost {
    ...
    /* renamed from: cb */
    private static C0038Chartboost f3960cb;
    ...
    public static void onCreate(Activity activity2, String appId, String appSignature) {
        ...
        f3960cb = C0038Chartboost.sharedChartboost();
        f3960cb.onCreate(activity2, appId, appSignature, (ChartboostDelegate) null);
        f3960cb.startSession();
    ...
    public static void onStart() {
        f3960cb.onStart(activity);
    }

    public static void onStop() {
        f3960cb.onStop(activity);
    }

    public static void onDestroy() {
        f3960cb.onDestroy(activity);
    }

    public static boolean onBackPressed() {
        return f3960cb.onBackPressed();
    }
