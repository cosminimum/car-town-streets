...
public class horizontalBanner extends RelativeLayout implements MoPubView.OnAdFailedListener, MoPubView.OnAdLoadedListener {
    ...
    public horizontalBanner(Context context) {
        ...
        this.mOfflineAd.setLayoutParams(new RelativeLayout.LayoutParams((int) (320.0f * density), (int) (50.0d * ((double) density))));
    ...
    public void reAdd() {
        ...
        adLayoutVerticleClick.setLayoutParams(new RelativeLayout.LayoutParams((int) (((double) density) * 320.0d), (int) (50.0d * ((double) density))));
