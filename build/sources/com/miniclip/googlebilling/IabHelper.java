...
public class IabHelper {
    ...
    public boolean handleActivityResult(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x0006:
            ...
            r12.logError(r8)
            com.miniclip.googlebilling.IabResult r6 = new com.miniclip.googlebilling.IabResult
            r8 = -1002(0xfffffffffffffc16, float:NaN)
            java.lang.String r9 = "Null data in IAB result"
            r6.<init>(r8, r9)
            com.miniclip.googlebilling.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
        ...
        L_0x00c7:
            r2 = 0
            com.miniclip.googlebilling.Purchase r3 = new com.miniclip.googlebilling.Purchase     // Catch:{ JSONException -> 0x012e }
            ...
            boolean r8 = com.miniclip.googlebilling.Security.verifyPurchase(r8, r4, r0)     // Catch:{ JSONException -> 0x01e9 }
            ...
            com.miniclip.googlebilling.IabResult r6 = new com.miniclip.googlebilling.IabResult     // Catch:{ JSONException -> 0x01e9 }
            ...
            com.miniclip.googlebilling.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x01e9 }
        ...
        L_0x0115:
            ...
            com.miniclip.googlebilling.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            com.miniclip.googlebilling.IabResult r9 = new com.miniclip.googlebilling.IabResult
            r10 = 0
        ...
        L_0x01e9:
            ...
            goto L_0x012f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miniclip.googlebilling.IabHelper.handleActivityResult(int, int, android.content.Intent):boolean");
    }
    ...
    public int querySkuDetails(Inventory inv, List<String> moreSkus) throws RemoteException, JSONException {
        ...
        while (skuList.size() > 0) {
            ...
            Iterator i$2 = skuDetails.getStringArrayList(RESPONSE_GET_SKU_DETAILS_LIST).iterator();
            while (i$2.hasNext()) {
                SkuDetails d = new SkuDetails(i$2.next());
