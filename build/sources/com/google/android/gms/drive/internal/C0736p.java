...
public interface C0736p extends IInterface {

    /* renamed from: com.google.android.gms.drive.internal.p$a */
    public static abstract class C0737a extends Binder implements C0736p {

        /* renamed from: com.google.android.gms.drive.internal.p$a$a */
        private static class C0738a implements C0736p {

            /* renamed from: dU */
            private IBinder f1552dU;

            C0738a(IBinder iBinder) {
                this.f1552dU = iBinder;
            }
            ...
            public void mo6157a(OnContentsResponse onContentsResponse) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(5, obtain, obtain2, 0);
            ...
            public void mo6158a(OnDownloadProgressResponse onDownloadProgressResponse) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo6159a(OnDriveIdResponse onDriveIdResponse) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo6160a(OnListEntriesResponse onListEntriesResponse) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo6161a(OnMetadataResponse onMetadataResponse) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo6162m(Status status) throws RemoteException {
                ...
                try {
                    ...
                    this.f1552dU.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSuccess() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
                    this.f1552dU.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: D */
        public static C0736p m1564D(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.drive.internal.IDriveServiceCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0736p)) ? new C0738a(iBinder) : (C0736p) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r4, android.os.Parcel r5, android.os.Parcel r6, int r7) throws android.os.RemoteException {
            ...
            L_0x0024:
                r3.mo6158a((com.google.android.gms.drive.internal.OnDownloadProgressResponse) r0)
                r6.writeNoException()
                r0 = r1
                goto L_0x0009
            L_0x002c:
            ...
            L_0x003f:
                r3.mo6160a((com.google.android.gms.drive.internal.OnListEntriesResponse) r0)
                r6.writeNoException()
                r0 = r1
                goto L_0x0009
            L_0x0047:
            ...
            L_0x005a:
                r3.mo6159a((com.google.android.gms.drive.internal.OnDriveIdResponse) r0)
                r6.writeNoException()
                r0 = r1
                goto L_0x0009
            L_0x0062:
            ...
            L_0x0075:
                r3.mo6161a((com.google.android.gms.drive.internal.OnMetadataResponse) r0)
                r6.writeNoException()
                r0 = r1
                goto L_0x0009
            L_0x007d:
            ...
            L_0x0090:
                r3.mo6157a((com.google.android.gms.drive.internal.OnContentsResponse) r0)
                r6.writeNoException()
                r0 = r1
                goto L_0x0009
            L_0x0099:
            ...
            L_0x00b3:
                ...
                goto L_0x0009
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.drive.internal.C0736p.C0737a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    /* renamed from: a */
    void mo6157a(OnContentsResponse onContentsResponse) throws RemoteException;

    /* renamed from: a */
    void mo6158a(OnDownloadProgressResponse onDownloadProgressResponse) throws RemoteException;

    /* renamed from: a */
    void mo6159a(OnDriveIdResponse onDriveIdResponse) throws RemoteException;

    /* renamed from: a */
    void mo6160a(OnListEntriesResponse onListEntriesResponse) throws RemoteException;

    /* renamed from: a */
    void mo6161a(OnMetadataResponse onMetadataResponse) throws RemoteException;

    /* renamed from: m */
    void mo6162m(Status status) throws RemoteException;
