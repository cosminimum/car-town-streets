...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class C1503a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate$a$a */
        private static class C1504a implements ILocationSourceDelegate {

            /* renamed from: dU */
            private IBinder f3592dU;

            C1504a(IBinder iBinder) {
                this.f3592dU = iBinder;
            }

            public void activate(C1529g listener) throws RemoteException {
                ...
                try {
                    ...
                    this.f3592dU.transact(1, obtain, obtain2, 0);
            ...
            public void deactivate() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ILocationSourceDelegate");
                    this.f3592dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: T */
        public static ILocationSourceDelegate m4144T(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ILocationSourceDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C1504a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    activate(C1529g.C1530a.m4175Y(data.readStrongBinder()));
    ...
    void activate(C1529g gVar) throws RemoteException;
