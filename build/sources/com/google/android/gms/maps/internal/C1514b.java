...
public interface C1514b extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.b$a */
    public static abstract class C1515a extends Binder implements C1514b {

        /* renamed from: com.google.android.gms.maps.internal.b$a$a */
        private static class C1516a implements C1514b {

            /* renamed from: dU */
            private IBinder f3597dU;

            C1516a(IBinder iBinder) {
                this.f3597dU = iBinder;
            }
            ...
            public void onCancel() throws RemoteException {
                ...
                try {
                    ...
                    this.f3597dU.transact(2, obtain, obtain2, 0);
            ...
            public void onFinish() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICancelableCallback");
                    this.f3597dU.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: P */
        public static C1514b m4151P(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1514b)) ? new C1516a(iBinder) : (C1514b) queryLocalInterface;
        }
