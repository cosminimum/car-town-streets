...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class C1507a extends Binder implements IMapViewDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapViewDelegate$a$a */
        private static class C1508a implements IMapViewDelegate {

            /* renamed from: dU */
            private IBinder f3594dU;

            C1508a(IBinder iBinder) {
                this.f3594dU = iBinder;
            }
            ...
            public IGoogleMapDelegate getMap() throws RemoteException {
                ...
                try {
                    ...
                    this.f3594dU.transact(1, obtain, obtain2, 0);
            ...
            public C0772b getView() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f3594dU.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void onCreate(Bundle savedInstanceState) throws RemoteException {
                ...
                try {
                    ...
                    this.f3594dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f3594dU.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onLowMemory() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f3594dU.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onPause() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f3594dU.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onResume() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapViewDelegate");
                    this.f3594dU.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void onSaveInstanceState(Bundle outState) throws RemoteException {
                ...
                try {
                    ...
                    this.f3594dU.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        /* renamed from: V */
        public static IMapViewDelegate m4146V(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IMapViewDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C1508a(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int r4, android.os.Parcel r5, android.os.Parcel r6, int r7) throws android.os.RemoteException {
            ...
            L_0x00b2:
                ...
                goto L_0x0009
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.maps.internal.IMapViewDelegate.C1507a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }
