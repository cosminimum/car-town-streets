...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class C1570a extends Binder implements IPolylineDelegate {

        /* renamed from: com.google.android.gms.maps.model.internal.IPolylineDelegate$a$a */
        private static class C1571a implements IPolylineDelegate {

            /* renamed from: dU */
            private IBinder f3696dU;

            C1571a(IBinder iBinder) {
                this.f3696dU = iBinder;
            }
            ...
            public boolean equalsRemote(IPolylineDelegate other) throws RemoteException {
                ...
                try {
                    ...
                    this.f3696dU.transact(15, obtain, obtain2, 0);
            ...
            public int getColor() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String getId() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public List<LatLng> getPoints() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public float getWidth() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public float getZIndex() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(10, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readFloat();
                } finally {
                    obtain2.recycle();
            ...
            public int hashCodeRemote() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(16, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt();
                } finally {
                    obtain2.recycle();
            ...
            public boolean isGeodesic() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(14, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public boolean isVisible() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(12, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public void remove() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    this.f3696dU.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setColor(int color) throws RemoteException {
                ...
                try {
                    ...
                    this.f3696dU.transact(7, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setGeodesic(boolean geodesic) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3696dU.transact(13, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setPoints(List<LatLng> points) throws RemoteException {
                ...
                try {
                    ...
                    this.f3696dU.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setVisible(boolean visible) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f3696dU.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setWidth(float width) throws RemoteException {
                ...
                try {
                    ...
                    this.f3696dU.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setZIndex(float zIndex) throws RemoteException {
                ...
                try {
                    ...
                    this.f3696dU.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        /* renamed from: ao */
        public static IPolylineDelegate m4244ao(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C1571a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean equalsRemote = equalsRemote(m4244ao(data.readStrongBinder()));
                    reply.writeNoException();
                    if (equalsRemote) {
                        z = true;
                    }
