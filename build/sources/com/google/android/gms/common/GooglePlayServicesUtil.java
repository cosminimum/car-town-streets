...
import com.google.android.gms.internal.C1069du;
import com.google.android.gms.internal.C1086dz;
...
public final class GooglePlayServicesUtil {
    ...
    /* renamed from: a */
    public static Dialog m1227a(int i, Activity activity, int i2, DialogInterface.OnCancelListener onCancelListener, int i3) {
        AlertDialog.Builder message = new AlertDialog.Builder(activity).setMessage(m1233b(activity, i, i3));
        if (onCancelListener != null) {
            message.setOnCancelListener(onCancelListener);
        }
        C1069du duVar = new C1069du(activity, m1228a(activity, i, i3), i2);
        String b = m1232b(activity, i);
        if (b != null) {
            message.setPositiveButton(b, duVar);
        }
        switch (i) {
            case 0:
                return null;
            case 1:
                return message.setTitle(C0585R.string.common_google_play_services_install_title).create();
            case 2:
                return message.setTitle(C0585R.string.common_google_play_services_update_title).create();
            case 3:
                return message.setTitle(C0585R.string.common_google_play_services_enable_title).create();
            case 4:
            case 6:
                return message.create();
            case 5:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0585R.string.common_google_play_services_invalid_account_title).create();
            case 7:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0585R.string.common_google_play_services_network_error_title).create();
            case 8:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.create();
            case 9:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0585R.string.common_google_play_services_unsupported_title).create();
            case 10:
    ...
    /* renamed from: a */
    public static Intent m1228a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m1239y(i2) ? m1238o(context) ? C1086dz.m2536T(GOOGLE_PLAY_SERVICES_PACKAGE) : C1086dz.m2535S("com.google.android.apps.bazaar") : C1086dz.m2535S(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C1086dz.m2533Q(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 12:
                return C1086dz.m2537bX();
            default:
                return null;
        }
    }
    ...
    /* renamed from: a */
    public static boolean m1229a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (C1135fg.m2765cD() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m1234b(resources);
    }

    /* renamed from: a */
    private static byte[] m1230a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[][] m1231a(byte[][]... bArr) {
        int i = 0;
    ...
    /* renamed from: b */
    public static String m1232b(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return resources.getString(C0585R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0585R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0585R.string.common_google_play_services_enable_button);
            default:
    ...
    /* renamed from: b */
    public static String m1233b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                String string = m1229a(context.getResources()) ? resources.getString(C0585R.string.common_google_play_services_install_text_tablet) : resources.getString(C0585R.string.common_google_play_services_install_text_phone);
                return m1239y(i2) ? string + " (via Bazaar)" : string;
            case 2:
                String string2 = resources.getString(C0585R.string.common_google_play_services_update_text);
                return m1239y(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
                return resources.getString(C0585R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0585R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0585R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0585R.string.common_google_play_services_unsupported_text);
            case 12:
                return resources.getString(C0585R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0585R.string.common_google_play_services_unknown_issue);
        }
    }

    /* renamed from: b */
    private static boolean m1234b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return C1135fg.m2767cF() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    /* renamed from: bi */
    public static boolean m1235bi() {
        return f1310mK ? f1311mL : "user".equals(Build.TYPE);
    }

    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode) {
        return m1227a(errorCode, activity, requestCode, (DialogInterface.OnCancelListener) null, -1);
    }
    ...
    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, DialogInterface.OnCancelListener cancelListener) {
        return m1227a(errorCode, activity, requestCode, cancelListener, -1);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent a = m1228a(context, errorCode, -1);
        if (a == null) {
            return null;
        }
        return PendingIntent.getActivity(context, requestCode, a, DriveFile.MODE_READ_ONLY);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0585R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        m1237n(context);
        try {
            byte[] a = m1230a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f1303mD);
            if (a == null) {
            ...
            try {
                ...
                if (m1230a(packageInfo, a) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                } else if (packageInfo.versionCode < 4242000) {
    ...
    /* renamed from: m */
    public static void m1236m(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent a = m1228a(context, isGooglePlayServicesAvailable, -1);
    ...
    /* renamed from: n */
    private static void m1237n(Context context) {
    ...
    /* renamed from: o */
    private static boolean m1238o(Context context) {
        if (f1310mK) {
            return f1312mM;
        }
        try {
            return m1230a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f1309mJ) != null;
        } catch (PackageManager.NameNotFoundException e) {
            return false;
        }
    }
    ...
    /* renamed from: z */
    private static int m1240z(int i) {
        if (i == -1) {
            return 2;
        }
        return i;
