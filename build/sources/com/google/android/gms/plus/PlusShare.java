...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        /* renamed from: DI */
        private boolean f3750DI;

        /* renamed from: DJ */
        private ArrayList<Uri> f3751DJ;
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            C1102eg.m2612a(plusClient != null, "PlusClient must not be null.");
            C1102eg.m2612a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            C1102eg.m2612a(plusClient.mo9697eK().mo8293az(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            C1102eg.m2612a(this.f3750DI, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            C1102eg.m2615b(uri != null && !TextUtils.isEmpty(uri.toString()), (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                C1102eg.m2612a(PlusShare.m4323aw(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Builder addStream(Uri streamUri) {
            ...
            if (this.f3751DJ == null) {
                this.f3751DJ = new ArrayList<>();
            }
            this.f3751DJ.add(uri);
            this.f3751DJ.add(streamUri);
            return this;
        }

        public Intent getIntent() {
            boolean z = true;
            boolean z2 = this.f3751DJ != null && this.f3751DJ.size() > 1;
            ...
            C1102eg.m2612a(!z2 || !booleanExtra, "Call-to-action buttons are only available for URLs.");
            C1102eg.m2612a(!booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL), "The content URL is required for interactive posts.");
            ...
            C1102eg.m2612a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                C1102eg.m2612a(PlusShare.m4323aw(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
                this.mIntent.setAction("android.intent.action.SEND");
                if (this.f3751DJ == null || this.f3751DJ.isEmpty()) {
                    this.mIntent.removeExtra("android.intent.extra.STREAM");
                } else {
                    this.mIntent.putExtra("android.intent.extra.STREAM", this.f3751DJ.get(0));
                }
                this.f3751DJ = null;
            }
            if (z2 && !equals) {
                ...
                if (this.f3751DJ == null || this.f3751DJ.isEmpty()) {
                    ...
                    this.mIntent.putParcelableArrayListExtra("android.intent.extra.STREAM", this.f3751DJ);
                }
            }
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            C1102eg.m2615b(this.f3750DI, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            C1102eg.m2615b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m4322a(title, description, thumbnailUri);
    ...
    /* renamed from: a */
    public static Bundle m4322a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
    ...
    /* renamed from: aw */
    protected static boolean m4323aw(String str) {
        if (TextUtils.isEmpty(str)) {
    ...
    public static Person createPerson(String id, String displayName) {
        if (TextUtils.isEmpty(id)) {
            ...
            return new C1407ig(displayName, id, (C1407ig.C1412c) null, 0, (String) null);
        } else {
