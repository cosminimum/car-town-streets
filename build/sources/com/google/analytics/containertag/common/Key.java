...
public enum Key {
    ...
    COUNTRY("country"),
    CURRENCY_CODE(TapjoyConstants.TJC_EVENT_IAP_CURRENCY_ID),
    ...
    ELEMENT("element"),
    EMAIL(MMAdViewSDK.Event.INTENT_EMAIL),
    ...
    TYPE(ServerProtocol.DIALOG_PARAM_TYPE),
