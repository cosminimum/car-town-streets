...
class ApsalarSession extends ApsalarEvent implements ApsalarAPI, ApsalarJSON {
    ...
    private String[] triggerInfo = new String[0];
    private LoadTriggerTask triggerTask = null;
            ...
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    ...
                    if (apsalarItem != null) {
                        ...
                        ApsalarItem apsalarItem2 = new ApsalarItem(jSONArray.getString(i), (Object) null);
