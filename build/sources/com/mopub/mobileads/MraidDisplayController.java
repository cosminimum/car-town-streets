        ...
        if (this.mRootView != null) {
            ...
            if (enabled) {
                if (this.mCloseButton == null) {
                    ...
                    states.addState(new int[]{-16842919}, getView().getResources().getDrawable(C2049R.drawable.close_button_normal));
                    states.addState(new int[]{16842919}, getView().getResources().getDrawable(C2049R.drawable.close_button_pressed));
