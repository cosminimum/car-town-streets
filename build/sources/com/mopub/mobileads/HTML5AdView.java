    ...
    private class HTML5WebChromeClient extends WebChromeClient implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
        ...
        public Bitmap getDefaultVideoPoster() {
            if (HTML5AdView.this.mDefaultVideoPoster == null) {
                Bitmap unused = HTML5AdView.this.mDefaultVideoPoster = BitmapFactory.decodeResource(HTML5AdView.this.getResources(), C2049R.drawable.default_video_poster);
            }
        ...
        public View getVideoLoadingProgressView() {
            if (HTML5AdView.this.mVideoProgressView == null) {
                View unused = HTML5AdView.this.mVideoProgressView = LayoutInflater.from(HTML5AdView.this.getContext()).inflate(C2049R.layout.video_loading_progress, (ViewGroup) null);
            }
