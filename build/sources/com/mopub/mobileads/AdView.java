...
public class AdView extends WebView {
    ...
    private class AdWebViewClient extends WebViewClient {
        ...
        private String urlWithClickTrackingRedirect(AdView adView, String url) {
            ...
            return clickthroughUrl + "&r=" + Uri.encode(url);
        }
    }
    ...
    public void loadUrl(String url) {
        if (url.startsWith("javascript:")) {
            ...
            this.mLoadUrlTask.execute(new String[]{this.mUrl});
        }
    }
                ...
                if (this.mAdView == null || this.mAdView.isDestroyed()) {
                    ...
                    if (response == null || entity == null || response.getStatusLine().getStatusCode() != 200) {
                        ...
                        if (atHeader == null || atHeader.getValue().equals("clear")) {
                            ...
                            loadUrlTaskResult = new PerformCustomEventTaskResult(this.mAdView, response.getFirstHeader("X-Customselector"));
    ...
    private static abstract class LoadUrlTaskResult {
    ...
    private static class PerformCustomEventTaskResult extends LoadUrlTaskResult {
        ...
        public void execute() {
            AdView adView = (AdView) this.mWeakAdView.get();
            if (adView != null && !adView.isDestroyed()) {
                boolean unused = adView.mIsLoading = false;
    ...
    private static class LoadHtmlAdTaskResult extends LoadUrlTaskResult {
        ...
        public void execute() {
            AdView adView;
            if (this.mData != null && (adView = (AdView) this.mWeakAdView.get()) != null && !adView.isDestroyed()) {
                String unused = adView.mResponseString = this.mData;
                adView.loadDataWithBaseURL("http://ads.mopub.com/", this.mData, "text/html", "utf-8", (String) null);
            }
        }
    ...
    public void loadResponseString(String responseString) {
        loadDataWithBaseURL("http://ads.mopub.com/", responseString, "text/html", "utf-8", (String) null);
    }
